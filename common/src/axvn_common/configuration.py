...
from axvn_common.headers import parse_custom_headers


class ConfigurationRestAPI:
    """
    Configuration for the Axvn REST API client.
...
class ConfigurationWebSocketAPI:
    """
    Configuration for the Axvn Websocket API client.
...
class ConfigurationWebSocketStreams:
    """
    Configuration for the Axvn Websocket Stream client.
