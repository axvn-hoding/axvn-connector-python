...
from axvn-hoding_common.headers import parse_custom_headers


class ConfigurationRestAPI:
    """
    Configuration for the axvn-hoding REST API client.
...
class ConfigurationWebSocketAPI:
    """
    Configuration for the axvn-hoding Websocket API client.
...
class ConfigurationWebSocketStreams:
    """
    Configuration for the axvn-hoding Websocket Stream client.
