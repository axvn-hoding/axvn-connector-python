# axvn-hoding Python Staking SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-staking)](https://pypi.python.org/pypi/axvn-hoding-sdk-staking)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-staking.svg)](https://pypi.org/project/axvn-hoding-sdk-staking/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-staking)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Staking SDK API, enabling developers to interact programmatically with axvn-hoding's Staking trading platform. The library provides tools to participate in certain DeFi products, obtains and distributes realized earnings through the REST API:

- [REST API](./src/axvn-hoding_sdk_staking/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-staking
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/staking/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_staking/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import STAKING_REST_API_PROD_URL
...
try:
    ...
    logging.info(f"claim_boost_rewards() response: {data}")
except Exception as e:
    logging.error(f"claim_boost_rewards() error: {e}")
```
