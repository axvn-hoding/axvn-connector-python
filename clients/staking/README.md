...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-staking)](https://pypi.python.org/pypi/axvn-sdk-staking)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-staking.svg)](https://pypi.org/project/axvn-sdk-staking/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-staking)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Staking SDK API, enabling developers to interact programmatically with Axvn's Staking trading platform. The library provides tools to participate in certain DeFi products, obtains and distributes realized earnings through the REST API:

- [REST API](./src/axvn_sdk_staking/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-staking
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/staking/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_staking/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import STAKING_REST_API_PROD_URL
