...
class GetBnsolRewardsHistoryResponseRowsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBnsolRewardsHistoryResponseRowsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBnsolRewardsHistoryResponseRowsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "time": obj.get("time"),
                "amountInSOL": obj.get("amountInSOL"),
                "holding": obj.get("holding"),
                "holdingInSOL": obj.get("holdingInSOL"),
