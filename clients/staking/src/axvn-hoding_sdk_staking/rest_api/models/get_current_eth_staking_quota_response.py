...
class GetCurrentEthStakingQuotaResponse(BaseModel):
    """
    ...
    left_staking_personal_quota: Optional[StrictStr] = Field(
        ...
        alias="leftStakingPersonalQuota",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetCurrentEthStakingQuotaResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetCurrentEthStakingQuotaResponse from a dict"""
        if obj is None:
            return None
