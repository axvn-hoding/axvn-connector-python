...
class OnChainYieldsAccountResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OnChainYieldsAccountResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OnChainYieldsAccountResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "totalFlexibleAmountInBTC": obj.get("totalFlexibleAmountInBTC"),
                "totalFlexibleAmountInUSDT": obj.get("totalFlexibleAmountInUSDT"),
                "totalLockedInBTC": obj.get("totalLockedInBTC"),
                "totalLockedInUSDT": obj.get("totalLockedInUSDT"),
            }
        )
