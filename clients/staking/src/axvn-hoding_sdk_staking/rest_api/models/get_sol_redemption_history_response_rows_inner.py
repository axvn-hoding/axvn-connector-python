...
class GetSolRedemptionHistoryResponseRowsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSolRedemptionHistoryResponseRowsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSolRedemptionHistoryResponseRowsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "distributeAsset": obj.get("distributeAsset"),
                "distributeAmount": obj.get("distributeAmount"),
