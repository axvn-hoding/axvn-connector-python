...
from axvn-hoding_sdk_staking.rest_api.api import SoftStakingApi
from axvn-hoding_sdk_staking.rest_api.models import GetSoftStakingProductListResponse
from axvn-hoding_sdk_staking.rest_api.models import GetSoftStakingRewardsHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import SetSoftStakingResponse
...
class TestSoftStakingApi:
    ...
    def test_get_soft_staking_product_list_success_with_optional_params(
        ...
        params = {"asset": "BTC", "current": 1, "size": 10, "recv_window": 5000}
