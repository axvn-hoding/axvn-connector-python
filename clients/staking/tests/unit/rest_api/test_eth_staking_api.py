...
from axvn-hoding_sdk_staking.rest_api.api import EthStakingApi
from axvn-hoding_sdk_staking.rest_api.models import EthStakingAccountResponse
from axvn-hoding_sdk_staking.rest_api.models import GetCurrentEthStakingQuotaResponse
from axvn-hoding_sdk_staking.rest_api.models import GetEthRedemptionHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetEthStakingHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetWbethRateHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetWbethRewardsHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetWbethUnwrapHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetWbethWrapHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import RedeemEthResponse
from axvn-hoding_sdk_staking.rest_api.models import SuaxvnscribeEthStakingResponse
from axvn-hoding_sdk_staking.rest_api.models import WrapBethResponse


from axvn-hoding_sdk_staking.rest_api.models import RedeemEthAssetEnum
...
class TestEthStakingApi:
    ...
    def test_redeem_eth_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            "amount": 1.0,
            "asset": RedeemEthAssetEnum["WBETH"].value,
            "recv_window": 5000,
        }
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_suaxvnscribe_eth_staking_success(self, mock_get_signature):
        """Test suaxvnscribe_eth_staking() successfully with required parameters only."""
        ...
        response = self.client.suaxvnscribe_eth_staking(**params)
        ...
        is_oneof = is_one_of_model(SuaxvnscribeEthStakingResponse)

        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(SuaxvnscribeEthStakingResponse, "from_dict"):
            expected = SuaxvnscribeEthStakingResponse.from_dict(expected_response)
        else:
            expected = SuaxvnscribeEthStakingResponse.model_validate_json(
                json.dumps(expected_response)
            )
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_suaxvnscribe_eth_staking_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test suaxvnscribe_eth_staking() successfully with optional parameters."""
    ...
    def test_suaxvnscribe_eth_staking_missing_required_param_amount(self):
        """Test that suaxvnscribe_eth_staking() raises RequiredError when 'amount' is missing."""
        params = {
            "amount": 1.0,
        }
        params["amount"] = None
        ...
        with pytest.raises(RequiredError, match="Missing required parameter 'amount'"):
            self.client.suaxvnscribe_eth_staking(**params)

    def test_suaxvnscribe_eth_staking_server_error(self):
        """Test that suaxvnscribe_eth_staking() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.suaxvnscribe_eth_staking = MagicMock(side_effect=mock_error)
