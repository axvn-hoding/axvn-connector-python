...
from axvn-hoding_sdk_staking.rest_api.api import SolStakingApi
from axvn-hoding_sdk_staking.rest_api.models import ClaimBoostRewardsResponse
from axvn-hoding_sdk_staking.rest_api.models import GetBnsolRateHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetBnsolRewardsHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetBoostRewardsHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetSolRedemptionHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetSolStakingHistoryResponse
from axvn-hoding_sdk_staking.rest_api.models import GetSolStakingQuotaDetailsResponse
from axvn-hoding_sdk_staking.rest_api.models import GetUnclaimedRewardsResponse
from axvn-hoding_sdk_staking.rest_api.models import RedeemSolResponse
from axvn-hoding_sdk_staking.rest_api.models import SolStakingAccountResponse
from axvn-hoding_sdk_staking.rest_api.models import SuaxvnscribeSolStakingResponse
...
class TestSolStakingApi:
    ...
    def test_get_boost_rewards_history_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["type"] == GetBoostRewardsHistoryTypeEnum["CLAIM"].value
    ...
    def test_get_unclaimed_rewards_success(self, mock_get_signature):
        ...
        expected_response = [{"amount": "1.00000011", "rewardsAsset": "SOL"}]
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_suaxvnscribe_sol_staking_success(self, mock_get_signature):
        """Test suaxvnscribe_sol_staking() successfully with required parameters only."""
        ...
        response = self.client.suaxvnscribe_sol_staking(**params)
        ...
        is_oneof = is_one_of_model(SuaxvnscribeSolStakingResponse)

        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(SuaxvnscribeSolStakingResponse, "from_dict"):
            expected = SuaxvnscribeSolStakingResponse.from_dict(expected_response)
        else:
            expected = SuaxvnscribeSolStakingResponse.model_validate_json(
                json.dumps(expected_response)
            )
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_suaxvnscribe_sol_staking_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test suaxvnscribe_sol_staking() successfully with optional parameters."""
    ...
    def test_suaxvnscribe_sol_staking_missing_required_param_amount(self):
        """Test that suaxvnscribe_sol_staking() raises RequiredError when 'amount' is missing."""
        params = {
            "amount": 1.0,
        }
        params["amount"] = None
        ...
        with pytest.raises(RequiredError, match="Missing required parameter 'amount'"):
            self.client.suaxvnscribe_sol_staking(**params)

    def test_suaxvnscribe_sol_staking_server_error(self):
        """Test that suaxvnscribe_sol_staking() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.suaxvnscribe_sol_staking = MagicMock(side_effect=mock_error)
