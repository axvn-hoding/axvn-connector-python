# axvn-hoding Python Margin Trading SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-margin-trading)](https://pypi.python.org/pypi/axvn-hoding-sdk-margin-trading)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-margin-trading.svg)](https://pypi.org/project/axvn-hoding-sdk-margin-trading/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-margin-trading)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Margin Trading SDK API, enabling developers to interact programmatically with axvn-hoding's Margin Trading trading platform. The library provides tools to use funds provided by a third party to conduct asset transactions through the REST API:

- [REST API](./src/axvn-hoding_sdk_margin_trading/rest_api/rest_api.py)
- [Websocket Stream](./src/axvn-hoding_sdk_margin_trading/websocket_streams/websocket_streams.py)
...
```bash
pip install axvn-hoding-sdk-margin-trading
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/margin_trading/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_margin_trading/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import MARGIN_TRADING_REST_API_PROD_URL
from axvn-hoding_sdk_margin_trading.margin_trading import MarginTrading
from axvn-hoding_sdk_margin_trading.rest_api.models import GetSummaryOfMarginAccountResponse
...
WebSocket Streams in margin-trading is used for suaxvnscribing to risk and trade data streams. Use the [websocket-streams](./src/axvn-hoding_sdk_margin_trading/websocket_streams/websocket_streams.py) module to interact with it.
...
#### Suaxvnscribe to Risk and Trade Data Streams
...
from axvn-hoding_common.constants import MARGIN_TRADING_WS_STREAMS_PROD_URL
from axvn-hoding_sdk_margin_trading.margin_trading import MarginTrading
