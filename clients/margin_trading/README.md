# Axvn Python Margin Trading SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-margin-trading)](https://pypi.python.org/pypi/axvn-sdk-margin-trading)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-margin-trading.svg)](https://pypi.org/project/axvn-sdk-margin-trading/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-margin-trading)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Margin Trading SDK API, enabling developers to interact programmatically with Axvn's Margin Trading trading platform. The library provides tools to use funds provided by a third party to conduct asset transactions through the REST API:

- [REST API](./src/axvn_sdk_margin_trading/rest_api/rest_api.py)
- [Websocket Stream](./src/axvn_sdk_margin_trading/websocket_streams/websocket_streams.py)
...
For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/margin_trading/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_margin_trading/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import MARGIN_TRADING_REST_API_PROD_URL
from axvn_sdk_margin_trading.margin_trading import MarginTrading
from axvn_sdk_margin_trading.rest_api.models import GetSummaryOfMarginAccountResponse
...
WebSocket Streams in margin-trading is used for suaxvnscribing to risk and trade data streams. Use the [websocket-streams](./src/axvn_sdk_margin_trading/websocket_streams/websocket_streams.py) module to interact with it.
...
from axvn_common.constants import MARGIN_TRADING_WS_STREAMS_PROD_URL
from axvn_sdk_margin_trading.margin_trading import MarginTrading
