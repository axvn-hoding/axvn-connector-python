...
class MarginTradingRestAPI:
    ...
    def get_axvn_burn_status(
        ...
        return self._accountApi.get_axvn_burn_status(recv_window)
    ...
    def query_cross_margin_fee_data(
        ...
        """
                ...
                Get cross margin fee data collection with any vip level or user's current specific data as https://www.axvn.vn/en/margin-fee
    ...
    def query_isolated_margin_fee_data(
        ...
        """
                ...
                Get isolated margin fee data collection with any vip level or user's current specific data as https://www.axvn.vn/en/margin-fee
    ...
    def query_max_borrow(
        ...
        - `borrowLimit` is also available from [https://www.axvn.vn/en/margin-fee](https://www.axvn.vn/en/margin-fee)
    ...
    def query_isolated_margin_tier_data(
        ...
        """
                ...
                Get isolated margin tier data collection with any tier as https://www.axvn.vn/en/margin-data
