...
from axvn-hoding_sdk_margin_trading.rest_api.models.margin_account_cancel_all_open_orders_on_a_symbol_response_inner_order_reports_inner import (
    MarginAccountCancelAllOpenOrdersOnASymbolResponseInnerOrderReportsInner,
)
from axvn-hoding_sdk_margin_trading.rest_api.models.margin_account_cancel_all_open_orders_on_a_symbol_response_inner_orders_inner import (
...
class MarginAccountCancelAllOpenOrdersOnASymbolResponseInner(BaseModel):
    """
    ...
    orig_client_order_id: Optional[StrictStr] = Field(
        default=None, description="orig Client Order Id.", alias="origClientOrderId"
    )
    order_id: Optional[StrictInt] = Field(
        default=None, description="order Id.", alias="orderId"
    )
    order_list_id: Optional[StrictInt] = Field(
        default=None, description="order List Id.", alias="orderListId"
    )
    ...
    contingency_type: Optional[StrictStr] = Field(
        default=None, description="contingency Type.", alias="contingencyType"
    )
    list_status_type: Optional[StrictStr] = Field(
        default=None, description="list Status Type.", alias="listStatusType"
    )
    list_order_status: Optional[StrictStr] = Field(
        default=None, description="list Order Status.", alias="listOrderStatus"
    )
    list_client_order_id: Optional[StrictStr] = Field(
        default=None, description="list Client Order Id.", alias="listClientOrderId"
    )
    transaction_time: Optional[StrictInt] = Field(
        default=None, description="transaction Time.", alias="transactionTime"
    )
    orders: Optional[
        List[MarginAccountCancelAllOpenOrdersOnASymbolResponseInnerOrdersInner]
    ] = Field(default=None, description="orders list.")
    order_reports: Optional[
        List[MarginAccountCancelAllOpenOrdersOnASymbolResponseInnerOrderReportsInner]
    ] = Field(default=None, description="order Reports list.", alias="orderReports")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarginAccountCancelAllOpenOrdersOnASymbolResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarginAccountCancelAllOpenOrdersOnASymbolResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        MarginAccountCancelAllOpenOrdersOnASymbolResponseInnerOrdersInner.from_dict(
                            _item
                        )
                ...
                "orderReports": (
                    [
                        MarginAccountCancelAllOpenOrdersOnASymbolResponseInnerOrderReportsInner.from_dict(
                            _item
                        )
