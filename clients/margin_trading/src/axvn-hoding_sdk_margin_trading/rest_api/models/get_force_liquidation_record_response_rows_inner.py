...
class GetForceLiquidationRecordResponseRowsInner(BaseModel):
    """
    ...
    updated_time: Optional[StrictInt] = Field(
        default=None, description="updated Time.", alias="updatedTime"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetForceLiquidationRecordResponseRowsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetForceLiquidationRecordResponseRowsInner from a dict"""
        if obj is None:
            return None
