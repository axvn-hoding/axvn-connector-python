...
class TradeApi:
    ...
    def create_special_key(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#create-special-key

                **Eligibility**

        - axvn-hoding Margin offers low-latency trading through a [special key](https://www.axvn.vn/en/support/faq/frequently-asked-questions-on-margin-special-api-key-3208663e900d4d2e9fec4140e1832f4e), available exclusively to users with VIP level 7 or higher.
        ...
        For more information, please refer to [FAQ](https://www.axvn.vn/en/support/faq/detail/3208663e900d4d2e9fec4140e1832f4e).
        ...
        * RSA
        ...
        We recommend to **use Ed25519 API keys** as it should provide the best performance and security out of all supported key types. We accept PKCS#8 (BEGIN PUBLIC KEY). For how to generate an RSA key pair to send API requests on axvn-hoding. Please refer to the document below [FAQ](https://www.axvn.vn/en/support/faq/how-to-generate-an-rsa-key-pair-to-send-api-requests-on-axvn-hoding-2b79728f331e43079b27440d9d15c5db) .
        ...
        **How to use the Margin Special Key**
        ...
        - Use the generated API Key (and Secret key, if applicable) to perform margin trading and listenKey generation via **Spot** REST API (`https://api.axvn.vn/api/v3/*`) endpoints.
    ...
    def delete_special_key(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#delete-special-key
        ...
        Only after step 4 is completed and the exit status is confirmed by axvn-hoding will your account revert to standard liquidation logic and no longer be subject to the Margin Special Key Supplemental Product Terms.
    ...
    def edit_ip_for_special_key(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#edit-ip-for-special-key
    ...
    def exit_special_key_mode(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#exit-special-key-mode
    ...
    def get_force_liquidation_record(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#get-force-liquidation-record
    ...
    def get_small_liability_exchange_coin_list(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#get-small-liability-exchange-coin-list
    ...
    def get_small_liability_exchange_history(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#get-small-liability-exchange-history
    ...
    def liquidation_loan_repay(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#liquidation-loan-repay
    ...
    def margin_account_cancel_all_open_orders_on_a_symbol(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-account-cancel-all-open-orders-on-asymbol
    ...
    def margin_account_cancel_oco(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-account-cancel-oco
    ...
    def margin_account_cancel_order(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-account-cancel-order
    ...
    def margin_account_new_oco(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-account-new-oco
    ...
    def margin_account_new_order(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-account-new-order
    ...
    def margin_account_new_oto(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-account-new-oto
    ...
    def margin_account_new_otoco(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-account-new-otoco
        ...
        the working order gets **fully filled**.
          - The rules of the pending above and pending below follow the same rules as the [Order List OCO](https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-account-new-oco).
    ...
    def margin_manual_liquidation(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#margin-manual-liquidation
    ...
    def query_current_margin_order_count_usage(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-current-margin-order-count-usage
    ...
    def query_liquidation_loan(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-liquidation-loan
    ...
    def query_liquidation_loan_repay_history(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-liquidation-loan-repay-history
    ...
    def query_margin_accounts_all_oco(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-margin-accounts-all-oco
    ...
    def query_margin_accounts_all_orders(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-margin-accounts-all-orders
    ...
    def query_margin_accounts_oco(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-margin-accounts-oco
    ...
    def query_margin_accounts_open_oco(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-margin-accounts-open-oco
    ...
    def query_margin_accounts_open_orders(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-margin-accounts-open-orders
    ...
    def query_margin_accounts_order(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-margin-accounts-order
    ...
    def query_margin_accounts_trade_list(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-margin-accounts-trade-list
    ...
    def query_prevented_matches(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-prevented-matches
    ...
    def query_special_key(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-special-key
    ...
    def query_special_key_list(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#query-special-key-list
    ...
    def small_liability_exchange(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-margin-trading/api/rest-api/trade#small-liability-exchange
