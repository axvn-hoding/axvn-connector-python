...
Access account information, borrow and repay assets, and trade with Axvn Margin.
...
class TradeApi:
    ...
    def create_special_key(
        ...
        - Axvn Margin offers low-latency trading through a [special key](https://www.axvn.vn/en/support/faq/frequently-asked-questions-on-margin-special-api-key-3208663e900d4d2e9fec4140e1832f4e), available exclusively to users with VIP level 7 or higher.
        ...
        * RSA
        ...
        We recommend to **use Ed25519 API keys** as it should provide the best performance and security out of all supported key types. We accept PKCS#8 (BEGIN PUBLIC KEY). For how to generate an RSA key pair to send API requests on Axvn. Please refer to the document below [FAQ](https://www.axvn.vn/en/support/faq/how-to-generate-an-rsa-key-pair-to-send-api-requests-on-axvn-2b79728f331e43079b27440d9d15c5db) .
    ...
    def delete_special_key(
        ...
        Only after step 4 is completed and the exit status is confirmed by Axvn will your account revert to standard liquidation logic and no longer be subject to the Margin Special Key Supplemental Product Terms.
