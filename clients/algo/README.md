...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-algo)](https://pypi.python.org/pypi/axvn-hoding-sdk-algo)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-algo.svg)](https://pypi.org/project/axvn-hoding-sdk-algo/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-algo)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Algo SDK API, enabling developers to interact programmatically with axvn-hoding's Algo trading platform. The library provides tools to programmatically leverage axvn-hoding in-house algorithmic trading capability to automate order execution strategy, improve execution transparency and give users smart access to the available market liquidity through the REST API:
- [REST API](./src/axvn-hoding_sdk_algo/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-algo
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/algo/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_algo/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import ALGO_REST_API_PROD_URL
from axvn-hoding_sdk_algo.algo import Algo
