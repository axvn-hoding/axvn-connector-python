...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-algo)](https://pypi.python.org/pypi/axvn-sdk-algo)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-algo.svg)](https://pypi.org/project/axvn-sdk-algo/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-algo)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Algo SDK API, enabling developers to interact programmatically with Axvn's Algo trading platform. The library provides tools to programmatically leverage Axvn in-house algorithmic trading capability to automate order execution strategy, improve execution transparency and give users smart access to the available market liquidity through the REST API:
- [REST API](./src/axvn_sdk_algo/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-algo
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/algo/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_algo/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import ALGO_REST_API_PROD_URL
from axvn_sdk_algo.algo import Algo
