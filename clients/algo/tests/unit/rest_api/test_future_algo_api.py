...
Programmatic access to axvn-hoding’s execution algorithms for creating and managing Spot and Futures algo orders.
...
from axvn-hoding_sdk_algo.rest_api.api import FutureAlgoApi
from axvn-hoding_sdk_algo.rest_api.models import CancelAlgoOrderFutureAlgoResponse
from axvn-hoding_sdk_algo.rest_api.models import (
    QueryCurrentAlgoOpenOrdersFutureAlgoResponse,
)
from axvn-hoding_sdk_algo.rest_api.models import QueryHistoricalAlgoOrdersFutureAlgoResponse
from axvn-hoding_sdk_algo.rest_api.models import QuerySubOrdersFutureAlgoResponse
from axvn-hoding_sdk_algo.rest_api.models import TimeWeightedAveragePriceFutureAlgoResponse
from axvn-hoding_sdk_algo.rest_api.models import VolumeParticipationFutureAlgoResponse


from axvn-hoding_sdk_algo.rest_api.models import QueryHistoricalAlgoOrdersFutureAlgoSideEnum
...
class TestFutureAlgoApi:
    ...
    def test_query_historical_algo_orders_future_algo_success_with_optional_params(
        ...
        params = {
            "symbol": "BTCUSDT",
            "side": QueryHistoricalAlgoOrdersFutureAlgoSideEnum["BUY"].value,
    ...
    def test_time_weighted_average_price_future_algo_success(self, mock_get_signature):
        ...
        assert (
            normalized["side"]
            == TimeWeightedAveragePriceFutureAlgoSideEnum["BUY"].value
        )
    ...
    def test_time_weighted_average_price_future_algo_success_with_optional_params(
        ...
        params = {
            ...
            "quantity": 1,
            "duration": 5000,
            "position_side": TimeWeightedAveragePriceFutureAlgoPositionSideEnum[
                "BOTH"
            ].value,
            "client_algo_id": "1",
            "reduce_only": False,
    ...
    def test_volume_participation_future_algo_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["symbol"] == "BTCUSDT"
        assert normalized["side"] == VolumeParticipationFutureAlgoSideEnum["BUY"].value
        assert normalized["quantity"] == 1
        assert (
            normalized["urgency"]
            == VolumeParticipationFutureAlgoUrgencyEnum["LOW"].value
        )
    ...
    def test_volume_participation_future_algo_success_with_optional_params(
        ...
        params = {
            ...
            "quantity": 1,
            "urgency": VolumeParticipationFutureAlgoUrgencyEnum["LOW"].value,
            "position_side": VolumeParticipationFutureAlgoPositionSideEnum[
                "BOTH"
            ].value,
            "client_algo_id": "1",
            "reduce_only": False,
