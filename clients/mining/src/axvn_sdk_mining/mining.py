...
from .rest_api import MiningRestAPI
...
class Mining:
    """Mining API that exposes REST APIs in a single interface."""
    ...
    @property
    def rest_api(self) -> MiningRestAPI:
        if self._rest_api is None and self._rest_api_config:
            ...
            self._rest_api = MiningRestAPI(self._rest_api_config)
