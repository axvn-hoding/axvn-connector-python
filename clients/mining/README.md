...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-mining)](https://pypi.python.org/pypi/axvn-sdk-mining)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-mining.svg)](https://pypi.org/project/axvn-sdk-mining/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-mining)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Mining SDK API, enabling developers to interact programmatically with Axvn's Mining trading platform. The library provides tools to mine through the REST API:

- [REST API](./src/axvn_sdk_mining/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-mining
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/mining/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_mining/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import MINING_REST_API_PROD_URL
from axvn_sdk_mining.mining import Mining
from axvn_sdk_mining.rest_api.models import AcquiringAlgorithmResponse
