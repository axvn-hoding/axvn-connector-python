...
Query mining status, earnings, and account data via the axvn-hoding Pool API.
...
from axvn-hoding_sdk_mining.rest_api.api import DefaultApi
from axvn-hoding_sdk_mining.rest_api.models import AccountListResponse
from axvn-hoding_sdk_mining.rest_api.models import AcquiringAlgorithmResponse
from axvn-hoding_sdk_mining.rest_api.models import AcquiringCoinnameResponse
from axvn-hoding_sdk_mining.rest_api.models import CancelHashrateResaleConfigurationResponse
from axvn-hoding_sdk_mining.rest_api.models import EarningsListResponse
from axvn-hoding_sdk_mining.rest_api.models import ExtraBonusListResponse
from axvn-hoding_sdk_mining.rest_api.models import HashrateResaleDetailResponse
from axvn-hoding_sdk_mining.rest_api.models import HashrateResaleListResponse
from axvn-hoding_sdk_mining.rest_api.models import HashrateResaleRequestResponse
from axvn-hoding_sdk_mining.rest_api.models import MiningAccountEarningResponse
from axvn-hoding_sdk_mining.rest_api.models import RequestForDetailMinerListResponse
from axvn-hoding_sdk_mining.rest_api.models import RequestForMinerListResponse
from axvn-hoding_sdk_mining.rest_api.models import StatisticListResponse
...
class TestDefaultApi:
    ...
    def test_account_list_success(self, mock_get_signature):
        ...
        assert normalized["algo"] == "sha256"
        assert normalized["userName"] == "test"
    ...
    def test_account_list_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"algo": "sha256", "user_name": "test", "recv_window": 5000}
    ...
    def test_acquiring_algorithm_success(self):
        ...
        expected_response = {
            ...
            "msg": "",
            "data": [
                {"algoName": "SHA256-BTC", "algoId": 1, "poolIndex": 100, "unit": "h/s"}
            ],
        }
    ...
    def test_cancel_hashrate_resale_configuration_success(self, mock_get_signature):
        ...
        assert normalized["configId"] == 168
        assert normalized["userName"] == "test"
    ...
    def test_cancel_hashrate_resale_configuration_success_with_optional_params(
        ...
        params = {"config_id": 168, "user_name": "test", "recv_window": 5000}
    ...
    def test_hashrate_resale_list_success_with_optional_params(
        ...
        params = {"page_index": 1, "page_size": 10, "recv_window": 5000}
    ...
    def test_hashrate_resale_request_success(self, mock_get_signature):
        ...
        assert normalized["userName"] == "test"
        assert normalized["algo"] == "sha256"
        assert normalized["endDate"] == 1770736694138
        assert normalized["startDate"] == 1770736694138
        assert normalized["toPoolUser"] == "S19pro"
        assert normalized["hashRate"] == 100000000
    ...
    def test_request_for_detail_miner_list_success(self, mock_get_signature):
        ...
        assert normalized["algo"] == "sha256"
        assert normalized["userName"] == "test"
        assert normalized["workerName"] == "bhdc1.16A10404B"
