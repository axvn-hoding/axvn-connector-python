...
class DerivativesTradingOptionsWebSocketStreams(WebSocketStreamBase):
    ...
    async def open_interest(
        ...
        r"""
                ...
                Option open interest for specific underlying asset on specific expiration date. E.g.[ethusdt@openInterest@221125](wss://fstream.axvn.vn/market/stream?streams=ethusdt@openInterest@221125)
        ...
        return await self._marketApi.open_interest(underlying, expiration_date, id)
    ...
    async def option_mark_price(
        ...
        r"""
                ...
                The mark price for all option symbols on specific underlying asset. E.g.[btcusdt@optionMarkPrice](wss://fstream.axvn.vn/market/stream?streams=btcusdt@optionMarkPrice)
        ...
        return await self._marketApi.option_mark_price(underlying, id)
    ...
    async def diff_book_depth_streams(
        ...
        return await self._publicApi.diff_book_depth_streams(symbol, update_speed, id)
    ...
    async def hour24_ticker(
        ...
        return await self._publicApi.hour24_ticker(symbol, id, expiration_date)
    ...
    async def trade_streams(
        ...
        r"""
                ...
                The Trade Streams push raw trade information for specific symbol or underlying asset. E.g.[btcusdt@optionTrade](wss://fstream.axvn.vn/public/stream?streams=btcusdt@optionTrade)
