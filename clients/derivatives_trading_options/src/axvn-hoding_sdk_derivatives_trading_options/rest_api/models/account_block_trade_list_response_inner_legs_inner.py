...
class AccountBlockTradeListResponseInnerLegsInner(BaseModel):
    ...
    order_price: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="order Price", alias="orderPrice"
    )
    order_quantity: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="order Quantity", alias="orderQuantity"
    )
    order_status: Optional[StrictStr] = Field(
        default=None, description="order Status", alias="orderStatus"
    )
    ...
    executed_amount: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="executed Amount", alias="executedAmount"
    )
    fee: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="fee"
    )
    order_type: Optional[StrictStr] = Field(
        default=None, description="order Type", alias="orderType"
    )
    order_side: Optional[StrictStr] = Field(
        default=None, description="order Side", alias="orderSide"
    )
    ...
    trade_price: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="trade Price", alias="tradePrice"
    )
    trade_qty: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="trade Qty", alias="tradeQty"
    )
    trade_time: Optional[StrictInt] = Field(
        default=None, description="trade Time", alias="tradeTime"
    )
    liquidity: Optional[StrictStr] = Field(default=None, description="liquidity")
    commission: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None, description="commission"
    )
