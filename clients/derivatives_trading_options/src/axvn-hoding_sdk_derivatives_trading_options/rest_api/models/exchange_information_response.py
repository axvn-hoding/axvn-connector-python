...
from axvn-hoding_sdk_derivatives_trading_options.rest_api.models.exchange_information_response_option_assets_inner import (
    ExchangeInformationResponseOptionAssetsInner,
)
from axvn-hoding_sdk_derivatives_trading_options.rest_api.models.exchange_information_response_option_contracts_inner import (
    ExchangeInformationResponseOptionContractsInner,
)
from axvn-hoding_sdk_derivatives_trading_options.rest_api.models.exchange_information_response_option_symbols_inner import (
    ExchangeInformationResponseOptionSymbolsInner,
)
from axvn-hoding_sdk_derivatives_trading_options.rest_api.models.exchange_information_response_rate_limits_inner import (
...
class ExchangeInformationResponse(BaseModel):
    ...
    timezone: Optional[StrictStr] = Field(
        default=None, description="Time zone used by the server"
    )
    server_time: Optional[StrictInt] = Field(
        default=None, description="Current system time", alias="serverTime"
    )
    option_contracts: Optional[
        List[ExchangeInformationResponseOptionContractsInner]
    ] = Field(
        default=None,
        description="Option contract underlying asset info",
        alias="optionContracts",
    )
    option_assets: Optional[List[ExchangeInformationResponseOptionAssetsInner]] = Field(
        default=None, description="Option asset info", alias="optionAssets"
    )
    option_symbols: Optional[List[ExchangeInformationResponseOptionSymbolsInner]] = (
        Field(
            default=None, description="Option trading pair info", alias="optionSymbols"
        )
    )
    rate_limits: Optional[List[ExchangeInformationResponseRateLimitsInner]] = Field(
        default=None, description="rate Limits", alias="rateLimits"
    )
