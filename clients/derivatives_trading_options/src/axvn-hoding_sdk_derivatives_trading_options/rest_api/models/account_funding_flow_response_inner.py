...
class AccountFundingFlowResponseInner(BaseModel):
    """
    AccountFundingFlowResponseInner
    """  # noqa: E501

    id: Optional[StrictInt] = Field(default=None, description="id")
    asset: Optional[StrictStr] = Field(default=None, description="Asset type")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountFundingFlowResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountFundingFlowResponseInner from a dict"""
        if obj is None:
            return None
