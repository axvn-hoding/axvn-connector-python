...
class UserCommissionResponseCommissionsInner(BaseModel):
    ...
    maker_fee: Optional[StrictStr] = Field(
        default=None, description="maker Fee", alias="makerFee"
    )
    taker_fee: Optional[StrictStr] = Field(
        default=None, description="taker Fee", alias="takerFee"
    )
