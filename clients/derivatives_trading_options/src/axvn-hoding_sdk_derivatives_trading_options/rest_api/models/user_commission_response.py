...
from axvn-hoding_sdk_derivatives_trading_options.rest_api.models.user_commission_response_commissions_inner import (
...
class UserCommissionResponse(BaseModel):
    ...
    commissions: Optional[List[UserCommissionResponseCommissionsInner]] = Field(
        default=None, description="commissions"
    )
