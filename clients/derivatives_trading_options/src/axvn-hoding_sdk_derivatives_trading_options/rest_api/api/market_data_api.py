...
class MarketDataApi:
    ...
    def check_server_time(
        ...
        """
                Check Server Time
                GET /eapi/v1/time
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#check-server-time
    ...
    def exchange_information(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#exchange-information
    ...
    def historical_exercise_records(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#historical-exercise-records
    ...
    def index_price(
        ...
        """
                Index Price
                GET /eapi/v1/index
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#index-price
    ...
    def kline_candlestick_data(
        ...
        """
                ...
                GET /eapi/v1/klines
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#kline-candlestick-data
    ...
    def open_interest(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#open-interest
    ...
    def option_mark_price(
        ...
        """
                Option Mark Price
                GET /eapi/v1/mark
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#option-mark-price
    ...
    def order_book(
        ...
        """
                Order Book
                GET /eapi/v1/depth
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#order-book
    ...
    def recent_block_trades_list(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#recent-block-trades-list
    ...
    def recent_trades_list(
        ...
        """
                Recent Trades List
                GET /eapi/v1/trades
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#recent-trades-list
    ...
    def test_connectivity(
        ...
        """
                Test Connectivity
                GET /eapi/v1/ping
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#test-connectivity
    ...
    def ticker24hr_price_change_statistics(
        ...
        """
                ...
                GET /eapi/v1/ticker
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-options/api/rest-api/market-data#ticker24hr-price-change-statistics
