# Axvn Python Derivatives Trading (Options) SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-derivatives-trading-options)](https://pypi.python.org/pypi/axvn-sdk-derivatives-trading-options)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-derivatives-trading-options.svg)](https://pypi.org/project/axvn-sdk-derivatives-trading-options/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-derivatives-trading-options)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Derivatives Trading Options SDK API, enabling developers to interact programmatically with Axvn's API to suit their derivative trading needs, through three distinct endpoints:
- [REST API](./src/axvn_sdk_derivatives_trading_options/rest_api/rest_api.py)
- [WebSocket Stream](./src/axvn_sdk_derivatives_trading_options/websocket_streams/websocket_streams.py)
...
```bash
pip install axvn-sdk-derivatives-trading-options
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/derivatives/option/general-info).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_derivatives_trading_options/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import DERIVATIVES_TRADING_OPTIONS_REST_API_PROD_URL
from axvn_sdk_derivatives_trading_options.derivatives_trading_options import DerivativesTradingOptions
from axvn_sdk_derivatives_trading_options.rest_api.models import OptionAccountInformationResponse
...
WebSocket Streams provide real-time data feeds for market trades, candlesticks, and more. Use the [websocket-streams](./src/axvn_sdk_derivatives_trading_options/websocket_streams/websocket_streams.py) module to suaxvnscribe to these streams.

```python
from axvn_common.configuration import ConfigurationWebSocketStreams
from axvn_common.constants import DERIVATIVES_TRADING_OPTIONS_WS_STREAMS_PROD_URL
from axvn_sdk_derivatives_trading_options.derivatives_trading_options import DerivativesTradingOptions
