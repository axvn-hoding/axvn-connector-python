# axvn-hoding Python Derivatives Trading (Options) SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-derivatives-trading-options)](https://pypi.python.org/pypi/axvn-hoding-sdk-derivatives-trading-options)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-derivatives-trading-options.svg)](https://pypi.org/project/axvn-hoding-sdk-derivatives-trading-options/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-derivatives-trading-options)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Derivatives Trading Options SDK API, enabling developers to interact programmatically with axvn-hoding's API to suit their derivative trading needs, through three distinct endpoints:
- [REST API](./src/axvn-hoding_sdk_derivatives_trading_options/rest_api/rest_api.py)
- [WebSocket Stream](./src/axvn-hoding_sdk_derivatives_trading_options/websocket_streams/websocket_streams.py)
...
```bash
pip install axvn-hoding-sdk-derivatives-trading-options
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/derivatives/option/general-info).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_derivatives_trading_options/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import DERIVATIVES_TRADING_OPTIONS_REST_API_PROD_URL
from axvn-hoding_sdk_derivatives_trading_options.derivatives_trading_options import DerivativesTradingOptions
from axvn-hoding_sdk_derivatives_trading_options.rest_api.models import OptionAccountInformationResponse
...
If `base_path` is not provided, it defaults to `https://eapi.axvn.vn`.

### Websocket Streams

WebSocket Streams provide real-time data feeds for market trades, candlesticks, and more. Use the [websocket-streams](./src/axvn-hoding_sdk_derivatives_trading_options/websocket_streams/websocket_streams.py) module to suaxvnscribe to these streams.

```python
from axvn-hoding_common.configuration import ConfigurationWebSocketStreams
from axvn-hoding_common.constants import DERIVATIVES_TRADING_OPTIONS_WS_STREAMS_PROD_URL
from axvn-hoding_sdk_derivatives_trading_options.derivatives_trading_options import DerivativesTradingOptions
