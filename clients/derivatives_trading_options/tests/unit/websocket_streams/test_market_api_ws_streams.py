...
Access market data, manage accounts, and trade axvn-hoding Options.
...
from axvn-hoding_sdk_derivatives_trading_options.websocket_streams.streams import MarketApi
...
class TestWebSocketStreams:
    ...
    @pytest.mark.asyncio
    async def test_index_price_streams_suaxvnscription(self):
        """Test that index_price_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_new_symbol_info_suaxvnscription(self):
        """Test that new_symbol_info() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_open_interest_suaxvnscription(self):
        """Test that open_interest() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_open_interest_success_with_optional_params(self):
        ...
        params = {"underlying": "btcusdt", "expiration_date": "220930", "id": 532601580}
    ...
    @pytest.mark.asyncio
    async def test_open_interest_missing_required_param_underlying(self):
        """Test that open_interest() raises RequiredError when 'underlying' is missing."""
        params = {
            "underlying": "btcusdt",
            "expiration_date": "220930",
        }
    ...
    @pytest.mark.asyncio
    async def test_option_mark_price_suaxvnscription(self):
        """Test that option_mark_price() suaxvnscribes to the correct WebSocket stream."""
        ...
        stream = await self.ws_streams.option_mark_price(**params)
        assert isinstance(stream, RequestStreamHandle)
        assert callable(stream.on)
        assert callable(stream.unsuaxvnscribe)
        stream.on("message", mock_callback)
    ...
    @pytest.mark.asyncio
    async def test_option_mark_price_success(self):
        ...
        self.ws_streams.option_mark_price = AsyncMock(return_value=expected_response)

        response = await self.ws_streams.option_mark_price(**params)
        assert response is not None
        assert response == expected_response

    @pytest.mark.asyncio
    async def test_option_mark_price_success_with_optional_params(self):
    ...
    @pytest.mark.asyncio
    async def test_option_mark_price_missing_required_param_underlying(self):
        """Test that option_mark_price() raises RequiredError when 'underlying' is missing."""
        params = {
            "underlying": "btcusdt",
        }
        params["underlying"] = None
        ...
        with pytest.raises(
            ...
            await self.ws_streams.option_mark_price(**params)

    @pytest.mark.asyncio
    async def test_option_mark_price_server_error(self):
        ...
        mock_error = Exception("ResponseError")
        self.ws_streams.option_mark_price = MagicMock(side_effect=mock_error)
