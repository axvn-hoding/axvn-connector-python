...
from axvn-hoding_sdk_derivatives_trading_options.websocket_streams.streams import PublicApi
...
class TestWebSocketStreams:
    ...
    @pytest.mark.asyncio
    async def test_hour24_ticker_suaxvnscription(self):
        """Test that hour24_ticker() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_trade_streams_suaxvnscription(self):
        """Test that trade_streams() suaxvnscribes to the correct WebSocket stream."""
