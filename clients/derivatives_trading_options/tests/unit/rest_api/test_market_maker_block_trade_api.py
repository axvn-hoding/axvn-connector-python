...
from axvn-hoding_sdk_derivatives_trading_options.rest_api.api import (
...
class TestMarketMakerBlockTradeApi:
    ...
    def test_accept_block_trade_order_success(self, mock_get_signature):
        ...
        assert (
            normalized["blockOrderMatchingKey"]
            == "7d046e6e-a429-4335-ab9d-6a681febcde5"
        )
    ...
    def test_extend_block_trade_order_success(self, mock_get_signature):
        ...
        assert (
            normalized["blockOrderMatchingKey"]
            == "3668822b8-1baa-6a2f-adb8-d3de6289b361"
        )
    ...
    def test_new_block_trade_order_success(self, mock_get_signature):
        ...
        params = {
            "liquidity": NewBlockTradeOrderLiquidityEnum["MAKER"].value,
            "legs": [
                NewBlockTradeOrderLegsParameterInner(
        ...
        assert "/eapi/v1/block/order/create" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["liquidity"] == NewBlockTradeOrderLiquidityEnum["MAKER"].value
    ...
    def test_query_block_trade_details_success(self, mock_get_signature):
        ...
        assert (
            normalized["blockOrderMatchingKey"]
            == "12b96c28-ba05-8906-c89t-703215cfb2e6"
        )
