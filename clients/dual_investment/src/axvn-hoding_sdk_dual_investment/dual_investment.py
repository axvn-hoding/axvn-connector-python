...
class DualInvestment:
    """DualInvestment API that exposes REST APIs in a single interface."""
    ...
    @property
    def rest_api(self) -> DualInvestmentRestAPI:
        if self._rest_api is None and self._rest_api_config:
            ...
            self._rest_api = DualInvestmentRestAPI(self._rest_api_config)
