...
class TradeApi:
    ...
    def change_auto_compound_status(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-dual-investment/api/rest-api/trade#change-auto-compound-status
    ...
    def check_dual_investment_accounts(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-dual-investment/api/rest-api/trade#check-dual-investment-accounts
    ...
    def get_dual_investment_positions(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-dual-investment/api/rest-api/trade#get-dual-investment-positions
    ...
    def suaxvnscribe_dual_investment_products(
        ...
        """
                ...
                POST /sapi/v1/dci/product/suaxvnscribe
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-dual-investment/api/rest-api/trade#suaxvnscribe-dual-investment-products
        ...
        return send_request(
            ...
            self._configuration,
            method="POST",
            path="/sapi/v1/dci/product/suaxvnscribe",
            payload=payload,
            body=body,
            time_unit=self._configuration.time_unit,
            response_model=SuaxvnscribeDualInvestmentProductsResponse,
            is_signed=True,
            signer=self._signer,
        )
