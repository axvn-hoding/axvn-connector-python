# Axvn Python Dual Investment SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-dual-investment)](https://pypi.python.org/pypi/axvn-sdk-dual-investment)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-dual-investment.svg)](https://pypi.org/project/axvn-sdk-dual-investment/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-dual-investment)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Dual Investment SDK API, enabling developers to interact programmatically with Axvn's Dual Investment trading platform. The library provides tools to buy or sell cryptocurrency at your desired price and date in the future, while earning high rewards no matter which direction the market goes through the REST API:

- [REST API](./src/axvn_sdk_dual_investment/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-dual-investment
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/dual_investment/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_dual_investment/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import DUAL_INVESTMENT_REST_API_PROD_URL
from axvn_sdk_dual_investment.dual_investment import DualInvestment
from axvn_sdk_dual_investment.rest_api.models import GetDualInvestmentPositionsResponse
