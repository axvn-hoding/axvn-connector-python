# axvn-hoding Python Dual Investment SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-dual-investment)](https://pypi.python.org/pypi/axvn-hoding-sdk-dual-investment)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-dual-investment.svg)](https://pypi.org/project/axvn-hoding-sdk-dual-investment/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-dual-investment)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Dual Investment SDK API, enabling developers to interact programmatically with axvn-hoding's Dual Investment trading platform. The library provides tools to buy or sell cryptocurrency at your desired price and date in the future, while earning high rewards no matter which direction the market goes through the REST API:

- [REST API](./src/axvn-hoding_sdk_dual_investment/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-dual-investment
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/dual_investment/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_dual_investment/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import DUAL_INVESTMENT_REST_API_PROD_URL
from axvn-hoding_sdk_dual_investment.dual_investment import DualInvestment
from axvn-hoding_sdk_dual_investment.rest_api.models import GetDualInvestmentPositionsResponse
