...
from axvn-hoding_sdk_dual_investment.rest_api.api import TradeApi
from axvn-hoding_sdk_dual_investment.rest_api.models import ChangeAutoCompoundStatusResponse
...
from axvn-hoding_sdk_dual_investment.rest_api.models import (
    SuaxvnscribeDualInvestmentProductsResponse,
)
...
class TestTradeApi:
    ...
    def test_change_auto_compound_status_success(self, mock_get_signature):
        ...
        assert normalized["positionId"] == "741590"
        assert (
            normalized["autoCompoundPlan"]
            == ChangeAutoCompoundStatusAutoCompoundPlanEnum["NONE"].value
        )
    ...
    def test_change_auto_compound_status_missing_required_param_auto_compound_plan(
        self,
    ):
        """Test that change_auto_compound_status() raises RequiredError when 'auto_compound_plan' is missing."""
        params = {
            "position_id": "741590",
            "auto_compound_plan": ChangeAutoCompoundStatusAutoCompoundPlanEnum[
                "NONE"
            ...
            "list": [
                {
                    ...
                    "suaxvnscriptionTime": 1708243200000,
                }
            ],
        }
        mock_get_signature.return_value = "mocked_signature"
    ...
    def test_get_dual_investment_positions_success_with_optional_params(
        ...
        params = {
            "status": GetDualInvestmentPositionsStatusEnum["PENDING"].value,
            "page_size": 10,
            "page_index": 1,
            "recv_window": 5000,
        }
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_suaxvnscribe_dual_investment_products_success(self, mock_get_signature):
        """Test suaxvnscribe_dual_investment_products() successfully with required parameters only."""
        ...
        response = self.client.suaxvnscribe_dual_investment_products(**params)
        ...
        assert "url" in request_kwargs
        assert "signature" in parse_qs(request_kwargs["params"])
        assert "/sapi/v1/dci/product/suaxvnscribe" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["id"] == "741590"
        assert normalized["orderId"] == "8257205859"
        assert normalized["depositAmount"] == 1
        assert (
            normalized["autoCompoundPlan"]
            == SuaxvnscribeDualInvestmentProductsAutoCompoundPlanEnum["NONE"].value
        )
        ...
        is_oneof = is_one_of_model(SuaxvnscribeDualInvestmentProductsResponse)
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(SuaxvnscribeDualInvestmentProductsResponse, "from_dict")
        ):
            expected = SuaxvnscribeDualInvestmentProductsResponse.from_dict(
                expected_response
            )
        else:
            expected = SuaxvnscribeDualInvestmentProductsResponse.model_validate_json(
                json.dumps(expected_response)
            )
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_suaxvnscribe_dual_investment_products_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test suaxvnscribe_dual_investment_products() successfully with optional parameters."""
    ...
    def test_suaxvnscribe_dual_investment_products_missing_required_param_id(self):
        """Test that suaxvnscribe_dual_investment_products() raises RequiredError when 'id' is missing."""
        params = {
            "id": "741590",
            "order_id": "8257205859",
            "deposit_amount": 1,
        ...
        with pytest.raises(RequiredError, match="Missing required parameter 'id'"):
            self.client.suaxvnscribe_dual_investment_products(**params)

    def test_suaxvnscribe_dual_investment_products_missing_required_param_order_id(self):
        """Test that suaxvnscribe_dual_investment_products() raises RequiredError when 'order_id' is missing."""
        params = {
            "id": "741590",
            "order_id": "8257205859",
            "deposit_amount": 1,
    ...
    def test_suaxvnscribe_dual_investment_products_missing_required_param_deposit_amount(
        self,
    ):
        """Test that suaxvnscribe_dual_investment_products() raises RequiredError when 'deposit_amount' is missing."""
        params = {
            "id": "741590",
            "order_id": "8257205859",
            "deposit_amount": 1,
    ...
    def test_suaxvnscribe_dual_investment_products_missing_required_param_auto_compound_plan(
        self,
    ):
        """Test that suaxvnscribe_dual_investment_products() raises RequiredError when 'auto_compound_plan' is missing."""
        params = {
            "id": "741590",
            "order_id": "8257205859",
            "deposit_amount": 1,
    ...
    def test_suaxvnscribe_dual_investment_products_server_error(self):
        """Test that suaxvnscribe_dual_investment_products() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.suaxvnscribe_dual_investment_products = MagicMock(
