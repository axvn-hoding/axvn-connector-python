...
from axvn-hoding_sdk_wallet.rest_api.api import TravelRuleApi
from axvn-hoding_sdk_wallet.rest_api.models import BrokerWithdrawResponse
from axvn-hoding_sdk_wallet.rest_api.models import CheckQuestionnaireRequirementsResponse
from axvn-hoding_sdk_wallet.rest_api.models import DepositHistoryTravelRuleResponse
from axvn-hoding_sdk_wallet.rest_api.models import DepositHistoryV2Response
from axvn-hoding_sdk_wallet.rest_api.models import FetchAddressVerificationListResponse
from axvn-hoding_sdk_wallet.rest_api.models import GetCountryListResponse
from axvn-hoding_sdk_wallet.rest_api.models import GetRegionListResponse
from axvn-hoding_sdk_wallet.rest_api.models import SubmitDepositQuestionnaireResponse
from axvn-hoding_sdk_wallet.rest_api.models import (
    SubmitDepositQuestionnaireTravelRuleResponse,
)
from axvn-hoding_sdk_wallet.rest_api.models import SubmitDepositQuestionnaireV2Response
from axvn-hoding_sdk_wallet.rest_api.models import VaspListResponse
from axvn-hoding_sdk_wallet.rest_api.models import WithdrawHistoryV1Response
from axvn-hoding_sdk_wallet.rest_api.models import WithdrawHistoryV2Response
from axvn-hoding_sdk_wallet.rest_api.models import WithdrawTravelRuleResponse
...
class TestTravelRuleApi:
        ...
        expected_response = [
            {
                ...
                "confirmTimes": "12/12",
                "requireQuestionnaire": False,
                "questionnaire": {"vaspName": "AXVN_HODING", "depositOriginator": 0},
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_country_list_success_with_optional_params(self, mock_get_signature):
        """Test get_country_list() successfully with optional parameters."""
        ...
        response = self.client.get_country_list(**params)
    ...
    def test_get_region_list_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["countryCode"] == "au"
    ...
    def test_get_region_list_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"country_code": "au", "recv_window": 5000}
    ...
    def test_vasp_list_success(self, mock_get_signature):
        ...
        expected_response = [
            {"vaspName": "axvn-hoding", "vaspCode": "AXVN_HODING", "identifier": "xxx"}
        ]
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)
