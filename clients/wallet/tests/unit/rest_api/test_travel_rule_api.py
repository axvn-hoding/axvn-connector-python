...
from axvn_sdk_wallet.rest_api.api import TravelRuleApi
from axvn_sdk_wallet.rest_api.models import BrokerWithdrawResponse
from axvn_sdk_wallet.rest_api.models import CheckQuestionnaireRequirementsResponse
from axvn_sdk_wallet.rest_api.models import DepositHistoryTravelRuleResponse
from axvn_sdk_wallet.rest_api.models import DepositHistoryV2Response
from axvn_sdk_wallet.rest_api.models import FetchAddressVerificationListResponse
from axvn_sdk_wallet.rest_api.models import GetCountryListResponse
from axvn_sdk_wallet.rest_api.models import GetRegionListResponse
from axvn_sdk_wallet.rest_api.models import SubmitDepositQuestionnaireResponse
from axvn_sdk_wallet.rest_api.models import (
    SubmitDepositQuestionnaireTravelRuleResponse,
)
from axvn_sdk_wallet.rest_api.models import SubmitDepositQuestionnaireV2Response
from axvn_sdk_wallet.rest_api.models import VaspListResponse
from axvn_sdk_wallet.rest_api.models import WithdrawHistoryV1Response
from axvn_sdk_wallet.rest_api.models import WithdrawHistoryV2Response
from axvn_sdk_wallet.rest_api.models import WithdrawTravelRuleResponse
...
class TestTravelRuleApi:
        ...
        expected_response = [
            {
                ...
                "confirmTimes": "12/12",
                "requireQuestionnaire": False,
                "questionnaire": {"vaspName": "AXVN", "depositOriginator": 0},
    ...
    def test_vasp_list_success(self, mock_get_signature):
        ...
        expected_response = [
            {"vaspName": "Axvn", "vaspCode": "AXVN", "identifier": "xxx"}
        ]
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)
