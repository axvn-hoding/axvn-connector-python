...
from axvn-hoding_sdk_wallet.rest_api.api import AccountApi
from axvn-hoding_sdk_wallet.rest_api.models import AccountApiTradingStatusResponse
from axvn-hoding_sdk_wallet.rest_api.models import AccountInfoResponse
from axvn-hoding_sdk_wallet.rest_api.models import AccountStatusResponse
from axvn-hoding_sdk_wallet.rest_api.models import DailyAccountSnapshotResponse


from axvn-hoding_sdk_wallet.rest_api.models import GetApiKeyPermissionResponse
...
class TestAccountApi:
    ...
    def test_daily_account_snapshot_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["type"] == DailyAccountSnapshotTypeEnum["SPOT"].value
