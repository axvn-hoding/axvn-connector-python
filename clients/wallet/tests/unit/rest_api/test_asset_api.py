...
Query balances, manage assets, and perform wallet operations via the axvn-hoding Wallet API.
...
from axvn-hoding_sdk_wallet.rest_api.api import AssetApi
from axvn-hoding_sdk_wallet.rest_api.models import AssetDetailResponse
from axvn-hoding_sdk_wallet.rest_api.models import AssetDividendRecordResponse
from axvn-hoding_sdk_wallet.rest_api.models import DustConvertResponse
from axvn-hoding_sdk_wallet.rest_api.models import DustConvertibleAssetsResponse
from axvn-hoding_sdk_wallet.rest_api.models import DustTransferResponse
from axvn-hoding_sdk_wallet.rest_api.models import DustlogResponse
from axvn-hoding_sdk_wallet.rest_api.models import FundingWalletResponse
from axvn-hoding_sdk_wallet.rest_api.models import (
    GetAssetsThatCanBeConvertedIntoBnbResponse,
)
from axvn-hoding_sdk_wallet.rest_api.models import (
    GetCloudMiningPaymentAndRefundHistoryResponse,
)
from axvn-hoding_sdk_wallet.rest_api.models import GetOpenSymbolListResponse
from axvn-hoding_sdk_wallet.rest_api.models import GetSpotAssetTagsResponse
from axvn-hoding_sdk_wallet.rest_api.models import QueryUserDelegationHistoryResponse
from axvn-hoding_sdk_wallet.rest_api.models import QueryUserUniversalTransferHistoryResponse
from axvn-hoding_sdk_wallet.rest_api.models import QueryUserWalletBalanceResponse
from axvn-hoding_sdk_wallet.rest_api.models import (
    ToggleBnbBurnOnSpotTradeAndMarginInterestResponse,
)
from axvn-hoding_sdk_wallet.rest_api.models import TradeFeeResponse
from axvn-hoding_sdk_wallet.rest_api.models import UserAssetResponse
from axvn-hoding_sdk_wallet.rest_api.models import UserUniversalTransferResponse


from axvn-hoding_sdk_wallet.rest_api.models import DustTransferAccountTypeEnum

from axvn-hoding_sdk_wallet.rest_api.models import DustlogAccountTypeEnum
...
from axvn-hoding_sdk_wallet.rest_api.models import QueryUserDelegationHistoryTypeEnum
...
from axvn-hoding_sdk_wallet.rest_api.models import UserUniversalTransferFromSymbolEnum
from axvn-hoding_sdk_wallet.rest_api.models import UserUniversalTransferToSymbolEnum
...
class TestAssetApi:
    ...
    def test_asset_detail_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"asset": "BTC", "recv_window": 5000}
    ...
    def test_dust_convertible_assets_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["targetAsset"] == "BTC"
    ...
    def test_dust_transfer_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            "asset": "BTC",
            "account_type": DustTransferAccountTypeEnum["SPOT"].value,
            "recv_window": 5000,
        }
    ...
    def test_dustlog_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            "account_type": DustlogAccountTypeEnum["SPOT"].value,
            "start_time": 1623319461670,
            "end_time": 1641782889000,
            "recv_window": 5000,
        }
    ...
    def test_funding_wallet_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"asset": "BTC", "need_btc_valuation": True, "recv_window": 5000}
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_assets_that_can_be_converted_into_axvn_success(
        self, mock_get_signature
    ):
        """Test get_assets_that_can_be_converted_into_axvn() successfully with required parameters only."""
            ...
            "details": [
                {
                    ...
                    "toBTC": "0.00016848",
                    "toAXVN": "0.01777302",
                    "toAXVNOffExchange": "0.01741756",
                    "exchange": "0.00035546",
                }
            ],
            "totalTransferBtc": "0.00016848",
            "totalTransferAXVN": "0.01777302",
            "dribbletPercentage": "0.02",
        }
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)

        response = self.client.get_assets_that_can_be_converted_into_axvn()
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_assets_that_can_be_converted_into_axvn_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test get_assets_that_can_be_converted_into_axvn() successfully with optional parameters."""

        params = {
            "account_type": GetAssetsThatCanBeConvertedIntoBnbAccountTypeEnum[
                "SPOT"
            ].value,
            "recv_window": 5000,
        }
        ...
        response = self.client.get_assets_that_can_be_converted_into_axvn(**params)
    ...
    def test_get_assets_that_can_be_converted_into_axvn_server_error(self):
        """Test that get_assets_that_can_be_converted_into_axvn() raises an error when the server returns an error."""

        mock_error = Exception("ResponseError")
        self.client.get_assets_that_can_be_converted_into_axvn = MagicMock(
            side_effect=mock_error
        )

        with pytest.raises(Exception, match="ResponseError"):
            self.client.get_assets_that_can_be_converted_into_axvn()
    ...
    def test_get_open_symbol_list_success(self):
        ...
        expected_response = [{"openTime": 1686161202000, "symbols": ["AXVNBTC"]}]
    ...
    def test_get_spot_asset_tags_success_with_optional_params(self):
        ...
        params = {"tag": "Layer1_Layer2,AXVNSC"}
    ...
    def test_query_user_delegation_history_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["email"] == "abc@test.com"
        assert normalized["startTime"] == 1623319461670
        assert normalized["endTime"] == 1641782889000
    ...
    def test_query_user_delegation_history_success_with_optional_params(
        ...
        params = {
            ...
            "start_time": 1623319461670,
            "end_time": 1641782889000,
            "type": QueryUserDelegationHistoryTypeEnum["DELEGATE"].value,
            "asset": "BTC",
            "current": 1,
            "size": 10,
            "recv_window": 5000,
    ...
    def test_query_user_universal_transfer_history_success_with_optional_params(
        ...
        params = {
            ...
            "current": 1,
            "size": 10,
            "from_symbol": QueryUserUniversalTransferHistoryFromSymbolEnum[
                "ISOLATEDMARGIN_MARGIN"
            ].value,
            "to_symbol": QueryUserUniversalTransferHistoryToSymbolEnum[
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_toggle_axvn_burn_on_spot_trade_and_margin_interest_success(
        self, mock_get_signature
    ):
        """Test toggle_axvn_burn_on_spot_trade_and_margin_interest() successfully with required parameters only."""

        expected_response = {"spotAXVNBurn": True, "interestAXVNBurn": False}
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)

        response = self.client.toggle_axvn_burn_on_spot_trade_and_margin_interest()
        ...
        assert "url" in request_kwargs
        assert "signature" in parse_qs(request_kwargs["params"])
        assert "/sapi/v1/axvnBurn" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_toggle_axvn_burn_on_spot_trade_and_margin_interest_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test toggle_axvn_burn_on_spot_trade_and_margin_interest() successfully with optional parameters."""

        params = {
            "spot_axvn_burn": "True",
            "interest_axvn_burn": "True",
            "recv_window": 5000,
        }
    ...
    def test_toggle_axvn_burn_on_spot_trade_and_margin_interest_server_error(self):
        """Test that toggle_axvn_burn_on_spot_trade_and_margin_interest() raises an error when the server returns an error."""

        mock_error = Exception("ResponseError")
        self.client.toggle_axvn_burn_on_spot_trade_and_margin_interest = MagicMock(
            side_effect=mock_error
        )

        with pytest.raises(Exception, match="ResponseError"):
            self.client.toggle_axvn_burn_on_spot_trade_and_margin_interest()
    ...
    def test_trade_fee_success(self, mock_get_signature):
        ...
        expected_response = [
            {"symbol": "ADAAXVN", "makerCommission": "0.001", "takerCommission": "0.001"}
        ]
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)
    ...
    def test_trade_fee_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"symbol": "ADAAXVN", "recv_window": 5000}
    ...
    def test_user_universal_transfer_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert (
            normalized["type"] == UserUniversalTransferTypeEnum["MAIN_UMFUTURE"].value
        )
        assert normalized["asset"] == "BTC"
    ...
    def test_user_universal_transfer_success_with_optional_params(
        ...
        params = {
            ...
            "asset": "BTC",
            "amount": 1.0,
            "from_symbol": UserUniversalTransferFromSymbolEnum[
                "ISOLATEDMARGIN_MARGIN"
            ].value,
            "to_symbol": UserUniversalTransferToSymbolEnum[
                "MARGIN_ISOLATEDMARGIN"
            ].value,
            "recv_window": 5000,
        }
