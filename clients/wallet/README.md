...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-wallet)](https://pypi.python.org/pypi/axvn-sdk-wallet)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-wallet.svg)](https://pypi.org/project/axvn-sdk-wallet/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-wallet)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Wallet SDK API, enabling developers to interact programmatically with Axvn's Wallet trading platform. The library provides tools to interact with wallet related functions like dust convert/ query balance etc through the REST API:
- [REST API](./src/axvn_sdk_wallet/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-wallet
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/wallet/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_wallet/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import WALLET_REST_API_PROD_URL
