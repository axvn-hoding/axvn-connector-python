...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-wallet)](https://pypi.python.org/pypi/axvn-hoding-sdk-wallet)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-wallet.svg)](https://pypi.org/project/axvn-hoding-sdk-wallet/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-wallet)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Wallet SDK API, enabling developers to interact programmatically with axvn-hoding's Wallet trading platform. The library provides tools to interact with wallet related functions like dust convert/ query balance etc through the REST API:
- [REST API](./src/axvn-hoding_sdk_wallet/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-wallet
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/wallet/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_wallet/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import WALLET_REST_API_PROD_URL
