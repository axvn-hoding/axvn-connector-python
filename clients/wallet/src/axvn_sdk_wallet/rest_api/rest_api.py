...
class WalletRestAPI:
    ...
    def enable_fast_withdraw_switch(
        ...
        - When Fast Withdraw Switch is on, transferring funds to a Axvn account will be done instantly. There is no on-chain transaction, no transaction ID and no withdrawal fee.
