...
class WalletRestAPI:
    ...
    def enable_fast_withdraw_switch(
        ...
        - When Fast Withdraw Switch is on, transferring funds to a axvn-hoding account will be done instantly. There is no on-chain transaction, no transaction ID and no withdrawal fee.
    ...
    def get_assets_that_can_be_converted_into_axvn(
        ...
        return self._assetApi.get_assets_that_can_be_converted_into_axvn(
    ...
    def toggle_axvn_burn_on_spot_trade_and_margin_interest(
        ...
        return self._assetApi.toggle_axvn_burn_on_spot_trade_and_margin_interest(
            spot_axvn_burn, interest_axvn_burn, recv_window
        )
