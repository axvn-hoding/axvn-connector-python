...
from axvn-hoding_sdk_wallet.rest_api.models.account_api_trading_status_response_data_trigger_condition import (
...
class AccountApiTradingStatusResponseData(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountApiTradingStatusResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountApiTradingStatusResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "triggerCondition": (
                    AccountApiTradingStatusResponseDataTriggerCondition.from_dict(
                        obj["triggerCondition"]
                    )
                    if obj.get("triggerCondition") is not None
                    else None
                ),
