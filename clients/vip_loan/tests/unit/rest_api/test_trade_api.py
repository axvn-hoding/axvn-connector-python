...
from axvn-hoding_sdk_vip_loan.rest_api.api import TradeApi
from axvn-hoding_sdk_vip_loan.rest_api.models import VipLoanBorrowResponse
from axvn-hoding_sdk_vip_loan.rest_api.models import VipLoanFixedRateBorrowResponse
from axvn-hoding_sdk_vip_loan.rest_api.models import VipLoanRenewResponse
from axvn-hoding_sdk_vip_loan.rest_api.models import VipLoanRepayResponse
...
class TestTradeApi:
    ...
    def test_vip_loan_fixed_rate_borrow_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["supplyRequest"] == "1212:0.12:100;3434:0.13:50"
        assert normalized["borrowCoin"] == "BUSD"
        assert normalized["loanTerm"] == 30
        assert normalized["borrowUid"] == 12345678
        assert normalized["collateralCoin"] == "AXVN,ETH,BTC"
    ...
    def test_vip_loan_renew_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"order_id": 1, "loan_term": 30, "recv_window": 5000}
