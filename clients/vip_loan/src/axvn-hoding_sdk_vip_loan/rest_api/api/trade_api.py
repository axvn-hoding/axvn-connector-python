...
class TradeApi:
    ...
    def vip_loan_borrow(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-vip-loan/api/rest-api/trade#vip-loan-borrow
    ...
    def vip_loan_fixed_rate_borrow(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-vip-loan/api/rest-api/trade#vip-loan-fixed-rate-borrow
    ...
    def vip_loan_renew(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-vip-loan/api/rest-api/trade#vip-loan-renew
    ...
    def vip_loan_repay(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-vip-loan/api/rest-api/trade#vip-loan-repay
