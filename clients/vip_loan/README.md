# axvn-hoding Python VIP Loan SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-vip-loan)](https://pypi.python.org/pypi/axvn-hoding-sdk-vip-loan)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-vip-loan.svg)](https://pypi.org/project/axvn-hoding-sdk-vip-loan/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-vip-loan)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding VIP Loan SDK API, enabling developers to interact programmatically with axvn-hoding's VIP Loan trading platform. The library provides tools to over-collateralized loan service with competitive rates, terms, and services through the REST API:

- [REST API](./src/axvn-hoding_sdk_vip_loan/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-vip-loan
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/vip_loan/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_vip_loan/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import VIP_LOAN_REST_API_PROD_URL
from axvn-hoding_sdk_vip_loan.vip_loan import VipLoan
from axvn-hoding_sdk_vip_loan.rest_api.models import GetCollateralAssetDataResponse
...
try:
    response = client.rest_api.GetCollateralAssetDataResponse()

    data: GetCollateralAssetDataResponse = response.data()
    logging.info(f"GetCollateralAssetDataResponse() response: {data}")
except Exception as e:
    logging.error(f"GetCollateralAssetDataResponse() error: {e}")
```
