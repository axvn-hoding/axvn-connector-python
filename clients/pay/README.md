...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-pay)](https://pypi.python.org/pypi/axvn-hoding-sdk-pay)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-pay.svg)](https://pypi.org/project/axvn-hoding-sdk-pay/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-pay)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Pay SDK API, enabling developers to interact programmatically with axvn-hoding's Pay trading platform. The library provides tools to query transaction history through the REST API:

- [REST API](./src/axvn-hoding_sdk_pay/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-pay
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/pay/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_pay/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import PAY_REST_API_PROD_URL
from axvn-hoding_sdk_pay.pay import Pay
from axvn-hoding_sdk_pay.rest_api.models import GetPayTradeHistoryResponse
...
try:
    ...
    logging.error(f"get_pay_trade_history() error: {e}")
```
