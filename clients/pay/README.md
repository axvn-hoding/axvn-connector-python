...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-pay)](https://pypi.python.org/pypi/axvn-sdk-pay)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-pay.svg)](https://pypi.org/project/axvn-sdk-pay/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-pay)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Pay SDK API, enabling developers to interact programmatically with Axvn's Pay trading platform. The library provides tools to query transaction history through the REST API:

- [REST API](./src/axvn_sdk_pay/rest_api/rest_api.py)
...
For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/pay/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_pay/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import PAY_REST_API_PROD_URL
from axvn_sdk_pay.pay import Pay
from axvn_sdk_pay.rest_api.models import GetPayTradeHistoryResponse
