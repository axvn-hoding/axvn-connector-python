...
from axvn-hoding_sdk_pay.rest_api.models.get_pay_trade_history_response_data_inner_funds_detail_inner import (
    GetPayTradeHistoryResponseDataInnerFundsDetailInner,
)
from axvn-hoding_sdk_pay.rest_api.models.get_pay_trade_history_response_data_inner_payer_info import (
    GetPayTradeHistoryResponseDataInnerPayerInfo,
)
from axvn-hoding_sdk_pay.rest_api.models.get_pay_trade_history_response_data_inner_receiver_info import (
...
class GetPayTradeHistoryResponseDataInner(BaseModel):
    ...
    order_type: Optional[StrictStr] = Field(
        default=None,
        description="Order type. Enum: PAY, PAY_REFUND, C2C, CRYPTO_BOX, CRYPTO_BOX_RF, C2C_HOLDING, C2C_HOLDING_RF, PAYOUT, REMITTANCE.",
        alias="orderType",
    )
    transaction_id: Optional[StrictStr] = Field(
        default=None, description="Transaction ID.", alias="transactionId"
    )
    transaction_time: Optional[StrictInt] = Field(
        default=None, description="Trade timestamp.", alias="transactionTime"
    )
    amount: Optional[StrictStr] = Field(
        default=None,
        description="Order amount (up to 8 decimal places). Positive means income; negative means expenditure.",
    )
    currency: Optional[StrictStr] = Field(default=None, description="Order asset.")
    wallet_type: Optional[StrictInt] = Field(
        default=None,
        description="Main wallet type: 1=funding wallet, 2=spot wallet, 3=fiat wallet, 4 or 6=card payment, 5=earn wallet.",
        alias="walletType",
    )
    wallet_types: Optional[List[StrictInt]] = Field(
        default=None,
        description="Array format of wallet types. Multiple values may appear for combined payments.",
        alias="walletTypes",
    )
    funds_detail: Optional[
        List[GetPayTradeHistoryResponseDataInnerFundsDetailInner]
    ] = Field(default=None, description="Funds usage details.", alias="fundsDetail")
