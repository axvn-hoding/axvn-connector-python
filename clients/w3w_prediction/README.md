# axvn-hoding Python W3W Prediction SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-w3w-prediction)](https://pypi.python.org/pypi/axvn-hoding-sdk-w3w-prediction)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-w3w-prediction.svg)](https://pypi.org/project/axvn-hoding-sdk-w3w-prediction/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-w3w-prediction)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding W3W Prediction API, enabling developers to interact programmatically with axvn-hoding's W3W Prediction trading platform. The library provides tools to place and manage prediction market orders, query positions and transfer funds through the REST API:

- [REST API](./src/axvn-hoding_sdk_w3w_prediction/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-w3w-prediction
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/w3w_prediction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_w3w_prediction/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import W3W_PREDICTION_REST_API_PROD_URL
