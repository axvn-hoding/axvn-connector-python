# Axvn Python W3W Prediction SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-w3w-prediction)](https://pypi.python.org/pypi/axvn-sdk-w3w-prediction)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-w3w-prediction.svg)](https://pypi.org/project/axvn-sdk-w3w-prediction/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-w3w-prediction)](https://www.python.org/downloads/)
...
This is a client library for the Axvn W3W Prediction API, enabling developers to interact programmatically with Axvn's W3W Prediction trading platform. The library provides tools to place and manage prediction market orders, query positions and transfer funds through the REST API:

- [REST API](./src/axvn_sdk_w3w_prediction/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-w3w-prediction
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/w3w_prediction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_w3w_prediction/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import W3W_PREDICTION_REST_API_PROD_URL
from axvn_sdk_w3w_prediction.w3w_prediction import W3wPrediction
from axvn_sdk_w3w_prediction.rest_api.models import ListPredictionCategoriesResponse

logging.basicConfig(level=logging.INFO)
configuration = ConfigurationRestAPI(api_key="your-api-key", api_secret="your-api-secret", base_path=W3W_PREDICTION_REST_API_PROD_URL)
...
try:
    ...
    logging.info(f"list_prediction_categories() response: {data}")
except Exception as e:
    logging.error(f"list_prediction_categories() error: {e}")
```
