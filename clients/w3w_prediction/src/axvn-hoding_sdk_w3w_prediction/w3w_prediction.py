...
class W3wPrediction:
    """W3wPrediction API that exposes REST APIs in a single interface."""
    ...
    @property
    def rest_api(self) -> W3wPredictionRestAPI:
        if self._rest_api is None and self._rest_api_config:
            ...
            self._rest_api = W3wPredictionRestAPI(self._rest_api_config)
