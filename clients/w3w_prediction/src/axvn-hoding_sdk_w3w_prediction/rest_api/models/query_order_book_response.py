...
from axvn-hoding_sdk_w3w_prediction.rest_api.models.query_order_book_response_asks_inner import (
    QueryOrderBookResponseAsksInner,
)
from axvn-hoding_sdk_w3w_prediction.rest_api.models.query_order_book_response_bids_inner import (
...
class QueryOrderBookResponse(BaseModel):
    """
    ...
    bids: Optional[List[QueryOrderBookResponseBidsInner]] = None
    asks: Optional[List[QueryOrderBookResponseAsksInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryOrderBookResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryOrderBookResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "bids": (
                    [
                        QueryOrderBookResponseBidsInner.from_dict(_item)
                ...
                "asks": (
                    [
                        QueryOrderBookResponseAsksInner.from_dict(_item)
