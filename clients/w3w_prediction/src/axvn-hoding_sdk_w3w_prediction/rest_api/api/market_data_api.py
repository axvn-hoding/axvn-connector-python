...
class MarketDataApi:
    ...
    def get_market_detail(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/market-data#get-market-detail
    ...
    def list_prediction_categories(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/market-data#list-prediction-categories
    ...
    def list_prediction_markets(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/market-data#list-prediction-markets
    ...
    def market_search(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/market-data#market-search
    ...
    def query_last_trade_price(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/market-data#query-last-trade-price
    ...
    def query_order_book(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/market-data#query-order-book
