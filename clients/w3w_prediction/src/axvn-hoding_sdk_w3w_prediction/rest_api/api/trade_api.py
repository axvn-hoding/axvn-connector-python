...
class TradeApi:
    ...
    def batch_cancel_orders(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/trade#batch-cancel-orders
    ...
    def get_quote(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/trade#get-quote
        ...
        - **MARKET order minimum amount:** For `MARKET` orders, `amountIn` must be at least approximately **1.5 USDT** (in wei: `1500000000000000000`). The exact minimum varies by market liquidity. If the amount is too small, the server returns `-9000 Your order amount is too small`. This limit does **not** apply to `LIMIT` orders.
                ...
                Args:
                    ...
                    chain_id (Optional[str] = None): Chain ID. Default `56` (AXVNSC)
    ...
    def place_order(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/trade#place-order
    ...
    def query_active_orders(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/trade#query-active-orders
    ...
    def query_order_history(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/web3-wallet-prediction-trading/api/rest-api/trade#query-order-history
