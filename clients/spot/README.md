...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-spot)](https://pypi.python.org/pypi/axvn-sdk-spot)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-spot.svg)](https://pypi.org/project/axvn-sdk-spot/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-spot)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Spot SDK API, enabling developers to interact programmatically with Axvn's SPOT trading platform. The library provides tools for retrieving market data, executing trades, and managing orders through three distinct endpoints:

- [REST API](./src/axvn_sdk_spot/rest_api/rest_api.py)
- [Websocket API](./src/axvn_sdk_spot/websocket_api/websocket_api.py)
- [Websocket Stream](./src/axvn_sdk_spot/websocket_streams/websocket_streams.py)
...
For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/axvn-docs-api/README).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_spot/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import SPOT_REST_API_PROD_URL
from axvn_sdk_spot.spot import Spot
from axvn_sdk_spot.rest_api.models import ExchangeInfoResponse, RateLimits
...
For testing purposes, `/api/*` endpoints can be used in the [Spot Testnet](https://testnet.axvn.vn/). Update the `base_path` in your configuration:

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import SPOT_REST_API_TESTNET_URL
from axvn_sdk_spot.spot import Spot
...
The WebSocket API provides request-response communication for market data and trading actions. Use the [`websocket_api`](./src/axvn_sdk_spot/websocket_api/websocket_api.py) module to interact with these endpoints.
...
from axvn_common.constants import SPOT_WS_API_PROD_URL
from axvn_sdk_spot.spot import Spot
from axvn_sdk_spot.websocket_api.models import AccountCommissionResponse
...
```python
from axvn_common.configuration import ConfigurationWebSocketAPI
from axvn_common.constants import SPOT_WS_API_TESTNET_URL
from axvn_sdk_spot.spot import Spot
...
WebSocket Streams provide real-time data feeds for market trades, candlesticks, and more. Use the [websocket-streams](./src/axvn_sdk_spot/websocket_streams/websocket_streams.py) module to suaxvnscribe to these streams.
...
from axvn_common.constants import SPOT_WS_STREAMS_PROD_URL
from axvn_sdk_spot.spot import Spot
