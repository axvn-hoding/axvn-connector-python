...
from axvn-hoding_sdk_spot.spot import (
    Spot,
    SPOT_WS_STREAMS_PROD_URL,
    ConfigurationWebSocketStreams,
)

from axvn-hoding_sdk_spot.websocket_streams.models import (
...
async def all_market_rolling_window_ticker():
    ...
    try:
        ...
        logging.error(f"all_market_rolling_window_ticker() error: {e}")
    finally:
        if connection:
...
if __name__ == "__main__":
    asyncio.run(all_market_rolling_window_ticker())
