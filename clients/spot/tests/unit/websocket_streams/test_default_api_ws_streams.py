...
from axvn-hoding_sdk_spot.websocket_streams.streams import DefaultApi
...
from axvn-hoding_sdk_spot.websocket_streams.models import DiffBookDepthUpdateSpeedEnum
...
from axvn-hoding_sdk_spot.websocket_streams.models import PartialBookDepthUpdateSpeedEnum
...
class TestWebSocketStreams:
    ...
    @pytest.mark.asyncio
    async def test_agg_trade_suaxvnscription(self):
        """Test that agg_trade() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_agg_trade_success_with_optional_params(self):
        ...
        params = {"symbol": "axvnusdt", "id": "e9d6b4349871b40611412680b3445fac"}
    ...
    @pytest.mark.asyncio
    async def test_all_market_rolling_window_ticker_suaxvnscription(self):
        """Test that all_market_rolling_window_ticker() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_all_mini_ticker_suaxvnscription(self):
        """Test that all_mini_ticker() suaxvnscribes to the correct WebSocket stream."""

        expected_response = [{"e": "24hrMiniTicker", "E": 1672515782136, "s": "AXVNBTC"}]
        stream_endpoint = ws_streams_placeholder(
    ...
    @pytest.mark.asyncio
    async def test_avg_price_suaxvnscription(self):
        """Test that avg_price() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_block_trade_suaxvnscription(self):
        """Test that block_trade() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_book_ticker_suaxvnscription(self):
        """Test that book_ticker() suaxvnscribes to the correct WebSocket stream."""

        params = {
            "symbol": "axvnusdt",
        }

        expected_response = {"u": 400900217, "s": "AXVNUSDT"}
        stream_endpoint = ws_streams_placeholder(
    ...
    @pytest.mark.asyncio
    async def test_diff_book_depth_suaxvnscription(self):
        """Test that diff_book_depth() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_diff_book_depth_success_with_optional_params(self):
        ...
        params = {
            "symbol": "axvnusdt",
            "id": "e9d6b4349871b40611412680b3445fac",
            "update_speed": DiffBookDepthUpdateSpeedEnum["UPDATE_SPEED_100ms"].value,
        }
    ...
    @pytest.mark.asyncio
    async def test_kline_suaxvnscription(self):
        """Test that kline() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_kline_offset_suaxvnscription(self):
        """Test that kline_offset() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_mini_ticker_suaxvnscription(self):
        """Test that mini_ticker() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_partial_book_depth_suaxvnscription(self):
        """Test that partial_book_depth() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_partial_book_depth_success_with_optional_params(self):
        ...
        params = {
            ...
            "levels": PartialBookDepthLevelsEnum["LEVELS_5"].value,
            "id": "e9d6b4349871b40611412680b3445fac",
            "update_speed": PartialBookDepthUpdateSpeedEnum["UPDATE_SPEED_100ms"].value,
        }
    ...
    @pytest.mark.asyncio
    async def test_reference_price_suaxvnscription(self):
        """Test that reference_price() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_reference_price_success_with_optional_params(self):
        ...
        params = {"symbol": "bazusd", "id": "e9d6b4349871b40611412680b3445fac"}
    ...
    @pytest.mark.asyncio
    async def test_rolling_window_ticker_suaxvnscription(self):
        """Test that rolling_window_ticker() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_ticker_suaxvnscription(self):
        """Test that ticker() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_trade_suaxvnscription(self):
        """Test that trade() suaxvnscribes to the correct WebSocket stream."""
