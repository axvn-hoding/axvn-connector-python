...
from axvn-hoding_sdk_spot.rest_api.api import MarketApi
from axvn-hoding_sdk_spot.rest_api.models import AggTradesResponse
from axvn-hoding_sdk_spot.rest_api.models import AvgPriceResponse
from axvn-hoding_sdk_spot.rest_api.models import DepthResponse
from axvn-hoding_sdk_spot.rest_api.models import GetTradesResponse
from axvn-hoding_sdk_spot.rest_api.models import HistoricalBlockTradesResponse
from axvn-hoding_sdk_spot.rest_api.models import HistoricalTradesResponse
from axvn-hoding_sdk_spot.rest_api.models import KlinesResponse
from axvn-hoding_sdk_spot.rest_api.models import ReferencePriceResponse
from axvn-hoding_sdk_spot.rest_api.models import ReferencePriceCalculationResponse
from axvn-hoding_sdk_spot.rest_api.models import TickerResponse
from axvn-hoding_sdk_spot.rest_api.models import Ticker24hrResponse
from axvn-hoding_sdk_spot.rest_api.models import TickerBookTickerResponse
from axvn-hoding_sdk_spot.rest_api.models import TickerPriceResponse
from axvn-hoding_sdk_spot.rest_api.models import TickerTradingDayResponse
from axvn-hoding_sdk_spot.rest_api.models import UiKlinesResponse


from axvn-hoding_sdk_spot.rest_api.models import DepthSymbolStatusEnum


from axvn-hoding_sdk_spot.rest_api.models import KlinesIntervalEnum


from axvn-hoding_sdk_spot.rest_api.models import ReferencePriceCalculationSymbolStatusEnum


from axvn-hoding_sdk_spot.rest_api.models import TickerWindowSizeEnum
from axvn-hoding_sdk_spot.rest_api.models import TickerTypeEnum
from axvn-hoding_sdk_spot.rest_api.models import TickerSymbolStatusEnum


from axvn-hoding_sdk_spot.rest_api.models import Ticker24hrTypeEnum
from axvn-hoding_sdk_spot.rest_api.models import Ticker24hrSymbolStatusEnum


from axvn-hoding_sdk_spot.rest_api.models import TickerBookTickerSymbolStatusEnum


from axvn-hoding_sdk_spot.rest_api.models import TickerPriceSymbolStatusEnum


from axvn-hoding_sdk_spot.rest_api.models import TickerTradingDayTypeEnum
from axvn-hoding_sdk_spot.rest_api.models import TickerTradingDaySymbolStatusEnum
...
class TestMarketApi:
    ...
    def test_get_trades_success_with_optional_params(self):
        ...
        params = {"symbol": "AXVNUSDT", "limit": 1}
    ...
    def test_historical_block_trades_success(self):
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["symbol"] == "AXVNBTC"
        assert normalized["fromId"] == 582
    ...
    def test_historical_block_trades_success_with_optional_params(self):
        ...
        params = {"symbol": "AXVNBTC", "from_id": 582, "limit": 500}
    ...
    def test_historical_trades_success_with_optional_params(self):
        ...
        params = {"symbol": "AXVNUSDT", "limit": 1, "from_id": 1}
    ...
    def test_klines_success(self):
        ...
        expected_response = [[1499040000000]]
