...
from axvn-hoding_sdk_spot.rest_api.models.order_list_opoco_response_order_reports_inner import (
    OrderListOpocoResponseOrderReportsInner,
)
from axvn-hoding_sdk_spot.rest_api.models.order_list_opoco_response_orders_inner import (
...
class OrderListOpocoResponse(BaseModel):
    """
    ...
    orders: Optional[List[OrderListOpocoResponseOrdersInner]] = None
    order_reports: Optional[List[OrderListOpocoResponseOrderReportsInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListOpocoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListOpocoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListOpocoResponseOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListOpocoResponseOrderReportsInner.from_dict(_item)
