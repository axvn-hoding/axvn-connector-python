...
from axvn-hoding_sdk_spot.rest_api.models.get_account_response_balances_inner import (
    GetAccountResponseBalancesInner,
)
from axvn-hoding_sdk_spot.rest_api.models.get_account_response_commission_rates import (
...
class GetAccountResponse(BaseModel):
    ...
    commission_rates: Optional[GetAccountResponseCommissionRates] = Field(
    ...
    balances: Optional[List[GetAccountResponseBalancesInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "commissionRates": (
                    GetAccountResponseCommissionRates.from_dict(obj["commissionRates"])
                ...
                "balances": (
                    [
                        GetAccountResponseBalancesInner.from_dict(_item)
