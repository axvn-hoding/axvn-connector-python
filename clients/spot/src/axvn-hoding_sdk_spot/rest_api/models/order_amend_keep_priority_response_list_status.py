...
from axvn-hoding_sdk_spot.rest_api.models.order_amend_keep_priority_response_list_status_orders_inner import (
...
class OrderAmendKeepPriorityResponseListStatus(BaseModel):
    """
    ...
    orders: Optional[List[OrderAmendKeepPriorityResponseListStatusOrdersInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderAmendKeepPriorityResponseListStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderAmendKeepPriorityResponseListStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderAmendKeepPriorityResponseListStatusOrdersInner.from_dict(
                            _item
                        )
