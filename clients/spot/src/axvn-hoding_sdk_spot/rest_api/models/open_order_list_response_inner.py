...
from axvn-hoding_sdk_spot.rest_api.models.open_order_list_response_inner_orders_inner import (
...
class OpenOrderListResponseInner(BaseModel):
    """
    ...
    orders: Optional[List[OpenOrderListResponseInnerOrdersInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenOrderListResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenOrderListResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OpenOrderListResponseInnerOrdersInner.from_dict(_item)
