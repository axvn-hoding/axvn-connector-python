...
from axvn-hoding_sdk_spot.rest_api.models.all_order_list_response_inner_orders_inner import (
...
class AllOrderListResponseInner(BaseModel):
    """
    ...
    orders: Optional[List[AllOrderListResponseInnerOrdersInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllOrderListResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllOrderListResponseInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        AllOrderListResponseInnerOrdersInner.from_dict(_item)
