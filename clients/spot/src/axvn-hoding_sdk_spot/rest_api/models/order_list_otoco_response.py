...
from axvn-hoding_sdk_spot.rest_api.models.order_list_otoco_response_order_reports_inner import (
    OrderListOtocoResponseOrderReportsInner,
)
from axvn-hoding_sdk_spot.rest_api.models.order_list_otoco_response_orders_inner import (
...
class OrderListOtocoResponse(BaseModel):
    """
    ...
    orders: Optional[List[OrderListOtocoResponseOrdersInner]] = None
    order_reports: Optional[List[OrderListOtocoResponseOrderReportsInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListOtocoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListOtocoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListOtocoResponseOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListOtocoResponseOrderReportsInner.from_dict(_item)
