...
class MinNotionalFilter(BaseModel):
    ...
    price_exponent: Optional[StrictInt] = Field(default=None, alias="priceExponent")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MinNotionalFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MinNotionalFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "priceExponent": obj.get("priceExponent"),
