...
from axvn-hoding_sdk_spot.rest_api.models.order_oco_response_order_reports_inner import (
    OrderOcoResponseOrderReportsInner,
)
from axvn-hoding_sdk_spot.rest_api.models.order_oco_response_orders_inner import (
...
class OrderOcoResponse(BaseModel):
    """
    OrderOcoResponse
    """  # noqa: E501
    ...
    orders: Optional[List[OrderOcoResponseOrdersInner]] = None
    order_reports: Optional[List[OrderOcoResponseOrderReportsInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderOcoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderOcoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderOcoResponseOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderOcoResponseOrderReportsInner.from_dict(_item)
