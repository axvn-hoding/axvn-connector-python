...
from axvn-hoding_sdk_spot.rest_api.models.sor_order_response_fills_inner import (
...
class SorOrderResponse(BaseModel):
    """
    SorOrderResponse
    """  # noqa: E501
    ...
    fills: Optional[List[SorOrderResponseFillsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SorOrderResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SorOrderResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "fills": (
                    [
                        SorOrderResponseFillsInner.from_dict(_item)
