...
from axvn-hoding_sdk_spot.rest_api.models.new_order_response_fills_inner import (
...
class NewOrderResponse(BaseModel):
    ...
    fills: Optional[List[NewOrderResponseFillsInner]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "fills": (
                    [
                        NewOrderResponseFillsInner.from_dict(_item)
