...
from axvn-hoding_sdk_spot.rest_api.models.order_list_opo_response_order_reports_inner import (
    OrderListOpoResponseOrderReportsInner,
)
from axvn-hoding_sdk_spot.rest_api.models.order_list_opo_response_orders_inner import (
...
class OrderListOpoResponse(BaseModel):
    """
    ...
    orders: Optional[List[OrderListOpoResponseOrdersInner]] = None
    order_reports: Optional[List[OrderListOpoResponseOrderReportsInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListOpoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListOpoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListOpoResponseOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListOpoResponseOrderReportsInner.from_dict(_item)
