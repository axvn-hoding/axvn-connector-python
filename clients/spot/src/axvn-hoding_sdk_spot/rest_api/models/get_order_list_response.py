...
from axvn-hoding_sdk_spot.rest_api.models.get_order_list_response_orders_inner import (
...
class GetOrderListResponse(BaseModel):
    ...
    orders: Optional[List[GetOrderListResponseOrdersInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetOrderListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetOrderListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        GetOrderListResponseOrdersInner.from_dict(_item)
