...
from axvn-hoding_sdk_spot.rest_api.models.order_list_oco_response_order_reports_inner import (
    OrderListOcoResponseOrderReportsInner,
)
from axvn-hoding_sdk_spot.rest_api.models.order_list_oco_response_orders_inner import (
...
class OrderListOcoResponse(BaseModel):
    """
    ...
    orders: Optional[List[OrderListOcoResponseOrdersInner]] = None
    order_reports: Optional[List[OrderListOcoResponseOrderReportsInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListOcoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListOcoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListOcoResponseOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListOcoResponseOrderReportsInner.from_dict(_item)
