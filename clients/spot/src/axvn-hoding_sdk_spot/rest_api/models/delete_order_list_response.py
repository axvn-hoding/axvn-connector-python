...
from axvn-hoding_sdk_spot.rest_api.models.delete_order_list_response_order_reports_inner import (
    DeleteOrderListResponseOrderReportsInner,
)
from axvn-hoding_sdk_spot.rest_api.models.delete_order_list_response_orders_inner import (
    DeleteOrderListResponseOrdersInner,
)
from typing import Set
from typing_extensions import Self


class DeleteOrderListResponse(BaseModel):
    """
    ...
    orders: Optional[List[DeleteOrderListResponseOrdersInner]] = None
    order_reports: Optional[List[DeleteOrderListResponseOrderReportsInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteOrderListResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteOrderListResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        DeleteOrderListResponseOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        DeleteOrderListResponseOrderReportsInner.from_dict(_item)
