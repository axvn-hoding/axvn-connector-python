...
from axvn-hoding_sdk_spot.rest_api.models.order_test_response_discount import (
    OrderTestResponseDiscount,
)
from axvn-hoding_sdk_spot.rest_api.models.order_test_response_special_commission_for_order import (
    OrderTestResponseSpecialCommissionForOrder,
)
from axvn-hoding_sdk_spot.rest_api.models.order_test_response_standard_commission_for_order import (
    OrderTestResponseStandardCommissionForOrder,
)
from axvn-hoding_sdk_spot.rest_api.models.order_test_response_tax_commission_for_order import (
...
class OrderTestResponse(BaseModel):
    ...
    tax_commission_for_order: Optional[OrderTestResponseTaxCommissionForOrder] = Field(
        default=None, alias="taxCommissionForOrder"
    )
    discount: Optional[OrderTestResponseDiscount] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderTestResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderTestResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "standardCommissionForOrder": (
                    OrderTestResponseStandardCommissionForOrder.from_dict(
                ...
                "specialCommissionForOrder": (
                    OrderTestResponseSpecialCommissionForOrder.from_dict(
                ...
                "taxCommissionForOrder": (
                    OrderTestResponseTaxCommissionForOrder.from_dict(
                ...
                "discount": (
                    OrderTestResponseDiscount.from_dict(obj["discount"])
