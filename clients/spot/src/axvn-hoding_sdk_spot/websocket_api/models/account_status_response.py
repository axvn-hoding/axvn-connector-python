...
from axvn-hoding_sdk_spot.websocket_api.models.account_status_response_result import (
...
class AccountStatusResponse(BaseModel):
    ...
    result: Optional[AccountStatusResponseResult] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    AccountStatusResponseResult.from_dict(obj["result"])
