...
from axvn-hoding_sdk_spot.websocket_api.models.order_place_response_result import (
...
class OrderPlaceResponse(BaseModel):
    ...
    result: Optional[OrderPlaceResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderPlaceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderPlaceResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    OrderPlaceResponseResult.from_dict(obj["result"])
