...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_oto_response_result_order_reports_inner import (
    OrderListPlaceOtoResponseResultOrderReportsInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_oto_response_result_orders_inner import (
    OrderListPlaceOtoResponseResultOrdersInner,
)
from typing import Set
from typing_extensions import Self


class OrderListPlaceOtoResponseResult(BaseModel):
    """
    ...
    orders: Optional[List[OrderListPlaceOtoResponseResultOrdersInner]] = Field(
        default=None, alias="orders"
    )

    order_reports: Optional[List[OrderListPlaceOtoResponseResultOrderReportsInner]] = (
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListPlaceOtoResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListPlaceOtoResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListPlaceOtoResponseResultOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListPlaceOtoResponseResultOrderReportsInner.from_dict(
                            _item
                        )
