...
from axvn-hoding_sdk_spot.websocket_api.models.account_commission_response_result import (
...
class AccountCommissionResponse(BaseModel):
    ...
    result: Optional[AccountCommissionResponseResult] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    AccountCommissionResponseResult.from_dict(obj["result"])
