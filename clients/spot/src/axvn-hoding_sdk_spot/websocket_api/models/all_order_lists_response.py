...
from axvn-hoding_sdk_spot.websocket_api.models.all_order_lists_response_result_inner import (
...
class AllOrderListsResponse(BaseModel):
    """
    ...
    result: Optional[List[AllOrderListsResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllOrderListsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllOrderListsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        AllOrderListsResponseResultInner.from_dict(_item)
