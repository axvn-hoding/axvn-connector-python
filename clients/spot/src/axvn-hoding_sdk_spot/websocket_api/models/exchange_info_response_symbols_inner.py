...
class ExchangeInfoResponseSymbolsInner(BaseModel):
    ...
    order_types: Optional[List[str]] = Field(default=None, alias="orderTypes")
    ...
    permission_sets: Optional[List[List[str]]] = Field(
    ...
    allowed_self_trade_prevention_modes: Optional[List[str]] = Field(
