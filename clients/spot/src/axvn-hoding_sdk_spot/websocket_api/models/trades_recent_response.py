...
from axvn-hoding_sdk_spot.websocket_api.models.trades_recent_response_result_inner import (
...
class TradesRecentResponse(BaseModel):
    ...
    result: Optional[List[TradesRecentResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TradesRecentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TradesRecentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        TradesRecentResponseResultInner.from_dict(_item)
