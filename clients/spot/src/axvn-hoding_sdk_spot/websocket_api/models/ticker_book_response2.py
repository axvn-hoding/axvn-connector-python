...
from axvn-hoding_sdk_spot.websocket_api.models.ticker_book_response2_result_inner import (
...
class TickerBookResponse2(BaseModel):
    """
    TickerBookResponse2
    """  # noqa: E501
    ...
    result: Optional[List[TickerBookResponse2ResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TickerBookResponse2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TickerBookResponse2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        TickerBookResponse2ResultInner.from_dict(_item)
