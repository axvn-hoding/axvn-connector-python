...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_status_response_result import (
...
class OrderListStatusResponse(BaseModel):
    """
    ...
    result: Optional[OrderListStatusResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListStatusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListStatusResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    OrderListStatusResponseResult.from_dict(obj["result"])
