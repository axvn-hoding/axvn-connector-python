...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_oco_response_result import (
...
class OrderListPlaceOcoResponse(BaseModel):
    """
    ...
    result: Optional[OrderListPlaceOcoResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListPlaceOcoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListPlaceOcoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    OrderListPlaceOcoResponseResult.from_dict(obj["result"])
