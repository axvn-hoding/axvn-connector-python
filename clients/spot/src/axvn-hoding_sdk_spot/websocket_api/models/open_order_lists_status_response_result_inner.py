...
from axvn-hoding_sdk_spot.websocket_api.models.open_order_lists_status_response_result_inner_orders_inner import (
...
class OpenOrderListsStatusResponseResultInner(BaseModel):
    """
    ...
    orders: Optional[List[OpenOrderListsStatusResponseResultInnerOrdersInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenOrderListsStatusResponseResultInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenOrderListsStatusResponseResultInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OpenOrderListsStatusResponseResultInnerOrdersInner.from_dict(
                            _item
                        )
