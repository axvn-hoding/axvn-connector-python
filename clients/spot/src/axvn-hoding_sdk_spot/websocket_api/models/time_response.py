...
from axvn-hoding_sdk_spot.websocket_api.models.time_response_result import (
    TimeResponseResult,
)
...
class TimeResponse(BaseModel):
    ...
    result: Optional[TimeResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TimeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TimeResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    TimeResponseResult.from_dict(obj["result"])
