...
from axvn-hoding_sdk_spot.websocket_api.models.open_orders_status_response_result_inner import (
...
class OpenOrdersStatusResponse(BaseModel):
    """
    ...
    result: Optional[List[OpenOrdersStatusResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenOrdersStatusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenOrdersStatusResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        OpenOrdersStatusResponseResultInner.from_dict(_item)
