...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_opoco_response_result_order_reports_inner import (
    OrderListPlaceOpocoResponseResultOrderReportsInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_opoco_response_result_orders_inner import (
...
class OrderListPlaceOpocoResponseResult(BaseModel):
    """
    ...
    orders: Optional[List[OrderListPlaceOpocoResponseResultOrdersInner]] = Field(
        default=None, alias="orders"
    )

    order_reports: Optional[
        List[OrderListPlaceOpocoResponseResultOrderReportsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListPlaceOpocoResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListPlaceOpocoResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListPlaceOpocoResponseResultOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListPlaceOpocoResponseResultOrderReportsInner.from_dict(
                            _item
                        )
