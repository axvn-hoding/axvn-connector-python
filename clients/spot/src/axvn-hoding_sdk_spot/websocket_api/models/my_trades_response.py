...
from axvn-hoding_sdk_spot.websocket_api.models.my_trades_response_result_inner import (
...
class MyTradesResponse(BaseModel):
    """
    MyTradesResponse
    """  # noqa: E501
    ...
    result: Optional[List[MyTradesResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MyTradesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MyTradesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        MyTradesResponseResultInner.from_dict(_item)
