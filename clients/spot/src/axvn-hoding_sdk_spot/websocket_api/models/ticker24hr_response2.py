...
from axvn-hoding_sdk_spot.websocket_api.models.ticker24hr_response2_result_inner import (
...
class Ticker24hrResponse2(BaseModel):
    ...
    result: Optional[List[Ticker24hrResponse2ResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Ticker24hrResponse2 from a JSON string"""
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        Ticker24hrResponse2ResultInner.from_dict(_item)
