...
from axvn-hoding_sdk_spot.websocket_api.models.sor_order_place_response_result_inner_fills_inner import (
...
class SorOrderPlaceResponseResultInner(BaseModel):
    """
    ...
    fills: Optional[List[SorOrderPlaceResponseResultInnerFillsInner]] = Field(
        default=None, alias="fills"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SorOrderPlaceResponseResultInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SorOrderPlaceResponseResultInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "fills": (
                    [
                        SorOrderPlaceResponseResultInnerFillsInner.from_dict(_item)
