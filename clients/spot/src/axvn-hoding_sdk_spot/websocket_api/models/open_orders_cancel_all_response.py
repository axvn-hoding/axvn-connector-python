...
from axvn-hoding_sdk_spot.websocket_api.models.open_orders_cancel_all_response_result_inner import (
...
class OpenOrdersCancelAllResponse(BaseModel):
    """
    ...
    result: Optional[List[OpenOrdersCancelAllResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenOrdersCancelAllResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenOrdersCancelAllResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        OpenOrdersCancelAllResponseResultInner.from_dict(_item)
