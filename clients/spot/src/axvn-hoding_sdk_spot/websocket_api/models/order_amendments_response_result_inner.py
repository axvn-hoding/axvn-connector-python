...
class OrderAmendmentsResponseResultInner(BaseModel):
    """
    ...
    new_qty: Optional[StrictStr] = Field(default=None, alias="newQty")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderAmendmentsResponseResultInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderAmendmentsResponseResultInner from a dict"""
        if obj is None:
            return None
