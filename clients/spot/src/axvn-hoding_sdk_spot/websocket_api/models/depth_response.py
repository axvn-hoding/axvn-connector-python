...
from axvn-hoding_sdk_spot.websocket_api.models.depth_response_result import (
    DepthResponseResult,
)
...
class DepthResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepthResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepthResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    DepthResponseResult.from_dict(obj["result"])
