...
from axvn-hoding_sdk_spot.websocket_api.models.ticker_trading_day_response_result_inner import (
...
class TickerTradingDayResponse(BaseModel):
    ...
    result: Optional[List[TickerTradingDayResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TickerTradingDayResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TickerTradingDayResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        TickerTradingDayResponseResultInner.from_dict(_item)
