...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_oco_response_result_order_reports_inner import (
    OrderListPlaceOcoResponseResultOrderReportsInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_oco_response_result_orders_inner import (
    OrderListPlaceOcoResponseResultOrdersInner,
)
from typing import Set
from typing_extensions import Self


class OrderListPlaceOcoResponseResult(BaseModel):
    """
    ...
    orders: Optional[List[OrderListPlaceOcoResponseResultOrdersInner]] = Field(
        default=None, alias="orders"
    )

    order_reports: Optional[List[OrderListPlaceOcoResponseResultOrderReportsInner]] = (
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListPlaceOcoResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListPlaceOcoResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListPlaceOcoResponseResultOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListPlaceOcoResponseResultOrderReportsInner.from_dict(
                            _item
                        )
