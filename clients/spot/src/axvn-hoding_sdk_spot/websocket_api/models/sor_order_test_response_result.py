...
from axvn-hoding_sdk_spot.websocket_api.models.order_test_response_result_discount import (
    OrderTestResponseResultDiscount,
)
from axvn-hoding_sdk_spot.websocket_api.models.order_test_response_result_standard_commission_for_order import (
...
class SorOrderTestResponseResult(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SorOrderTestResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SorOrderTestResponseResult from a dict"""
        if obj is None:
            return None
