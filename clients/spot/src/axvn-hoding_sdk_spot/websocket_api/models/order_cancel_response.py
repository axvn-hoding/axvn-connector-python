...
from axvn-hoding_sdk_spot.websocket_api.models.order_cancel_response_result import (
...
class OrderCancelResponse(BaseModel):
    ...
    result: Optional[OrderCancelResponseResult] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    OrderCancelResponseResult.from_dict(obj["result"])
