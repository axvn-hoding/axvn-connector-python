...
class PercentPriceBySideFilter(BaseModel):
    ...
    multiplier_exponent: Optional[StrictInt] = Field(
        default=None, alias="multiplierExponent"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PercentPriceBySideFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PercentPriceBySideFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "multiplierExponent": obj.get("multiplierExponent"),
