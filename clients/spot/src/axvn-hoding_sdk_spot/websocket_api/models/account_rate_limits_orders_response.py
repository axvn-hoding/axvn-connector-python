...
from axvn-hoding_sdk_spot.websocket_api.models.account_commission_response_rate_limits_inner import (
    AccountCommissionResponseRateLimitsInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.account_rate_limits_orders_response_result_inner import (
...
class AccountRateLimitsOrdersResponse(BaseModel):
    """
    ...
    result: Optional[List[AccountRateLimitsOrdersResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountRateLimitsOrdersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountRateLimitsOrdersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        AccountRateLimitsOrdersResponseResultInner.from_dict(_item)
