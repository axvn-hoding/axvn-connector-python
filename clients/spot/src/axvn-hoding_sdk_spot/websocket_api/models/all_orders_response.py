...
from axvn-hoding_sdk_spot.websocket_api.models.all_orders_response_result_inner import (
...
class AllOrdersResponse(BaseModel):
    ...
    result: Optional[List[AllOrdersResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AllOrdersResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AllOrdersResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        AllOrdersResponseResultInner.from_dict(_item)
