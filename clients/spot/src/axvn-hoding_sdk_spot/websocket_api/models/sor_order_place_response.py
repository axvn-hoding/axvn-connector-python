...
from axvn-hoding_sdk_spot.websocket_api.models.sor_order_place_response_result_inner import (
...
class SorOrderPlaceResponse(BaseModel):
    """
    ...
    result: Optional[List[SorOrderPlaceResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SorOrderPlaceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SorOrderPlaceResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        SorOrderPlaceResponseResultInner.from_dict(_item)
