...
class TickerResponse2ResultInner(BaseModel):
    """
    ...
    quote_volume: Optional[StrictStr] = Field(
        default=None,
        description="Sum of (price * volume) for all trades",
        alias="quoteVolume",
    )
    open_time: Optional[StrictInt] = Field(
        default=None, description="Open time for ticker window", alias="openTime"
    )
    close_time: Optional[StrictInt] = Field(
        default=None, description="Close time for ticker window", alias="closeTime"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TickerResponse2ResultInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TickerResponse2ResultInner from a dict"""
        if obj is None:
            return None
