...
from axvn-hoding_sdk_spot.websocket_api.models.ticker_price_response1_result import (
...
class TickerPriceResponse1(BaseModel):
    """
    ...
    result: Optional[TickerPriceResponse1Result] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TickerPriceResponse1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TickerPriceResponse1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    TickerPriceResponse1Result.from_dict(obj["result"])
