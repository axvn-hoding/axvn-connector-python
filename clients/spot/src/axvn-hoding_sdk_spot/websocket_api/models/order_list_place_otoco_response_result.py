...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_otoco_response_result_order_reports_inner import (
    OrderListPlaceOtocoResponseResultOrderReportsInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_otoco_response_result_orders_inner import (
...
class OrderListPlaceOtocoResponseResult(BaseModel):
    """
    ...
    orders: Optional[List[OrderListPlaceOtocoResponseResultOrdersInner]] = Field(
        default=None, alias="orders"
    )

    order_reports: Optional[
        List[OrderListPlaceOtocoResponseResultOrderReportsInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListPlaceOtocoResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListPlaceOtocoResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListPlaceOtocoResponseResultOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListPlaceOtocoResponseResultOrderReportsInner.from_dict(
                            _item
                        )
