...
from axvn-hoding_sdk_spot.websocket_api.models.order_amendments_response_result_inner import (
...
class OrderAmendmentsResponse(BaseModel):
    """
    ...
    result: Optional[List[OrderAmendmentsResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderAmendmentsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderAmendmentsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        OrderAmendmentsResponseResultInner.from_dict(_item)
