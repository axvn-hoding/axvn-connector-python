...
from axvn-hoding_sdk_spot.websocket_api.models.ticker_response1_result import (
...
class TickerResponse1(BaseModel):
    """
    TickerResponse1
    """  # noqa: E501
    ...
    result: Optional[TickerResponse1Result] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TickerResponse1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TickerResponse1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    TickerResponse1Result.from_dict(obj["result"])
