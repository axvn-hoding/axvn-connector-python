...
from axvn-hoding_sdk_spot.websocket_api.models.exchange_filters import ExchangeFilters
from axvn-hoding_sdk_spot.websocket_api.models.exchange_info_response_sors_inner import (
    ExchangeInfoResponseSorsInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.exchange_info_response_symbols_inner import (
    ExchangeInfoResponseSymbolsInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.rate_limits import RateLimits
...
class ExchangeInfoResponse(BaseModel):
    ...
    symbols: Optional[List[ExchangeInfoResponseSymbolsInner]] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "symbols": (
                    [
                        ExchangeInfoResponseSymbolsInner.from_dict(_item)
                ...
                "sors": (
                    [
                        ExchangeInfoResponseSorsInner.from_dict(_item)
