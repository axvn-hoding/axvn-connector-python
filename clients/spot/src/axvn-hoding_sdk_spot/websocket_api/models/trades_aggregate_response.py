...
from axvn-hoding_sdk_spot.websocket_api.models.trades_aggregate_response_result_inner import (
...
class TradesAggregateResponse(BaseModel):
    """
    ...
    result: Optional[List[TradesAggregateResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TradesAggregateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TradesAggregateResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        TradesAggregateResponseResultInner.from_dict(_item)
