...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_cancel_response_result import (
...
class OrderListCancelResponse(BaseModel):
    """
    ...
    result: Optional[OrderListCancelResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListCancelResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListCancelResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    OrderListCancelResponseResult.from_dict(obj["result"])
