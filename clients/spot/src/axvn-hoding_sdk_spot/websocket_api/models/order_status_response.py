...
from axvn-hoding_sdk_spot.websocket_api.models.order_status_response_result import (
...
class OrderStatusResponse(BaseModel):
    ...
    result: Optional[OrderStatusResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderStatusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderStatusResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    OrderStatusResponseResult.from_dict(obj["result"])
