...
from axvn-hoding_sdk_spot.websocket_api.models.my_prevented_matches_response_result_inner import (
...
class MyPreventedMatchesResponse(BaseModel):
    """
    ...
    result: Optional[List[MyPreventedMatchesResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MyPreventedMatchesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MyPreventedMatchesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        MyPreventedMatchesResponseResultInner.from_dict(_item)
