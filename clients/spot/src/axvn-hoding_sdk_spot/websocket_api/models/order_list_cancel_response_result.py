...
from axvn-hoding_sdk_spot.websocket_api.models.all_order_lists_response_result_inner_orders_inner import (
    AllOrderListsResponseResultInnerOrdersInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.order_list_cancel_response_result_order_reports_inner import (
...
class OrderListCancelResponseResult(BaseModel):
    """
    ...
    orders: Optional[List[AllOrderListsResponseResultInnerOrdersInner]] = Field(
        default=None, alias="orders"
    )

    order_reports: Optional[List[OrderListCancelResponseResultOrderReportsInner]] = (
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListCancelResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListCancelResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        AllOrderListsResponseResultInnerOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListCancelResponseResultOrderReportsInner.from_dict(_item)
