...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_response_result_order_reports_inner import (
...
class OrderListPlaceResponseResult(BaseModel):
    """
    ...
    order_reports: Optional[List[OrderListPlaceResponseResultOrderReportsInner]] = (
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListPlaceResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListPlaceResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orderReports": (
                    [
                        OrderListPlaceResponseResultOrderReportsInner.from_dict(_item)
