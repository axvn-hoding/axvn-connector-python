...
from axvn-hoding_sdk_spot.websocket_api.models.order_place_response_result_fills_inner import (
...
class OrderPlaceResponseResult(BaseModel):
    """
    ...
    fills: Optional[List[OrderPlaceResponseResultFillsInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderPlaceResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderPlaceResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "fills": (
                    [
                        OrderPlaceResponseResultFillsInner.from_dict(_item)
