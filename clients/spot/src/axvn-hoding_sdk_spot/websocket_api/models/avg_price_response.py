...
from axvn-hoding_sdk_spot.websocket_api.models.avg_price_response_result import (
...
class AvgPriceResponse(BaseModel):
    ...
    result: Optional[AvgPriceResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AvgPriceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AvgPriceResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    AvgPriceResponseResult.from_dict(obj["result"])
