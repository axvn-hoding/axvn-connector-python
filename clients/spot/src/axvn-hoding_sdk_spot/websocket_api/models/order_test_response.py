...
from axvn-hoding_sdk_spot.websocket_api.models.order_test_response_result import (
...
class OrderTestResponse(BaseModel):
    ...
    result: Optional[OrderTestResponseResult] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    OrderTestResponseResult.from_dict(obj["result"])
