...
from axvn-hoding_sdk_spot.websocket_api.models.my_allocations_response_result_inner import (
...
class MyAllocationsResponse(BaseModel):
    ...
    result: Optional[List[MyAllocationsResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MyAllocationsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MyAllocationsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        MyAllocationsResponseResultInner.from_dict(_item)
