...
from axvn-hoding_sdk_spot.websocket_api.models.ticker_response2_result_inner import (
...
class TickerResponse2(BaseModel):
    ...
    result: Optional[List[TickerResponse2ResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TickerResponse2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TickerResponse2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        TickerResponse2ResultInner.from_dict(_item)
