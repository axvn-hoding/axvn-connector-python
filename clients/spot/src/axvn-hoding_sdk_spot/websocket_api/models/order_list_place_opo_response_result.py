...
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_opo_response_result_order_reports_inner import (
    OrderListPlaceOpoResponseResultOrderReportsInner,
)
from axvn-hoding_sdk_spot.websocket_api.models.order_list_place_opo_response_result_orders_inner import (
...
class OrderListPlaceOpoResponseResult(BaseModel):
    """
    ...
    orders: Optional[List[OrderListPlaceOpoResponseResultOrdersInner]] = Field(
        default=None, alias="orders"
    )

    order_reports: Optional[List[OrderListPlaceOpoResponseResultOrderReportsInner]] = (
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderListPlaceOpoResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderListPlaceOpoResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderListPlaceOpoResponseResultOrdersInner.from_dict(_item)
                ...
                "orderReports": (
                    [
                        OrderListPlaceOpoResponseResultOrderReportsInner.from_dict(
                            _item
                        )
