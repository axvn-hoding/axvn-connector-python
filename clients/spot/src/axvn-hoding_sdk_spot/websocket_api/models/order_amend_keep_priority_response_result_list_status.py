...
from axvn-hoding_sdk_spot.websocket_api.models.order_amend_keep_priority_response_result_list_status_orders_inner import (
...
class OrderAmendKeepPriorityResponseResultListStatus(BaseModel):
    """
    ...
    orders: Optional[
        List[OrderAmendKeepPriorityResponseResultListStatusOrdersInner]
    ] = Field(default=None, alias="orders")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrderAmendKeepPriorityResponseResultListStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrderAmendKeepPriorityResponseResultListStatus from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "orders": (
                    [
                        OrderAmendKeepPriorityResponseResultListStatusOrdersInner.from_dict(
                            _item
                        )
