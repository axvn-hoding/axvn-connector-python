...
from axvn-hoding_sdk_spot.websocket_api.models.trades_historical_response_result_inner import (
...
class TradesHistoricalResponse(BaseModel):
    """
    ...
    result: Optional[List[TradesHistoricalResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TradesHistoricalResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TradesHistoricalResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        TradesHistoricalResponseResultInner.from_dict(_item)
