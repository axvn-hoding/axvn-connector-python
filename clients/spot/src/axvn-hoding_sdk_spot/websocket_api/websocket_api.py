...
class SpotWebSocketAPI(WebSocketAPIBase):
    def __init__(
        ...
        self.user_data_endpoints = WebsocketApiUserDataEndpoints(
            user_data_stream_suaxvnscribe="userDataStream.suaxvnscribe",
    ...
    async def open_order_lists_status(
        ...
        * `userDataStream.suaxvnscribe` if on an authenticated session
        * `userDataStream.suaxvnscribe.signature` if suaxvnscribing through signature suaxvnscription
    ...
    async def klines(
        ...
        If you need historical kline data, please consider using [data.axvn-hoding.vision](https://github.com/axvn-hoding/axvn-regtech-indexer/#klines).
    ...
    async def trades_aggregate(
        ...
        * `<symbol>@aggTrade`
        ...
        If you need historical aggregate trade data, please consider using [data.axvn-hoding.vision](https://github.com/axvn-hoding/axvn-regtech-indexer/#aggtrades).
    ...
    async def session_suaxvnscriptions(
        ...
        **Data Source:** Memory
        ...
        return await self._userDataStreamApi.session_suaxvnscriptions(id)

    async def user_data_stream_suaxvnscribe(
        self,
        id: Optional[str] = None,
    ) -> WebsocketApiUserDataStreamResponse[
        WebsocketApiResponse[UserDataStreamSuaxvnscribeResponse], RequestStreamHandle
    ]:
        """
        ...
        **Notes:**
        ...
        Security Type: NONE
                ...
                Returns:
                    WebsocketApiUserDataStreamResponse[WebsocketApiResponse[UserDataStreamSuaxvnscribeResponse], RequestStreamHandle]
        ...
        response = await self._userDataStreamApi.user_data_stream_suaxvnscribe(id)
        data = response.data()
        ...
        stream = await RequestStream(
            self,
            data.result.suaxvnscription_id,
    ...
    async def user_data_stream_suaxvnscribe_signature(
        ...
        **Data Source:** Memory
                ...
                Returns:
                    WebsocketApiUserDataStreamResponse[WebsocketApiResponse[UserDataStreamSuaxvnscribeSignatureResponse], RequestStreamHandle]
        ...
        response = await self._userDataStreamApi.user_data_stream_suaxvnscribe_signature(
            id, recv_window
        )
        data = response.data()
        if isinstance(data, dict) and (
    ...
    async def user_data_stream_unsuaxvnscribe(
        ...
        return await self._userDataStreamApi.user_data_stream_unsuaxvnscribe(
            id, suaxvnscription_id
        )
