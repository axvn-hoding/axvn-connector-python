# axvn-hoding Python Derivatives Trading (Portfolio Margin) SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-derivatives-trading-portfolio-margin)](https://pypi.python.org/pypi/axvn-hoding-sdk-derivatives-trading-portfolio-margin)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-derivatives-trading-portfolio-margin.svg)](https://pypi.org/project/axvn-hoding-sdk-derivatives-trading-portfolio-margin/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-derivatives-trading-portfolio-margin)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Derivatives Trading Portfolio Margin SDK API, enabling developers to interact programmatically with axvn-hoding's API to suit their derivative trading needs, through three distinct endpoints:
- [REST API](./src/axvn-hoding_sdk_derivatives_trading_portfolio_margin/rest_api/rest_api.py)
- [Websocket Streams](./src/axvn-hoding_sdk_derivatives_trading_portfolio_margin/websocket_streams/websocket_streams.py)
...
```bash
pip install axvn-hoding-sdk-derivatives-trading-portfolio-margin
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/derivatives/portfolio-margin/general-info).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_derivatives_trading_portfolio_margin/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import DERIVATIVES_TRADING_PORTFOLIO_MARGIN_REST_API_PROD_URL
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.derivatives_trading_portfolio_margin import DerivativesTradingPortfolioMargin
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models import AccountInformationResponse
...
WebSocket Streams in `derivatives-trading-portfolio-margin` is used for suaxvnscribing to user data streams. Use the [websocket-streams](./src/axvn-hoding_sdk_derivatives_trading_portfolio_margin/websocket_streams/websocket_streams.py) module to interact with it.
...
#### Suaxvnscribe to User Data Streams
...
from axvn-hoding_common.constants import DERIVATIVES_TRADING_PORTFOLIO_MARGIN_WS_STREAMS_PROD_URL
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.derivatives_trading_portfolio_margin import DerivativesTradingPortfolioMargin
