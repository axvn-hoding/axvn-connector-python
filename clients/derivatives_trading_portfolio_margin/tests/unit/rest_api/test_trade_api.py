...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.api import TradeApi
...
class TestTradeApi:
    ...
    def test_cancel_um_algo_order_success_with_optional_params(
        ...
        params = {
            "algo_id": 2146760,
            "client_algo_id": "6B2I9XVcJpCjqPAJ4YoFX7",
            "recv_window": 5000,
        }
    ...
    def test_cm_position_adl_quantile_estimation_success_with_optional_params(
        ...
        params = {"symbol": "BTCUSD_201225", "recv_window": 5000}
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_um_futures_axvn_burn_status_success(self, mock_get_signature):
        """Test get_um_futures_axvn_burn_status() successfully with required parameters only."""

        expected_response = {"feeBurn": True}
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)

        response = self.client.get_um_futures_axvn_burn_status()
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_um_futures_axvn_burn_status_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test get_um_futures_axvn_burn_status() successfully with optional parameters."""
        ...
        response = self.client.get_um_futures_axvn_burn_status(**params)
    ...
    def test_get_um_futures_axvn_burn_status_server_error(self):
        """Test that get_um_futures_axvn_burn_status() raises an error when the server returns an error."""

        mock_error = Exception("ResponseError")
        self.client.get_um_futures_axvn_burn_status = MagicMock(side_effect=mock_error)

        with pytest.raises(Exception, match="ResponseError"):
            self.client.get_um_futures_axvn_burn_status()
    ...
    def test_new_cm_conditional_order_success_with_optional_params(
        ...
        params = {
            ...
            "price_protect": NewCmConditionalOrderPriceProtectEnum["TRUE"].value,
            "new_client_strategy_id": "1",
            "stop_price": 1.0,
    ...
    def test_new_cm_order_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            ...
            "quantity": 1.0,
            "reduce_only": NewCmOrderReduceOnlyEnum["TRUE"].value,
            "price": 1.0,
            "price_match": NewCmOrderPriceMatchEnum["OPPONENT"].value,
            "new_client_order_id": "1",
    ...
    def test_new_um_algo_order_success(self, mock_get_signature):
        ...
        assert "/papi/v1/um/algo/order" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["algoType"] == NewUmAlgoOrderAlgoTypeEnum["CONDITIONAL"].value
        assert normalized["symbol"] == "AXVNUSDT"
    ...
    def test_new_um_conditional_order_success_with_optional_params(
        ...
        params = {
            ...
            "quantity": 1.0,
            "reduce_only": NewUmConditionalOrderReduceOnlyEnum["TRUE"].value,
            "price": 1.0,
            "working_type": NewUmConditionalOrderWorkingTypeEnum["MARK_PRICE"].value,
            "price_protect": NewUmConditionalOrderPriceProtectEnum["TRUE"].value,
            "new_client_strategy_id": "1",
            "stop_price": 1.0,
            "activation_price": 1.0,
            "callback_rate": 1.0,
            "price_match": NewUmConditionalOrderPriceMatchEnum["OPPONENT"].value,
    ...
    def test_new_um_order_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            ...
            "quantity": 1.0,
            "reduce_only": NewUmOrderReduceOnlyEnum["TRUE"].value,
            "price": 1.0,
            "new_client_order_id": "1",
    ...
    def test_query_all_cm_orders_success(self, mock_get_signature):
        ...
        response = self.client.query_all_cm_orders()
    ...
    def test_query_all_cm_orders_server_error(self):
        ...
        with pytest.raises(Exception, match="ResponseError"):
            self.client.query_all_cm_orders()
    ...
    def test_query_all_current_cm_open_conditional_orders_success_with_optional_params(
        ...
        params = {"symbol": "BTCUSD", "recv_window": 5000}
    ...
    def test_query_all_current_cm_open_orders_success_with_optional_params(
        ...
        params = {"symbol": "BTCUSD_200925", "pair": "BTCUSD", "recv_window": 5000}
    ...
    def test_query_um_algo_order_history_success_with_optional_params(
        ...
        params = {
            "symbol": "AXVNUSDT",
            "algo_id": 2146760,
            "start_time": 1770130294138,
            "end_time": 1770736694138,
            "limit": 500,
            "recv_window": 5000,
        }
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_toggle_axvn_burn_on_um_futures_trade_success(self, mock_get_signature):
        """Test toggle_axvn_burn_on_um_futures_trade() successfully with required parameters only."""
        ...
        response = self.client.toggle_axvn_burn_on_um_futures_trade(**params)
        ...
        assert (
            normalized["feeBurn"]
            == ToggleBnbBurnOnUmFuturesTradeFeeBurnEnum["TRUE"].value
        )
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_toggle_axvn_burn_on_um_futures_trade_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test toggle_axvn_burn_on_um_futures_trade() successfully with optional parameters."""
    ...
    def test_toggle_axvn_burn_on_um_futures_trade_missing_required_param_fee_burn(self):
        """Test that toggle_axvn_burn_on_um_futures_trade() raises RequiredError when 'fee_burn' is missing."""
        params = {
            "fee_burn": ToggleBnbBurnOnUmFuturesTradeFeeBurnEnum["TRUE"].value,
        }
        ...
        with pytest.raises(
            ...
            self.client.toggle_axvn_burn_on_um_futures_trade(**params)

    def test_toggle_axvn_burn_on_um_futures_trade_server_error(self):
        """Test that toggle_axvn_burn_on_um_futures_trade() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.toggle_axvn_burn_on_um_futures_trade = MagicMock(
            side_effect=mock_error
        )
