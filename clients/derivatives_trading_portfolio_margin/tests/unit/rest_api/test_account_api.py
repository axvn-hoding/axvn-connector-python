...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.api import AccountApi
...
class TestAccountApi:
    ...
    def test_account_balance_success(self, mock_get_signature):
        ...
        elif is_oneof or is_list or hasattr(AccountBalanceResponse, "from_dict"):
    ...
    def test_account_balance_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"asset": "USDT", "recv_window": 5000}
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_axvn_transfer_success(self, mock_get_signature):
        """Test axvn_transfer() successfully with required parameters only."""
        ...
        response = self.client.axvn_transfer(**params)
        ...
        assert "url" in request_kwargs
        assert "signature" in parse_qs(request_kwargs["params"])
        assert "/papi/v1/axvn-transfer" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["amount"] == 1.0
        assert normalized["transferSide"] == BnbTransferTransferSideEnum["TO_UM"].value
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_axvn_transfer_success_with_optional_params(self, mock_get_signature):
        """Test axvn_transfer() successfully with optional parameters."""
    ...
    def test_axvn_transfer_missing_required_param_amount(self):
        """Test that axvn_transfer() raises RequiredError when 'amount' is missing."""
        params = {
            "amount": 1.0,
            "transfer_side": BnbTransferTransferSideEnum["TO_UM"].value,
        }
        ...
        with pytest.raises(RequiredError, match="Missing required parameter 'amount'"):
            self.client.axvn_transfer(**params)

    def test_axvn_transfer_missing_required_param_transfer_side(self):
        """Test that axvn_transfer() raises RequiredError when 'transfer_side' is missing."""
        params = {
            "amount": 1.0,
            "transfer_side": BnbTransferTransferSideEnum["TO_UM"].value,
        }
    ...
    def test_axvn_transfer_server_error(self):
        """Test that axvn_transfer() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.axvn_transfer = MagicMock(side_effect=mock_error)
    ...
    def test_change_auto_repay_futures_status_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert (
            normalized["autoRepay"]
            == ChangeAutoRepayFuturesStatusAutoRepayEnum["TRUE"].value
        )
    ...
    def test_change_cm_initial_leverage_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["symbol"] == "BTCUSD_200925"
        assert normalized["leverage"] == 21
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof or is_list or hasattr(ChangeCmInitialLeverageResponse, "from_dict")
        ):
    ...
    def test_change_cm_initial_leverage_success_with_optional_params(
        ...
        params = {"symbol": "BTCUSD_200925", "leverage": 21, "recv_window": 5000}
    ...
    def test_change_cm_position_mode_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert (
            normalized["dualSidePosition"]
            == ChangeCmPositionModeDualSidePositionEnum["TRUE"].value
        )
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(ChangeCmPositionModeResponse, "from_dict"):
    ...
    def test_change_um_initial_leverage_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof or is_list or hasattr(ChangeUmInitialLeverageResponse, "from_dict")
        ):
    ...
    def test_change_um_initial_leverage_success_with_optional_params(
        ...
        params = {"symbol": "BTCUSDT", "leverage": 21, "recv_window": 5000}
    ...
    def test_change_um_position_mode_success(self, mock_get_signature):
        ...
        assert (
            normalized["dualSidePosition"]
            == ChangeUmPositionModeDualSidePositionEnum["TRUE"].value
        )
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(ChangeUmPositionModeResponse, "from_dict"):
    ...
    def test_cm_notional_and_leverage_brackets_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(CmNotionalAndLeverageBracketsResponse, "from_dict")
        ):
    ...
    def test_cm_notional_and_leverage_brackets_success_with_optional_params(
        ...
        params = {"symbol": "BTCUSD_PERP", "recv_window": 5000}
    ...
    def test_get_cm_account_detail_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(GetCmAccountDetailResponse, "from_dict"):
    ...
    def test_get_cm_current_position_mode_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetCmCurrentPositionModeResponse, "from_dict")
        ):
    ...
    def test_get_cm_income_history_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(GetCmIncomeHistoryResponse, "from_dict"):
    ...
    def test_get_cm_income_history_success_with_optional_params(
        ...
        params = {
            "symbol": "BTCUSD_200925",
            "income_type": GetCmIncomeHistoryIncomeTypeEnum["TRANSFER"].value,
    ...
    def test_get_download_id_for_um_futures_order_history_success(
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetDownloadIdForUmFuturesOrderHistoryResponse, "from_dict")
        ):
    ...
    def test_get_download_id_for_um_futures_trade_history_success(
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetDownloadIdForUmFuturesTradeHistoryResponse, "from_dict")
        ):
    ...
    def test_get_download_id_for_um_futures_transaction_history_success(
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetDownloadIdForUmFuturesTransactionHistoryResponse, "from_dict")
        ):
    ...
    def test_get_margin_borrow_loan_interest_history_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetMarginBorrowLoanInterestHistoryResponse, "from_dict")
        ):
    ...
    def test_get_margin_borrow_loan_interest_history_success_with_optional_params(
        ...
        params = {
            ...
            "current": 1,
            "size": 10,
            "archived": GetMarginBorrowLoanInterestHistoryArchivedEnum["TRUE"].value,
            "recv_window": 5000,
        }
    ...
    def test_get_um_account_detail_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(GetUmAccountDetailResponse, "from_dict"):
    ...
    def test_get_um_account_detail_v2_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(GetUmAccountDetailV2Response, "from_dict"):
    ...
    def test_get_um_current_position_mode_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetUmCurrentPositionModeResponse, "from_dict")
        ):
    ...
    def test_get_um_futures_order_download_link_by_id_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["downloadId"] == "545923594199212032"
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetUmFuturesOrderDownloadLinkByIdResponse, "from_dict")
        ):
    ...
    def test_get_um_futures_order_download_link_by_id_success_with_optional_params(
        ...
        params = {"download_id": "545923594199212032", "recv_window": 5000}
    ...
    def test_get_um_futures_trade_download_link_by_id_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetUmFuturesTradeDownloadLinkByIdResponse, "from_dict")
        ):
    ...
    def test_get_um_futures_transaction_download_link_by_id_success(
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetUmFuturesTransactionDownloadLinkByIdResponse, "from_dict")
        ):
    ...
    def test_get_um_income_history_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(GetUmIncomeHistoryResponse, "from_dict"):
    ...
    def test_get_um_income_history_success_with_optional_params(
        ...
        params = {
            ...
            "income_type": GetUmIncomeHistoryIncomeTypeEnum["TRANSFER"].value,
            "start_time": 1623319461670,
            "end_time": 1641782889000,
            "page": 1,
            "limit": 100,
    ...
    def test_get_user_commission_rate_for_cm_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["symbol"] == "BTCUSD_PERP"
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetUserCommissionRateForCmResponse, "from_dict")
        ):
    ...
    def test_get_user_commission_rate_for_um_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetUserCommissionRateForUmResponse, "from_dict")
        ):
    ...
    def test_margin_max_borrow_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(MarginMaxBorrowResponse, "from_dict"):
    ...
    def test_query_cm_position_information_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(QueryCmPositionInformationResponse, "from_dict")
        ):
    ...
    def test_query_cm_position_information_success_with_optional_params(
        ...
        params = {"margin_asset": "USDT", "pair": "BTCUSD_201225", "recv_window": 5000}
    ...
    def test_query_margin_loan_record_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(QueryMarginLoanRecordResponse, "from_dict"):
    ...
    def test_query_margin_loan_record_success_with_optional_params(
        ...
        params = {
            ...
            "current": 1,
            "size": 10,
            "archived": QueryMarginLoanRecordArchivedEnum["TRUE"].value,
            "recv_window": 5000,
        }
    ...
    def test_query_margin_max_withdraw_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof or is_list or hasattr(QueryMarginMaxWithdrawResponse, "from_dict")
        ):
    ...
    def test_query_margin_repay_record_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof or is_list or hasattr(QueryMarginRepayRecordResponse, "from_dict")
        ):
    ...
    def test_query_margin_repay_record_success_with_optional_params(
        ...
        params = {
            ...
            "current": 1,
            "size": 10,
            "archived": QueryMarginRepayRecordArchivedEnum["TRUE"].value,
            "recv_window": 5000,
        }
    ...
    def test_query_um_position_information_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(QueryUmPositionInformationResponse, "from_dict")
        ):
    ...
    def test_query_user_negative_balance_auto_exchange_record_success(
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(QueryUserNegativeBalanceAutoExchangeRecordResponse, "from_dict")
        ):
    ...
    def test_um_futures_account_configuration_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(UmFuturesAccountConfigurationResponse, "from_dict")
        ):
    ...
    def test_um_futures_symbol_configuration_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(UmFuturesSymbolConfigurationResponse, "from_dict")
        ):
    ...
    def test_um_notional_and_leverage_brackets_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(UmNotionalAndLeverageBracketsResponse, "from_dict")
        ):
    ...
    def test_um_notional_and_leverage_brackets_success_with_optional_params(
        ...
        params = {"symbol": "ETHUSDT", "recv_window": 5000}
