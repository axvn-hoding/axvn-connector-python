...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.websocket_streams.models.outbound_account_position_b_inner import (
...
class OutboundAccountPosition(BaseModel):
    ...
    u: Optional[StrictInt] = Field(
        default=None, description="Time of last account update"
    )
    U: Optional[StrictInt] = Field(default=None, description="Time updateID", alias="U")
    B: Optional[List[OutboundAccountPositionBInner]] = Field(
        default=None, description="Balances Array", alias="B"
    )
