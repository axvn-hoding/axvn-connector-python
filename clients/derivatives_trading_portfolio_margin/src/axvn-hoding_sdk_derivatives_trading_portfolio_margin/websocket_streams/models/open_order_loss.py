...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.websocket_streams.models.open_order_loss_o_inner import (
    OpenOrderLossOInner,
)
...
class OpenOrderLoss(BaseModel):
    ...
    O: Optional[List[OpenOrderLossOInner]] = Field(
        default=None, description="Update Data", alias="O"
    )
