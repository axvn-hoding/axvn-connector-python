...
class PortfolioMarginUmTradingQuantitativeRulesIndicatorsResponseIndicatorsACCOUNTInner(
    ...
    indicator: Optional[StrictStr] = Field(default=None, description="Indicator.")
    value: Optional[StrictInt] = Field(default=None, description="Value.")
    trigger_value: Optional[StrictInt] = Field(
        default=None, description="Trigger Value.", alias="triggerValue"
    )
    planned_recover_time: Optional[StrictInt] = Field(
        default=None, description="Planned Recover Time.", alias="plannedRecoverTime"
    )
    is_locked: Optional[StrictBool] = Field(
        default=None, description="Is Locked.", alias="isLocked"
    )
