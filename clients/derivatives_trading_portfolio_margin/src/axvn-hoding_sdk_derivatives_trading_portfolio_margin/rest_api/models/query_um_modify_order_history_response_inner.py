...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models.query_cm_modify_order_history_response_inner_amendment import (
...
class QueryUmModifyOrderHistoryResponseInner(BaseModel):
    """
    QueryUmModifyOrderHistoryResponseInner
    """  # noqa: E501

    amendment_id: Optional[StrictInt] = Field(
        default=None, description="Order modification ID", alias="amendmentId"
    )
    ...
    time: Optional[StrictInt] = Field(
        default=None, description="Order modification time"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryUmModifyOrderHistoryResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryUmModifyOrderHistoryResponseInner from a dict"""
        if obj is None:
            return None
