...
class QueryAllCurrentCmOpenConditionalOrdersResponseInner(BaseModel):
    """
    ...
    book_time: Optional[StrictInt] = Field(
        default=None, description="order time", alias="bookTime"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryAllCurrentCmOpenConditionalOrdersResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryAllCurrentCmOpenConditionalOrdersResponseInner from a dict"""
        if obj is None:
            return None
