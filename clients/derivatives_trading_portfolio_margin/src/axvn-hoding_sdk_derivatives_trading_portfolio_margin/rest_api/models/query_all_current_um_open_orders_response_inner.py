...
class QueryAllCurrentUmOpenOrdersResponseInner(BaseModel):
    """
    ...
    orig_type: Optional[StrictStr] = Field(
        default=None, description="Orig Type.", alias="origType"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryAllCurrentUmOpenOrdersResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryAllCurrentUmOpenOrdersResponseInner from a dict"""
        if obj is None:
            return None
