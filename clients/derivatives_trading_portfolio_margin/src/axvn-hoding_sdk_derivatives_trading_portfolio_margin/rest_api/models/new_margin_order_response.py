...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models.new_margin_order_response_fills_inner import (
...
class NewMarginOrderResponse(BaseModel):
    """
    ...
    fills: Optional[List[NewMarginOrderResponseFillsInner]] = Field(
        default=None, description="Fills."
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewMarginOrderResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NewMarginOrderResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "fills": (
                    [
                        NewMarginOrderResponseFillsInner.from_dict(_item)
