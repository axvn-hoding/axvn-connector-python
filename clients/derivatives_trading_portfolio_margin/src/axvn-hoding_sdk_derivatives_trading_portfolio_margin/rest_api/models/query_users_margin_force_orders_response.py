...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models.query_users_margin_force_orders_response_rows_inner import (
...
class QueryUsersMarginForceOrdersResponse(BaseModel):
    ...
    rows: Optional[List[QueryUsersMarginForceOrdersResponseRowsInner]] = Field(
