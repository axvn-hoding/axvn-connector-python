...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models.query_margin_accounts_all_oco_response_inner_orders_inner import (
...
class QueryMarginAccountsAllOcoResponseInner(BaseModel):
    ...
    orders: Optional[List[QueryMarginAccountsAllOcoResponseInnerOrdersInner]] = Field(
