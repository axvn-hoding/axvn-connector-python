...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models.portfolio_margin_um_trading_quantitative_rules_indicators_response_indicators_account_inner import (
    PortfolioMarginUmTradingQuantitativeRulesIndicatorsResponseIndicatorsACCOUNTInner,
)
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models.portfolio_margin_um_trading_quantitative_rules_indicators_response_indicators_btcusdt_inner import (
...
class PortfolioMarginUmTradingQuantitativeRulesIndicatorsResponseIndicators(BaseModel):
    ...
    ] = Field(default=None, description="BTCUSDT.", alias="BTCUSDT")
    account: Optional[
        List[
            PortfolioMarginUmTradingQuantitativeRulesIndicatorsResponseIndicatorsACCOUNTInner
        ]
    ] = Field(default=None, description="ACCOUNT.", alias="ACCOUNT")
