...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models.cancel_margin_account_all_open_orders_on_a_symbol_response_inner_order_reports_inner import (
    CancelMarginAccountAllOpenOrdersOnASymbolResponseInnerOrderReportsInner,
)
from axvn-hoding_sdk_derivatives_trading_portfolio_margin.rest_api.models.cancel_margin_account_all_open_orders_on_a_symbol_response_inner_orders_inner import (
...
class CancelMarginAccountAllOpenOrdersOnASymbolResponseInner(BaseModel):
    ...
    ] = Field(default=None, description="Orders.")
