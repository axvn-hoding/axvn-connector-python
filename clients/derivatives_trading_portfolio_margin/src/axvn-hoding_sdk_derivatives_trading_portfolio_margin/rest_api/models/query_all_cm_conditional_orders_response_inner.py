...
class QueryAllCmConditionalOrdersResponseInner(BaseModel):
    ...
    status: Optional[StrictStr] = Field(
        default=None,
        description="Normal order status after trigger if appliable, only have when the strategy is triggered",
    )
    ...
    trigger_time: Optional[StrictInt] = Field(
        default=None, description="Trigger Time.", alias="triggerTime"
    )
