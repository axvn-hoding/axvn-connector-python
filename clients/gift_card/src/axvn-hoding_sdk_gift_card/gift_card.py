...
from .rest_api import GiftCardRestAPI
...
class GiftCard:
    """GiftCard API that exposes REST APIs in a single interface."""
    ...
    @property
    def rest_api(self) -> GiftCardRestAPI:
        if self._rest_api is None and self._rest_api_config:
            ...
            self._rest_api = GiftCardRestAPI(self._rest_api_config)
