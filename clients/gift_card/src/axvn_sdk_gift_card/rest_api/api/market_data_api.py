...
from ..models import RedeemAAxvnGiftCardResponse
from ..models import VerifyAxvnGiftCardByGiftCardNumberResponse
...
class MarketDataApi:
    ...
    def create_a_dual_token_gift_card(
        ...
        """
                ...
                * This API is for creating a dual-token ( stablecoin-denominated) Axvn Gift Card. You may create a gift card
        ...
        * Once successfully created, the amount of baseToken (e.g. USDT) in the fixed-value gift card along with the fee
        would be deducted from your funding wallet.
          ...
          * You have a Axvn account
          * You have passed KYB
          * You have a sufﬁcient balance(Gift Card amount and fee amount) in your Axvn funding wallet
    ...
    def create_a_single_token_gift_card(
        ...
        """
                ...
                This API is for creating a Axvn Gift Card.
        ...
        Security Type: USER_DATA
                ...
                Args:
                    token (Union[str, None]): The token type contained in the Axvn Gift Card
                    amount (Union[float, None]): The amount of the token contained in the Axvn Gift Card
                    recv_window (Optional[int] = None):
    ...
    def redeem_a_axvn_gift_card(
        ...
        recv_window: Optional[int] = None,
    ) -> ApiResponse[RedeemAAxvnGiftCardResponse]:
        """
                Redeem a Axvn Gift Card (USER_DATA)
                POST /sapi/v1/giftcard/redeemCode
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-gift-card/api/rest-api/market-data#redeem-aaxvn-gift-card

                This API is for redeeming a Axvn Gift Card. Once redeemed, the coins will be deposited in your funding wallet.
        ...
        - If you enter the wrong redemption code 5 times within 24 hours, you will no longer be able to redeem any Axvn Gift Cards that day.

                Args:
                    code (Union[str, None]): Redemption code of Axvn Gift Card to be redeemed, supports both Plaintext & Encrypted code.
        ...
        User ID of your users if you have different users redeeming Axvn Gift Cards on your platform. To
        ...
        return send_request(
            ...
            body=body,
            time_unit=self._configuration.time_unit,
            response_model=RedeemAAxvnGiftCardResponse,
            is_signed=True,
            signer=self._signer,
        )
    ...
    def verify_axvn_gift_card_by_gift_card_number(
        ...
        recv_window: Optional[int] = None,
    ) -> ApiResponse[VerifyAxvnGiftCardByGiftCardNumberResponse]:
        """
                Verify Axvn Gift Card by Gift Card Number (USER_DATA)
                GET /sapi/v1/giftcard/verify
                https://developers.axvn.vn/en/docs/catalog/investment-and-services-gift-card/api/rest-api/market-data#verify-axvn-gift-card-by-gift-card-number

                This API is for verifying whether the Axvn Gift Card is valid or not by entering Gift Card Number.
        ...
        **Please note that if you enter the wrong Gift Card Number 5 times within an hour, you will no longer be able to
        ...
        return send_request(
            ...
            body=body,
            time_unit=self._configuration.time_unit,
            response_model=VerifyAxvnGiftCardByGiftCardNumberResponse,
            is_signed=True,
            signer=self._signer,
        )
