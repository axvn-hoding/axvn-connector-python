...
from axvn_sdk_gift_card.rest_api.api import MarketDataApi
from axvn_sdk_gift_card.rest_api.models import CreateADualTokenGiftCardResponse
from axvn_sdk_gift_card.rest_api.models import CreateASingleTokenGiftCardResponse
from axvn_sdk_gift_card.rest_api.models import FetchRsaPublicKeyResponse
from axvn_sdk_gift_card.rest_api.models import FetchTokenLimitResponse
from axvn_sdk_gift_card.rest_api.models import RedeemAAxvnGiftCardResponse
from axvn_sdk_gift_card.rest_api.models import (
    VerifyAxvnGiftCardByGiftCardNumberResponse,
)
...
class TestMarketDataApi:
    ...
    @patch("axvn_common.utils.get_signature")
    def test_redeem_a_axvn_gift_card_success(self, mock_get_signature):
        """Test redeem_a_axvn_gift_card() successfully with required parameters only."""
        ...
        response = self.client.redeem_a_axvn_gift_card(**params)
        ...
        is_oneof = is_one_of_model(RedeemAAxvnGiftCardResponse)

        if is_list and not is_flat_list:
            expected = expected_response
        elif (
            is_oneof or is_list or hasattr(RedeemAAxvnGiftCardResponse, "from_dict")
        ):
            expected = RedeemAAxvnGiftCardResponse.from_dict(expected_response)
        else:
            expected = RedeemAAxvnGiftCardResponse.model_validate_json(
                json.dumps(expected_response)
            )
    ...
    @patch("axvn_common.utils.get_signature")
    def test_redeem_a_axvn_gift_card_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test redeem_a_axvn_gift_card() successfully with optional parameters."""
    ...
    def test_redeem_a_axvn_gift_card_missing_required_param_code(self):
        """Test that redeem_a_axvn_gift_card() raises RequiredError when 'code' is missing."""
        params = {
            "code": "6H9EKF5ECCWFBHGE",
        }
        params["code"] = None
        ...
        with pytest.raises(RequiredError, match="Missing required parameter 'code'"):
            self.client.redeem_a_axvn_gift_card(**params)

    def test_redeem_a_axvn_gift_card_server_error(self):
        """Test that redeem_a_axvn_gift_card() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.redeem_a_axvn_gift_card = MagicMock(side_effect=mock_error)

        with pytest.raises(Exception, match="ResponseError"):
            self.client.redeem_a_axvn_gift_card(**params)

    @patch("axvn_common.utils.get_signature")
    def test_verify_axvn_gift_card_by_gift_card_number_success(
        self, mock_get_signature
    ):
        """Test verify_axvn_gift_card_by_gift_card_number() successfully with required parameters only."""
        ...
        response = self.client.verify_axvn_gift_card_by_gift_card_number(**params)
        ...
        is_oneof = is_one_of_model(VerifyAxvnGiftCardByGiftCardNumberResponse)
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(VerifyAxvnGiftCardByGiftCardNumberResponse, "from_dict")
        ):
            expected = VerifyAxvnGiftCardByGiftCardNumberResponse.from_dict(
                expected_response
            )
        else:
            expected = (
                VerifyAxvnGiftCardByGiftCardNumberResponse.model_validate_json(
                    json.dumps(expected_response)
                )
            )
    ...
    @patch("axvn_common.utils.get_signature")
    def test_verify_axvn_gift_card_by_gift_card_number_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test verify_axvn_gift_card_by_gift_card_number() successfully with optional parameters."""
    ...
    def test_verify_axvn_gift_card_by_gift_card_number_missing_required_param_reference_no(
        self,
    ):
        """Test that verify_axvn_gift_card_by_gift_card_number() raises RequiredError when 'reference_no' is missing."""
        params = {
            "reference_no": "0033002328060227",
        }
        ...
        with pytest.raises(
            ...
            self.client.verify_axvn_gift_card_by_gift_card_number(**params)

    def test_verify_axvn_gift_card_by_gift_card_number_server_error(self):
        """Test that verify_axvn_gift_card_by_gift_card_number() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.verify_axvn_gift_card_by_gift_card_number = MagicMock(
