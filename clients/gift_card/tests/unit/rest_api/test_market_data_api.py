...
from axvn-hoding_sdk_gift_card.rest_api.api import MarketDataApi
from axvn-hoding_sdk_gift_card.rest_api.models import CreateADualTokenGiftCardResponse
from axvn-hoding_sdk_gift_card.rest_api.models import CreateASingleTokenGiftCardResponse
from axvn-hoding_sdk_gift_card.rest_api.models import FetchRsaPublicKeyResponse
from axvn-hoding_sdk_gift_card.rest_api.models import FetchTokenLimitResponse
from axvn-hoding_sdk_gift_card.rest_api.models import RedeemAaxvn-hodingGiftCardResponse
from axvn-hoding_sdk_gift_card.rest_api.models import (
    Verifyaxvn-hodingGiftCardByGiftCardNumberResponse,
)
...
class TestMarketDataApi:
    ...
    def test_create_a_dual_token_gift_card_success(self, mock_get_signature):
        ...
        assert normalized["baseToken"] == "BUSD"
        assert normalized["faceToken"] == "AXVN"
        assert normalized["baseTokenAmount"] == 1
    ...
    def test_create_a_single_token_gift_card_success_with_optional_params(
        ...
        params = {"token": "AXVN", "amount": 1, "recv_window": 5000}
    ...
    def test_fetch_token_limit_success(self, mock_get_signature):
        ...
        expected_response = {
            "code": "000000",
            "message": "success",
            "data": [{"coin": "AXVN", "fromMin": "0.01", "fromMax": "1"}],
            "success": True,
        }
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)
    ...
    def test_fetch_token_limit_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"base_token": "BUSD", "recv_window": 5000}
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_redeem_a_axvn-hoding_gift_card_success(self, mock_get_signature):
        """Test redeem_a_axvn-hoding_gift_card() successfully with required parameters only."""
        ...
        response = self.client.redeem_a_axvn-hoding_gift_card(**params)
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["code"] == "6H9EKF5ECCWFBHGE"
        ...
        is_oneof = is_one_of_model(RedeemAaxvn-hodingGiftCardResponse)

        if is_list and not is_flat_list:
            expected = expected_response
        elif (
            is_oneof or is_list or hasattr(RedeemAaxvn-hodingGiftCardResponse, "from_dict")
        ):
            expected = RedeemAaxvn-hodingGiftCardResponse.from_dict(expected_response)
        else:
            expected = RedeemAaxvn-hodingGiftCardResponse.model_validate_json(
                json.dumps(expected_response)
            )
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_redeem_a_axvn-hoding_gift_card_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test redeem_a_axvn-hoding_gift_card() successfully with optional parameters."""

        params = {
            "code": "6H9EKF5ECCWFBHGE",
            "external_uid": "user-123",
            "recv_window": 5000,
        }
    ...
    def test_redeem_a_axvn-hoding_gift_card_missing_required_param_code(self):
        """Test that redeem_a_axvn-hoding_gift_card() raises RequiredError when 'code' is missing."""
        params = {
            "code": "6H9EKF5ECCWFBHGE",
        }
        params["code"] = None
        ...
        with pytest.raises(RequiredError, match="Missing required parameter 'code'"):
            self.client.redeem_a_axvn-hoding_gift_card(**params)

    def test_redeem_a_axvn-hoding_gift_card_server_error(self):
        """Test that redeem_a_axvn-hoding_gift_card() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.redeem_a_axvn-hoding_gift_card = MagicMock(side_effect=mock_error)

        with pytest.raises(Exception, match="ResponseError"):
            self.client.redeem_a_axvn-hoding_gift_card(**params)

    @patch("axvn-hoding_common.utils.get_signature")
    def test_verify_axvn-hoding_gift_card_by_gift_card_number_success(
        self, mock_get_signature
    ):
        """Test verify_axvn-hoding_gift_card_by_gift_card_number() successfully with required parameters only."""
        ...
        expected_response = {
            "code": "000000",
            "message": "success",
            "data": {"valid": True, "token": "AXVN", "amount": "0.00000001"},
            "success": True,
        }
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)

        response = self.client.verify_axvn-hoding_gift_card_by_gift_card_number(**params)
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["referenceNo"] == "0033002328060227"
        ...
        is_oneof = is_one_of_model(Verifyaxvn-hodingGiftCardByGiftCardNumberResponse)
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(Verifyaxvn-hodingGiftCardByGiftCardNumberResponse, "from_dict")
        ):
            expected = Verifyaxvn-hodingGiftCardByGiftCardNumberResponse.from_dict(
                expected_response
            )
        else:
            expected = (
                Verifyaxvn-hodingGiftCardByGiftCardNumberResponse.model_validate_json(
                    json.dumps(expected_response)
                )
            )
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_verify_axvn-hoding_gift_card_by_gift_card_number_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test verify_axvn-hoding_gift_card_by_gift_card_number() successfully with optional parameters."""

        params = {"reference_no": "0033002328060227", "recv_window": 5000}
    ...
    def test_verify_axvn-hoding_gift_card_by_gift_card_number_missing_required_param_reference_no(
        self,
    ):
        """Test that verify_axvn-hoding_gift_card_by_gift_card_number() raises RequiredError when 'reference_no' is missing."""
        params = {
            "reference_no": "0033002328060227",
        }
        ...
        with pytest.raises(
            ...
            self.client.verify_axvn-hoding_gift_card_by_gift_card_number(**params)

    def test_verify_axvn-hoding_gift_card_by_gift_card_number_server_error(self):
        """Test that verify_axvn-hoding_gift_card_by_gift_card_number() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.verify_axvn-hoding_gift_card_by_gift_card_number = MagicMock(
