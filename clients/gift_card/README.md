...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-gift-card)](https://pypi.python.org/pypi/axvn-sdk-gift-card)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-gift-card.svg)](https://pypi.org/project/axvn-sdk-gift-card/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-gift-card)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Gift Card SDK API, enabling developers to interact programmatically with Axvn's Gift Card trading platform. The library provides tools to perform crypto transfer and exchange through secured and prepaid codes through the REST API:
- [REST API](./src/axvn_sdk_gift_card/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-gift-card
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/gift_card/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_gift_card/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import GIFT_CARD_REST_API_PROD_URL
from axvn_sdk_gift_card.gift_card import GiftCard
from axvn_sdk_gift_card.rest_api.models import CreateASingleTokenGiftCardResponse
