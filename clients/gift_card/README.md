# axvn-hoding Python Gift Card SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-gift-card)](https://pypi.python.org/pypi/axvn-hoding-sdk-gift-card)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-gift-card.svg)](https://pypi.org/project/axvn-hoding-sdk-gift-card/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-gift-card)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Gift Card SDK API, enabling developers to interact programmatically with axvn-hoding's Gift Card trading platform. The library provides tools to perform crypto transfer and exchange through secured and prepaid codes through the REST API:
- [REST API](./src/axvn-hoding_sdk_gift_card/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-gift-card
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/gift_card/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_gift_card/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import GIFT_CARD_REST_API_PROD_URL
from axvn-hoding_sdk_gift_card.gift_card import GiftCard
from axvn-hoding_sdk_gift_card.rest_api.models import CreateASingleTokenGiftCardResponse
...
try:
    ...
    logging.info(f"create_a_single_token_gift_card() response: {data}")
except Exception as e:
    logging.error(f"create_a_single_token_gift_card() error: {e}")
```
