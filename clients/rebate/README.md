...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-rebate)](https://pypi.python.org/pypi/axvn-hoding-sdk-rebate)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-rebate.svg)](https://pypi.org/project/axvn-hoding-sdk-rebate/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-rebate)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Rebate SDK API, enabling developers to interact programmatically with axvn-hoding's Rebate trading platform. The library provides tools to query spot rebate history Records through the REST API:

- [REST API](./src/axvn-hoding_sdk_rebate/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-rebate
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/rebate/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_rebate/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import REBATE_REST_API_PROD_URL
from axvn-hoding_sdk_rebate.rebate import Rebate
from axvn-hoding_sdk_rebate.rest_api.models import GetSpotRebateHistoryRecordsResponse
...
If you are upgrading to the new modularized structure, refer to the [Migration Guide](./docs/migration_guide_rebate_sdk.md) for detailed steps.
