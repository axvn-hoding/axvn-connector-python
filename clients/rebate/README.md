...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-rebate)](https://pypi.python.org/pypi/axvn-sdk-rebate)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-rebate.svg)](https://pypi.org/project/axvn-sdk-rebate/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-rebate)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Rebate SDK API, enabling developers to interact programmatically with Axvn's Rebate trading platform. The library provides tools to query spot rebate history Records through the REST API:

- [REST API](./src/axvn_sdk_rebate/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-rebate
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/rebate/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_rebate/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import REBATE_REST_API_PROD_URL
