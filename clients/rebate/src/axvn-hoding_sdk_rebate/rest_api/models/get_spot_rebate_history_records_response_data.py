...
from axvn-hoding_sdk_rebate.rest_api.models.get_spot_rebate_history_records_response_data_data_inner import (
...
class GetSpotRebateHistoryRecordsResponseData(BaseModel):
    ...
    total_records: Optional[StrictInt] = Field(
        default=None, description="Total number of records.", alias="totalRecords"
    )
    total_page_num: Optional[StrictInt] = Field(
        default=None, description="Total number of pages.", alias="totalPageNum"
    )
    data: Optional[List[GetSpotRebateHistoryRecordsResponseDataDataInner]] = Field(
        default=None, description="Rebate records."
    )
