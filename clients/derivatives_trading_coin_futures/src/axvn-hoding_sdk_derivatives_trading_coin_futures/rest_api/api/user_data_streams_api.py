...
class UserDataStreamsApi:
    ...
    def close_user_data_stream(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/rest-api/user-data-streams#close-user-data-stream
    ...
    def keepalive_user_data_stream(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/rest-api/user-data-streams#keepalive-user-data-stream
    ...
    def start_user_data_stream(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/rest-api/user-data-streams#start-user-data-stream
