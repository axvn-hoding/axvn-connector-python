...
from axvn-hoding_sdk_derivatives_trading_coin_futures.rest_api.models.current_all_open_orders_response_inner import (
...
class CurrentAllOpenOrdersResponse(CurrentAllOpenOrdersResponseInner):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CurrentAllOpenOrdersResponse from a JSON string"""
