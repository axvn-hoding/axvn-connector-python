...
from axvn-hoding_sdk_derivatives_trading_coin_futures.rest_api.models.symbol_price_ticker_response_inner import (
...
class SymbolPriceTickerResponse(SymbolPriceTickerResponseInner):
    """
