...
from ..models import NewOrderClosePositionEnum
...
class TradeApi:
    ...
    async def cancel_order(
        ...
        """
            Cancel Order (TRADE)
            /order.cancel
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/ws-api/trade#cancel-order
    ...
    async def modify_order(
        ...
        """
            Modify Order (TRADE)
            /order.modify
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/ws-api/trade#modify-order
    ...
    async def new_order(
        ...
        close_position: Optional[NewOrderClosePositionEnum] = None,
        ...
        """
            New Order (TRADE)
            /order.place
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/ws-api/trade#new-order
        ...
        - Additional mandatory parameters based on `type`:
          ...
          - In Hedge Mode, cannot be used with `BUY` orders in `LONG` position side. and cannot be used with `SELL` orders in `SHORT` position side
            ...
            Args:
                    symbol (Union[str, None]):
                    side (Union[NewOrderSideEnum, None]):
                    type (Union[NewOrderTypeEnum, None]): **After CM migration, stop-type values (`STOP`, `STOP_MARKET`, `TAKE_PROFIT`, `TAKE_PROFIT_MARKET`, `TRAILING_STOP_MARKET`) are no longer accepted and will return `-4120`. Use the REST `/dapi/v1/algoOrder` endpoint instead.**
                    id (Optional[str] = None):
                    ...
                    reduce_only (Optional[NewOrderReduceOnlyEnum] = None): Cannot be sent in Hedge Mode; cannot be sent with `closePosition`=`true` (Close-All)"
                    price (Optional[float] = None):
                    ...
                    close_position (Optional[NewOrderClosePositionEnum] = None): `true`, `false`；Close-All，used with `STOP_MARKET` or `TAKE_PROFIT_MARKET`.
    ...
    async def position_information(
        ...
        """
            ...
            /account.position
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/ws-api/trade#position-information
    ...
    async def query_order(
        ...
        """
            ...
            /order.status
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/ws-api/trade#query-order
