...
class AccountApi:
    ...
    async def account_information(
        ...
        """
            ...
            /account.status
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/ws-api/account#account-information
    ...
    async def futures_account_balance(
        ...
        """
            ...
            /account.balance
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-coin-m-futures/api/ws-api/account#futures-account-balance
