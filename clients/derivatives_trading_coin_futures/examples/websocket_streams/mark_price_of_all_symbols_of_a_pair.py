...
async def mark_price_of_all_symbols_of_a_pair():
    ...
    try:
        ...
        stream = await connection.mark_price_of_all_symbols_of_a_pair(
            pair="btcusdt",
        )
        ...
        logging.error(f"mark_price_of_all_symbols_of_a_pair() error: {e}")
    finally:
        if connection:
...
if __name__ == "__main__":
    asyncio.run(mark_price_of_all_symbols_of_a_pair())
