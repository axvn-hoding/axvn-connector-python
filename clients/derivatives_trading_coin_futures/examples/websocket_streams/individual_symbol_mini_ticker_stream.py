...
async def individual_symbol_mini_ticker_stream():
    ...
    try:
        ...
        stream = await connection.individual_symbol_mini_ticker_stream(
            symbol="btcusdt",
        )
        ...
        logging.error(f"individual_symbol_mini_ticker_stream() error: {e}")
    finally:
        if connection:
...
if __name__ == "__main__":
    asyncio.run(individual_symbol_mini_ticker_stream())
