...
from axvn-hoding_common.utils import ws_streams_placeholder
from axvn-hoding_common.websocket import WebSocketStreamBase, RequestStreamHandle
from axvn-hoding_sdk_derivatives_trading_coin_futures.websocket_streams.streams import (
    DefaultApi,
)
...
def mock_websocket_client():
    ...
    websocket_stream_client.suaxvnscribe = AsyncMock()
    websocket_stream_client.unsuaxvnscribe = AsyncMock()
...
class TestWebSocketStreams:
    ...
    @pytest.mark.asyncio
    async def test_aggregate_trade_streams_suaxvnscription(self):
        """Test that aggregate_trade_streams() suaxvnscribes to the correct WebSocket stream."""
        ...
        assert callable(stream.unsuaxvnscribe)
    ...
    @pytest.mark.asyncio
    async def test_all_book_tickers_stream_suaxvnscription(self):
        """Test that all_book_tickers_stream() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_all_market_liquidation_order_streams_suaxvnscription(self):
        """Test that all_market_liquidation_order_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_all_market_mini_tickers_stream_suaxvnscription(self):
        """Test that all_market_mini_tickers_stream() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_all_market_tickers_streams_suaxvnscription(self):
        """Test that all_market_tickers_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_continuous_contract_kline_candlestick_streams_suaxvnscription(self):
        """Test that continuous_contract_kline_candlestick_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_contract_info_stream_suaxvnscription(self):
        """Test that contract_info_stream() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_diff_book_depth_streams_suaxvnscription(self):
        """Test that diff_book_depth_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_index_kline_candlestick_streams_suaxvnscription(self):
        """Test that index_kline_candlestick_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_index_price_stream_suaxvnscription(self):
        """Test that index_price_stream() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_index_price_stream_success_with_optional_params(self):
        ...
        params = {
            "pair": "btcusdt",
            "id": "e9d6b4349871b40611412680b3445fac",
            "update_speed": IndexPriceStreamUpdateSpeedEnum["UPDATE_SPEED_1s"].value,
        }
    ...
    @pytest.mark.asyncio
    async def test_individual_symbol_book_ticker_streams_suaxvnscription(self):
        """Test that individual_symbol_book_ticker_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_individual_symbol_mini_ticker_stream_suaxvnscription(self):
        """Test that individual_symbol_mini_ticker_stream() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_individual_symbol_ticker_streams_suaxvnscription(self):
        """Test that individual_symbol_ticker_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_kline_candlestick_streams_suaxvnscription(self):
        """Test that kline_candlestick_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_mark_price_kline_candlestick_streams_suaxvnscription(self):
        """Test that mark_price_kline_candlestick_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_mark_price_of_all_symbols_of_a_pair_suaxvnscription(self):
        """Test that mark_price_of_all_symbols_of_a_pair() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_mark_price_of_all_symbols_of_a_pair_success_with_optional_params(
        ...
        params = {
            "pair": "btcusdt",
            "id": "e9d6b4349871b40611412680b3445fac",
            "update_speed": MarkPriceOfAllSymbolsOfAPairUpdateSpeedEnum[
                "UPDATE_SPEED_1s"
            ].value,
        }
    ...
    @pytest.mark.asyncio
    async def test_mark_price_stream_suaxvnscription(self):
        """Test that mark_price_stream() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_mark_price_stream_success_with_optional_params(self):
        ...
        params = {
            "symbol": "btcusdt",
            "id": "e9d6b4349871b40611412680b3445fac",
            "update_speed": MarkPriceStreamUpdateSpeedEnum["UPDATE_SPEED_1s"].value,
        }
    ...
    @pytest.mark.asyncio
    async def test_market_liquidation_order_streams_suaxvnscription(self):
        """Test that market_liquidation_order_streams() suaxvnscribes to the correct WebSocket stream."""
        ...
        stream = await self.ws_streams.market_liquidation_order_streams(**params)
        assert isinstance(stream, RequestStreamHandle)
        assert callable(stream.on)
        assert callable(stream.unsuaxvnscribe)
        stream.on("message", mock_callback)
    ...
    @pytest.mark.asyncio
    async def test_market_liquidation_order_streams_success(self):
        """Test market_liquidation_order_streams() successfully with required parameters only."""
        ...
        self.ws_streams.market_liquidation_order_streams = AsyncMock(
            return_value=expected_response
        )

        response = await self.ws_streams.market_liquidation_order_streams(**params)
        assert response is not None
        assert response == expected_response

    @pytest.mark.asyncio
    async def test_market_liquidation_order_streams_success_with_optional_params(self):
        """Test market_liquidation_order_streams() successfully with optional parameters."""
    ...
    @pytest.mark.asyncio
    async def test_market_liquidation_order_streams_missing_required_param_symbol(self):
        """Test that market_liquidation_order_streams() raises RequiredError when 'symbol' is missing."""
        params = {
            "symbol": "btcusdt",
        }
        params["symbol"] = None
        ...
        with pytest.raises(RequiredError, match="Missing required parameter 'symbol'"):
            await self.ws_streams.market_liquidation_order_streams(**params)

    @pytest.mark.asyncio
    async def test_market_liquidation_order_streams_server_error(self):
        """Test that market_liquidation_order_streams() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.ws_streams.market_liquidation_order_streams = MagicMock(
            side_effect=mock_error
        )
    ...
    @pytest.mark.asyncio
    async def test_partial_book_depth_streams_suaxvnscription(self):
        """Test that partial_book_depth_streams() suaxvnscribes to the correct WebSocket stream."""

        params = {
            "symbol": "btcusdt",
            "levels": PartialBookDepthStreamsLevelsEnum["LEVELS_5"].value,
        }
