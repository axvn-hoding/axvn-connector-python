...
from axvn-hoding_sdk_derivatives_trading_coin_futures.websocket_api.api import TradeApi
...
class TestWebSocketTradeApi:
    ...
    async def test_new_order_success_with_optional_params(self):
        ...
        params = {
            ...
            "stop_price": 1.0,
            "close_position": NewOrderClosePositionEnum["TRUE"].value,
        ...
        assert params["close_position"] == NewOrderClosePositionEnum["TRUE"].value
        assert params["activation_price"] == 1.0
        assert params["callback_rate"] == 5000.0
        assert params["working_type"] == NewOrderWorkingTypeEnum["MARK_PRICE"].value
        assert params["price_protect"] == NewOrderPriceProtectEnum["TRUE"].value
        assert (
    ...
    async def test_position_information_success_with_optional_params(self):
        ...
        assert params["id"] == "e9d6b4349871b40611412680b3445fac"
        assert params["margin_asset"] == "USDT"
