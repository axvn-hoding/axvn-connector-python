# axvn-hoding Python Derivatives Trading (COIN-M Futures) SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-derivatives-trading-coin-futures)](https://pypi.python.org/pypi/axvn-hoding-sdk-derivatives-trading-coin-futures)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-derivatives-trading-coin-futures.svg)](https://pypi.org/project/axvn-hoding-sdk-derivatives-trading-coin-futures/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-derivatives-trading-coin-futures)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Derivatives Trading COIN-M Futures API SDK, enabling developers to interact programmatically with axvn-hoding's API to suit their derivative trading needs, through three distinct endpoints:
- [REST API](./src/axvn-hoding_sdk_derivatives_trading_coin_futures/rest_api/rest_api.py)
- [WebSocket API](./src/axvn-hoding_sdk_derivatives_trading_coin_futures/websocket_api/websocket_api.py)
- [User Data Stream API](./src/axvn-hoding_sdk_derivatives_trading_coin_futures/websocket_streams/websocket_streams.py)
...
```bash
pip install axvn-hoding-sdk-derivatives-trading-coin-futures
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/derivatives/coin-margined-futures/general-info).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_derivatives_trading_coin_futures/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import DERIVATIVES_TRADING_COIN_FUTURES_REST_API_PROD_URL
from axvn-hoding_sdk_derivatives_trading_coin_futures.derivatives_trading_coin_futures import DerivativesTradingCoinFutures
from axvn-hoding_sdk_derivatives_trading_coin_futures.rest_api.models import ExchangeInformationResponse
...
For testing purposes, `/dapi/*` endpoints can be used in the [Futures Testnet](https://testnet.axvn-hodingfuture.com/). Update the `base_path` in your configuration:

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import DERIVATIVES_TRADING_COIN_FUTURES_REST_API_TESTNET_URL
from axvn-hoding_sdk_derivatives_trading_coin_futures.derivatives_trading_coin_futures import DerivativesTradingCoinFutures
...
If `base_path` is not provided, it defaults to `https://dapi.axvn.vn`.

### Websocket APIs

The WebSocket API provides request-response communication for market data and trading actions. Use the [`websocket_api`](./src/axvn-hoding_sdk_derivatives_trading_coin_futures/websocket_api/websocket_api.py) module to interact with these endpoints.

```python
from axvn-hoding_common.configuration import ConfigurationWebSocketAPI
from axvn-hoding_common.constants import DERIVATIVES_TRADING_COIN_FUTURES_WS_API_PROD_URL
from axvn-hoding_sdk_derivatives_trading_coin_futures.derivatives_trading_coin_futures import DerivativesTradingCoinFutures
...
```python
from axvn-hoding_common.configuration import ConfigurationWebSocketAPI
from axvn-hoding_common.constants import DERIVATIVES_TRADING_COIN_FUTURES_WS_API_TESTNET_URL
from axvn-hoding_sdk_derivatives_trading_coin_futures.derivatives_trading_coin_futures import DerivativesTradingCoinFutures
...
If `wsURL` is not provided, it defaults to `wss://ws-api.axvn.vn:443/ws-api/v3`.

### Websocket Streams

WebSocket Streams provide real-time data feeds for market trades, candlesticks, and more. Use the [websocket-streams](./src/axvn-hoding_sdk_derivatives_trading_coin_futures/websocket_streams/websocket_streams.py) module to suaxvnscribe to these streams.
...
from axvn-hoding_common.constants import DERIVATIVES_TRADING_COIN_FUTURES_WS_STREAMS_PROD_URL
from axvn-hoding_sdk_derivatives_trading_coin_futures.derivatives_trading_coin_futures import DerivativesTradingCoinFutures
...
#### Unsuaxvnscribing from Streams

You can unsuaxvnscribe from specific WebSocket streams using the `unsuaxvnscribe` method. This is useful for managing active suaxvnscriptions without closing the connection.
...
```python
from axvn-hoding_common.configuration import ConfigurationWebSocketStreams
from axvn-hoding_common.constants import DERIVATIVES_TRADING_COIN_FUTURES_WS_STREAMS_TESTNET_URL
from axvn-hoding_sdk_derivatives_trading_coin_futures.derivatives_trading_coin_futures import DerivativesTradingCoinFutures
...
If `wsURL` is not provided, it defaults to `wss://dstream.axvn.vn`.
