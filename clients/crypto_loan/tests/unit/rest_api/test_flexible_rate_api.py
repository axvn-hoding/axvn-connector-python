...
from axvn-hoding_sdk_crypto_loan.rest_api.api import FlexibleRateApi
from axvn-hoding_sdk_crypto_loan.rest_api.models import CheckCollateralRepayRateResponse
from axvn-hoding_sdk_crypto_loan.rest_api.models import FlexibleLoanAdjustLtvResponse
from axvn-hoding_sdk_crypto_loan.rest_api.models import FlexibleLoanBorrowResponse
from axvn-hoding_sdk_crypto_loan.rest_api.models import FlexibleLoanRepayResponse
from axvn-hoding_sdk_crypto_loan.rest_api.models import GetFlexibleLoanAssetsDataResponse
from axvn-hoding_sdk_crypto_loan.rest_api.models import GetFlexibleLoanBorrowHistoryResponse
from axvn-hoding_sdk_crypto_loan.rest_api.models import (
...
from axvn-hoding_sdk_crypto_loan.rest_api.models import GetFlexibleLoanOngoingOrdersResponse
from axvn-hoding_sdk_crypto_loan.rest_api.models import (
...
from axvn-hoding_sdk_crypto_loan.rest_api.models import FlexibleLoanRepayRepaymentTypeEnum
...
class TestFlexibleRateApi:
    ...
    def test_check_collateral_repay_rate_success(self, mock_get_signature):
        ...
        assert normalized["loanCoin"] == "BUSD"
        assert normalized["collateralCoin"] == "AXVN"
    ...
    def test_check_collateral_repay_rate_success_with_optional_params(
        ...
        params = {"loan_coin": "BUSD", "collateral_coin": "AXVN", "recv_window": 5000}
    ...
    def test_flexible_loan_adjust_ltv_success(self, mock_get_signature):
        ...
        assert normalized["loanCoin"] == "BUSD"
        assert normalized["collateralCoin"] == "AXVN"
        assert normalized["adjustmentAmount"] == 1
        assert (
            normalized["direction"]
            == FlexibleLoanAdjustLtvDirectionEnum["ADDITIONAL"].value
        )
    ...
    def test_flexible_loan_repay_success(self, mock_get_signature):
        ...
        assert normalized["loanCoin"] == "BUSD"
        assert normalized["collateralCoin"] == "AXVN"
        assert normalized["repayAmount"] == 1
    ...
    def test_flexible_loan_repay_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            ...
            "repayment_type": FlexibleLoanRepayRepaymentTypeEnum[
                "REPAYMENT_TYPE_1"
            ].value,
            "recv_window": 5000,
        }
    ...
    def test_get_flexible_loan_assets_data_success_with_optional_params(
        ...
        params = {"loan_coin": "BUSD", "recv_window": 5000}
    ...
    def test_get_flexible_loan_collateral_assets_data_success_with_optional_params(
        ...
        params = {"collateral_coin": "AXVN", "recv_window": 5000}
