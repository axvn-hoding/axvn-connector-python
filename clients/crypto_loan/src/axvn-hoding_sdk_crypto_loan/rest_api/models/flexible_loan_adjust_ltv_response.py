...
class FlexibleLoanAdjustLtvResponse(BaseModel):
    """
    ...
    adjustment_amount: Optional[StrictStr] = Field(
        default=None, alias="adjustmentAmount"
    )
    current_ltv: Optional[StrictStr] = Field(default=None, alias="currentLTV")
    status: Optional[StrictStr] = Field(
        default=None, description="Succeeds, Failed, Processing"
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FlexibleLoanAdjustLtvResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FlexibleLoanAdjustLtvResponse from a dict"""
        if obj is None:
            return None
