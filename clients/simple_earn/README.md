# axvn-hoding Python Simple Earn Connector
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-simple-earn)](https://pypi.python.org/pypi/axvn-hoding-sdk-simple-earn)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-simple-earn.svg)](https://pypi.org/project/axvn-hoding-sdk-simple-earn/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-simple-earn)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Simple Earn SDK API, enabling developers to interact programmatically with axvn-hoding's Simple Earn trading platform. The library provides tools to earn rewards by depositing digital assets for either flexible or locked periods of time through the REST API:

- [REST API](./src/axvn-hoding_sdk_simple_earn/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-simple-earn
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/simple_earn/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_simple_earn/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import SIMPLE_EARN_REST_API_PROD_URL
from axvn-hoding_sdk_simple_earn.simple_earn import SimpleEarn
from axvn-hoding_sdk_simple_earn.rest_api.models import GetSimpleEarnLockedProductListResponse
