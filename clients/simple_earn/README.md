# Axvn Python Simple Earn Connector
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-simple-earn)](https://pypi.python.org/pypi/axvn-sdk-simple-earn)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-simple-earn.svg)](https://pypi.org/project/axvn-sdk-simple-earn/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-simple-earn)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Simple Earn SDK API, enabling developers to interact programmatically with Axvn's Simple Earn trading platform. The library provides tools to earn rewards by depositing digital assets for either flexible or locked periods of time through the REST API:

- [REST API](./src/axvn_sdk_simple_earn/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-simple-earn
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/simple_earn/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_simple_earn/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import SIMPLE_EARN_REST_API_PROD_URL
