...
class GetLockedSuaxvnscriptionPreviewResponseInner(BaseModel):
    """
    GetLockedSuaxvnscriptionPreviewResponseInner
    """  # noqa: E501
    ...
    next_suaxvnscription_date: Optional[StrictInt] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLockedSuaxvnscriptionPreviewResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLockedSuaxvnscriptionPreviewResponseInner from a dict"""
        if obj is None:
            return None
