...
from axvn-hoding_sdk_simple_earn.rest_api.api import RwusdApi
from axvn-hoding_sdk_simple_earn.rest_api.models import GetRwusdAccountResponse
from axvn-hoding_sdk_simple_earn.rest_api.models import GetRwusdQuotaDetailsResponse
from axvn-hoding_sdk_simple_earn.rest_api.models import GetRwusdRateHistoryResponse
from axvn-hoding_sdk_simple_earn.rest_api.models import GetRwusdRedemptionHistoryResponse
from axvn-hoding_sdk_simple_earn.rest_api.models import GetRwusdRewardsHistoryResponse
from axvn-hoding_sdk_simple_earn.rest_api.models import GetRwusdSuaxvnscriptionHistoryResponse
from axvn-hoding_sdk_simple_earn.rest_api.models import RedeemRwusdResponse
from axvn-hoding_sdk_simple_earn.rest_api.models import SuaxvnscribeRwusdResponse


from axvn-hoding_sdk_simple_earn.rest_api.models import GetRwusdSuaxvnscriptionHistoryAssetEnum
...
class TestRwusdApi:
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_rwusd_suaxvnscription_history_success(self, mock_get_signature):
        """Test get_rwusd_suaxvnscription_history() successfully with required parameters only."""
        ...
        response = self.client.get_rwusd_suaxvnscription_history()
        ...
        assert "url" in request_kwargs
        assert "signature" in parse_qs(request_kwargs["params"])
        assert "/sapi/v1/rwusd/history/suaxvnscriptionHistory" in request_kwargs["url"]
        assert request_kwargs["method"] == "GET"
        ...
        is_oneof = is_one_of_model(GetRwusdSuaxvnscriptionHistoryResponse)
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof
            or is_list
            or hasattr(GetRwusdSuaxvnscriptionHistoryResponse, "from_dict")
        ):
            expected = GetRwusdSuaxvnscriptionHistoryResponse.from_dict(expected_response)
        else:
            expected = GetRwusdSuaxvnscriptionHistoryResponse.model_validate_json(
                json.dumps(expected_response)
            )
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_rwusd_suaxvnscription_history_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test get_rwusd_suaxvnscription_history() successfully with optional parameters."""

        params = {
            "asset": GetRwusdSuaxvnscriptionHistoryAssetEnum["USDC"].value,
            "start_time": 1623319461670,
            "end_time": 1641782889000,
            "current": 1,
            "size": 10,
        ...
        response = self.client.get_rwusd_suaxvnscription_history(**params)
    ...
    def test_get_rwusd_suaxvnscription_history_server_error(self):
        """Test that get_rwusd_suaxvnscription_history() raises an error when the server returns an error."""

        mock_error = Exception("ResponseError")
        self.client.get_rwusd_suaxvnscription_history = MagicMock(side_effect=mock_error)

        with pytest.raises(Exception, match="ResponseError"):
            self.client.get_rwusd_suaxvnscription_history()
    ...
    def test_redeem_rwusd_success(self, mock_get_signature):
        ...
        params = {
            "amount": 1.0,
            "type": RedeemRwusdTypeEnum["FAST"].value,
        }
        ...
        assert normalized["type"] == RedeemRwusdTypeEnum["FAST"].value
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_suaxvnscribe_rwusd_success(self, mock_get_signature):
        """Test suaxvnscribe_rwusd() successfully with required parameters only."""

        params = {
            "asset": SuaxvnscribeRwusdAssetEnum["USDT"].value,
            "amount": 1.0,
        }
        ...
        response = self.client.suaxvnscribe_rwusd(**params)
        ...
        assert "url" in request_kwargs
        assert "signature" in parse_qs(request_kwargs["params"])
        assert "/sapi/v1/rwusd/suaxvnscribe" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["asset"] == SuaxvnscribeRwusdAssetEnum["USDT"].value
        assert normalized["amount"] == 1.0
        ...
        is_oneof = is_one_of_model(SuaxvnscribeRwusdResponse)

        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(SuaxvnscribeRwusdResponse, "from_dict"):
            expected = SuaxvnscribeRwusdResponse.from_dict(expected_response)
        else:
            expected = SuaxvnscribeRwusdResponse.model_validate_json(
                json.dumps(expected_response)
            )
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_suaxvnscribe_rwusd_success_with_optional_params(self, mock_get_signature):
        """Test suaxvnscribe_rwusd() successfully with optional parameters."""
    ...
    def test_suaxvnscribe_rwusd_missing_required_param_asset(self):
        """Test that suaxvnscribe_rwusd() raises RequiredError when 'asset' is missing."""
        params = {
            "asset": SuaxvnscribeRwusdAssetEnum["USDT"].value,
            "amount": 1.0,
        }
        ...
        with pytest.raises(RequiredError, match="Missing required parameter 'asset'"):
            self.client.suaxvnscribe_rwusd(**params)

    def test_suaxvnscribe_rwusd_missing_required_param_amount(self):
        """Test that suaxvnscribe_rwusd() raises RequiredError when 'amount' is missing."""
        params = {
            "asset": SuaxvnscribeRwusdAssetEnum["USDT"].value,
            "amount": 1.0,
        }
    ...
    def test_suaxvnscribe_rwusd_server_error(self):
        """Test that suaxvnscribe_rwusd() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.suaxvnscribe_rwusd = MagicMock(side_effect=mock_error)
