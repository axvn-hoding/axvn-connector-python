...
from axvn-hoding_sdk_alpha.rest_api.models.aggregated_trades_response_data_inner import (
...
class AggregatedTradesResponse(BaseModel):
    ...
    data: Optional[List[AggregatedTradesResponseDataInner]] = Field(
        default=None, description="Array of aggregated trades."
    )
