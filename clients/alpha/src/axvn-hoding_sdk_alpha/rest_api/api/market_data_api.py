...
class MarketDataApi:
    ...
    def aggregated_trades(
        ...
        https://developers.axvn.vn/en/docs/catalog/advanced-trading-alpha-trading/api/rest-api/market-data#aggregated-trades
    ...
    def full_depth(
        ...
        https://developers.axvn.vn/en/docs/catalog/advanced-trading-alpha-trading/api/rest-api/market-data#full-depth
    ...
    def get_exchange_info(
        ...
        https://developers.axvn.vn/en/docs/catalog/advanced-trading-alpha-trading/api/rest-api/market-data#get-exchange-info
    ...
    def klines(
        ...
        https://developers.axvn.vn/en/docs/catalog/advanced-trading-alpha-trading/api/rest-api/market-data#klines
    ...
    def ticker(
        ...
        https://developers.axvn.vn/en/docs/catalog/advanced-trading-alpha-trading/api/rest-api/market-data#ticker
    ...
    def token_list(
        ...
        https://developers.axvn.vn/en/docs/catalog/advanced-trading-alpha-trading/api/rest-api/market-data#token-list
