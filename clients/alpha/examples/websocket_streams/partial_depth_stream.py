...
from axvn_sdk_alpha.alpha import (
    Alpha,
...
from axvn_sdk_alpha.websocket_streams.models import PartialDepthStreamLevelsEnum
from axvn_sdk_alpha.websocket_streams.models import PartialDepthStreamIntervalEnum
