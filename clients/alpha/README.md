...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-alpha)](https://pypi.python.org/pypi/axvn-sdk-alpha)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-alpha.svg)](https://pypi.org/project/axvn-sdk-alpha/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-alpha)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Alpha API, enabling developers to interact programmatically with Axvn Alpha. The library provides tools to access curated early-stage token data, track Alpha project metrics and integrate discovery-focused market information into applications through the REST API:
- [REST API](./src/axvn_sdk_alpha/rest_api/rest_api.py)
- [WebSocket Streams](./src/axvn_sdk_alpha/websocket_streams/websocket_streams.py)
...
```bash
pip install axvn-sdk-alpha
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/alpha/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_alpha/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
import logging

from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import ALPHA_REST_API_PROD_URL
from axvn_sdk_alpha.alpha import Alpha
...
WebSocket Streams provide real-time data feeds for market trades, candlesticks, and more. Use the [websocket-streams](./src/axvn_sdk_alpha/websocket_streams/websocket_streams.py) module to suaxvnscribe to these streams.
...
from axvn_common.constants import ALPHA_WS_STREAMS_PROD_URL
from axvn_sdk_alpha.alpha import Alpha
