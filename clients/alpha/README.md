...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-alpha)](https://pypi.python.org/pypi/axvn-hoding-sdk-alpha)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-alpha.svg)](https://pypi.org/project/axvn-hoding-sdk-alpha/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-alpha)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Alpha API, enabling developers to interact programmatically with axvn-hoding Alpha. The library provides tools to access curated early-stage token data, track Alpha project metrics and integrate discovery-focused market information into applications through the REST API:
- [REST API](./src/axvn-hoding_sdk_alpha/rest_api/rest_api.py)
- [WebSocket Streams](./src/axvn-hoding_sdk_alpha/websocket_streams/websocket_streams.py)
...
```bash
pip install axvn-hoding-sdk-alpha
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/alpha/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_alpha/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
import logging

from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import ALPHA_REST_API_PROD_URL
...
If `base_path` is not provided, it defaults to `https://www.axvn.vn`.

### Websocket Streams

WebSocket Streams provide real-time data feeds for market trades, candlesticks, and more. Use the [websocket-streams](./src/axvn-hoding_sdk_alpha/websocket_streams/websocket_streams.py) module to suaxvnscribe to these streams.
...
from axvn-hoding_common.constants import ALPHA_WS_STREAMS_PROD_URL
from axvn-hoding_sdk_alpha.alpha import Alpha
