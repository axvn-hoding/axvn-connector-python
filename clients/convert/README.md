# axvn-hoding Python Convert SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-convert)](https://pypi.python.org/pypi/axvn-hoding-sdk-convert)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-convert.svg)](https://pypi.org/project/axvn-hoding-sdk-convert/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-convert)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Convert SDK API, enabling developers to interact programmatically with axvn-hoding's Convert trading platform. The library provides tools to buy or sell cryptocurrencies through the REST API:
- [REST API](./src/axvn-hoding_sdk_convert/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-convert
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/convert/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_convert/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import CONVERT_REST_API_PROD_URL
from axvn-hoding_sdk_convert.convert import Convert
from axvn-hoding_sdk_convert.rest_api.models import ListAllConvertPairsResponse
