...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-convert)](https://pypi.python.org/pypi/axvn-sdk-convert)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-convert.svg)](https://pypi.org/project/axvn-sdk-convert/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-convert)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Convert SDK API, enabling developers to interact programmatically with Axvn's Convert trading platform. The library provides tools to buy or sell cryptocurrencies through the REST API:
- [REST API](./src/axvn_sdk_convert/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-convert
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/convert/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_convert/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import CONVERT_REST_API_PROD_URL
from axvn_sdk_convert.convert import Convert
from axvn_sdk_convert.rest_api.models import ListAllConvertPairsResponse
