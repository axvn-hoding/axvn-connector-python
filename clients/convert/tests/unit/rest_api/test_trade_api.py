...
from axvn-hoding_sdk_convert.rest_api.api import TradeApi
from axvn-hoding_sdk_convert.rest_api.models import AcceptQuoteResponse
from axvn-hoding_sdk_convert.rest_api.models import CancelLimitOrderResponse
from axvn-hoding_sdk_convert.rest_api.models import GetConvertTradeHistoryResponse
from axvn-hoding_sdk_convert.rest_api.models import OrderStatusResponse
from axvn-hoding_sdk_convert.rest_api.models import PlaceLimitOrderResponse
from axvn-hoding_sdk_convert.rest_api.models import QueryLimitOpenOrdersResponse
from axvn-hoding_sdk_convert.rest_api.models import SendQuoteRequestResponse
...
from axvn-hoding_sdk_convert.rest_api.models import PlaceLimitOrderWalletTypeEnum


from axvn-hoding_sdk_convert.rest_api.models import SendQuoteRequestWalletTypeEnum
from axvn-hoding_sdk_convert.rest_api.models import SendQuoteRequestValidTimeEnum
...
class TestTradeApi:
    ...
    def test_accept_quote_success(self, mock_get_signature):
        ...
        elif is_oneof or is_list or hasattr(AcceptQuoteResponse, "from_dict"):
    ...
    def test_cancel_limit_order_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["orderId"] == 1603680255057330400
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(CancelLimitOrderResponse, "from_dict"):
    ...
    def test_cancel_limit_order_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"order_id": 1603680255057330400, "recv_window": 5000}
    ...
    def test_get_convert_trade_history_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            ...
            is_oneof or is_list or hasattr(GetConvertTradeHistoryResponse, "from_dict")
        ):
    ...
    def test_place_limit_order_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["baseAsset"] == "BTC"
        assert normalized["quoteAsset"] == "USDT"
        assert normalized["limitPrice"] == 1
        assert normalized["side"] == PlaceLimitOrderSideEnum["BUY"].value
        assert (
            normalized["expiredType"]
            == PlaceLimitOrderExpiredTypeEnum["EXPIRED_TYPE_1_D"].value
        )
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(PlaceLimitOrderResponse, "from_dict"):
    ...
    def test_place_limit_order_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            ...
            "base_amount": 1,
            "quote_amount": 1,
            "wallet_type": PlaceLimitOrderWalletTypeEnum["SPOT"].value,
            "recv_window": 5000,
        }
    ...
    def test_query_limit_open_orders_success(self, mock_get_signature):
        ...
        if is_list and not is_flat_list:
            expected = expected_response
        elif is_oneof or is_list or hasattr(QueryLimitOpenOrdersResponse, "from_dict"):
    ...
    def test_send_quote_request_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["fromAsset"] == "BTC"
        assert normalized["toAsset"] == "USDT"
    ...
    def test_send_quote_request_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            ...
            "from_amount": 1,
            "to_amount": 1,
            "wallet_type": SendQuoteRequestWalletTypeEnum["SPOT"].value,
            "valid_time": SendQuoteRequestValidTimeEnum["VALID_TIME_10s"].value,
            "recv_window": 5000,
        }
