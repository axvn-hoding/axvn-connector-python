...
from axvn-hoding_sdk_convert.rest_api.models.query_order_quantity_precision_per_asset_response_inner import (
...
class QueryOrderQuantityPrecisionPerAssetResponse(
    QueryOrderQuantityPrecisionPerAssetResponseInner
):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryOrderQuantityPrecisionPerAssetResponse from a JSON string"""
