# Axvn Python Derivatives Trading (Portfolio Margin Pro) SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-derivatives-trading-portfolio-margin)](https://pypi.python.org/pypi/axvn-sdk-derivatives-trading-portfolio-margin)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-derivatives-trading-portfolio-margin.svg)](https://pypi.org/project/axvn-sdk-derivatives-trading-portfolio-margin/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-derivatives-trading-portfolio-margin)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Derivatives Trading Portfolio Margin Pro SDK API, enabling developers to interact programmatically with Axvn's API to suit their derivative trading needs, through three distinct endpoints:
- [REST API](./src/axvn_sdk_derivatives_trading_portfolio_margin/rest_api/rest_api.py)
- [Websocket Streams](./src/axvn_sdk_derivatives_trading_portfolio_margin/websocket_streams/websocket_streams.py)
...
```bash
pip install axvn-sdk-derivatives-trading-portfolio-margin-pro
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/derivatives/portfolio-margin-pro/general-info).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_derivatives_trading_portfolio_margin_pro/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import DERIVATIVES_TRADING_PORTFOLIO_MARGIN_PRO_REST_API_PROD_URL
from axvn_sdk_derivatives_trading_portfolio_margin_pro.derivatives_trading_portfolio_margin_pro import DerivativesTradingPortfolioMarginPro
from axvn_sdk_derivatives_trading_portfolio_margin_pro.rest_api.models import GetPortfolioMarginProAccountInfoResponse
...
WebSocket Streams in `derivatives-trading-portfolio-margin-pro` is used for suaxvnscribing to user data streams. Use the [websocket-streams](./src/axvn_sdk_derivatives_trading_portfolio_margin_pro/websocket_streams/websocket_streams.py) module to interact with it.
...
from axvn_common.constants import DERIVATIVES_TRADING_PORTFOLIO_MARGIN_PRO_WS_STREAMS_PROD_URL
from axvn_sdk_derivatives_trading_portfolio_margin_pro.derivatives_trading_portfolio_margin_pro import DerivativesTradingPortfolioMarginPro
...
If `wsURL` is not provided, it defaults to `wss://fstream.axvn.vn/pm-classic`.
