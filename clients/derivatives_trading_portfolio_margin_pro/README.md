# axvn-hoding Python Derivatives Trading (Portfolio Margin Pro) SDK
...
This is a client library for the axvn-hoding Derivatives Trading Portfolio Margin Pro SDK API, enabling developers to interact programmatically with axvn-hoding's API to suit their derivative trading needs, through three distinct endpoints:
...
For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/derivatives/portfolio-margin-pro/general-info).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_derivatives_trading_portfolio_margin_pro/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import DERIVATIVES_TRADING_PORTFOLIO_MARGIN_PRO_REST_API_PROD_URL
...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin_pro.rest_api.models import GetPortfolioMarginProAccountInfoResponse
...
WebSocket Streams in `derivatives-trading-portfolio-margin-pro` is used for suaxvnscribing to user data streams. Use the [websocket-streams](./src/axvn-hoding_sdk_derivatives_trading_portfolio_margin_pro/websocket_streams/websocket_streams.py) module to interact with it.
...
from axvn-hoding_common.constants import DERIVATIVES_TRADING_PORTFOLIO_MARGIN_PRO_WS_STREAMS_PROD_URL
from axvn-hoding_sdk_derivatives_trading_portfolio_margin_pro.derivatives_trading_portfolio_margin_pro import DerivativesTradingPortfolioMarginPro
