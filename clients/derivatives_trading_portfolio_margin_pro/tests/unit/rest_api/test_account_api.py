...
from axvn-hoding_sdk_derivatives_trading_portfolio_margin_pro.rest_api.api import AccountApi
...
class TestAccountApi:
    ...
    def test_axvn_transfer_success(self, mock_get_signature):
        ...
        assert "/sapi/v1/portfolio/axvn-transfer" in request_kwargs["url"]
    ...
    def test_get_transferable_earn_asset_balance_for_portfolio_margin_success(
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["asset"] == "LDUSDT"
        assert (
    ...
    def test_portfolio_margin_pro_bankruptcy_loan_repay_success_with_optional_params(
        ...
        params = {
            "var_from": PortfolioMarginProBankruptcyLoanRepayVarFromEnum["SPOT"].value,
            "recv_window": 5000,
        }
    ...
    def test_repay_futures_negative_balance_success_with_optional_params(
        ...
        params = {
            "var_from": RepayFuturesNegativeBalanceVarFromEnum["SPOT"].value,
            "recv_window": 5000,
        }
    ...
    def test_set_margin_call_level_success(self, mock_get_signature):
        ...
        assert "/sapi/v1/portfolio/margin-call-level" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["marginCallLevel"] == 1.5
    ...
    def test_set_margin_call_level_success_with_optional_params(
        ...
        params = {"margin_call_level": 1.5, "recv_window": 5000}
    ...
    def test_switch_delta_mode_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert (
            normalized["deltaEnabled"] == SwitchDeltaModeDeltaEnabledEnum["TRUE"].value
        )
    ...
    def test_transfer_ldusdt_rwusd_for_portfolio_margin_success(
        ...
        assert (
            normalized["asset"]
            == TransferLdusdtRwusdForPortfolioMarginAssetEnum["LDUSDT"].value
        )
        assert (
            normalized["transferType"]
            == TransferLdusdtRwusdForPortfolioMarginTransferTypeEnum[
