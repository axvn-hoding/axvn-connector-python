...
class DerivativesTradingPortfolioMarginPro:
    """DerivativesTradingPortfolioMarginPro API that exposes REST, and Stream APIs in a single interface."""
    ...
    @property
    def rest_api(self) -> DerivativesTradingPortfolioMarginProRestAPI:
        if self._rest_api is None and self._rest_api_config:
            ...
            self._rest_api = DerivativesTradingPortfolioMarginProRestAPI(
                self._rest_api_config
            )
        return self._rest_api

    @property
    def websocket_streams(self) -> DerivativesTradingPortfolioMarginProWebSocketStreams:
