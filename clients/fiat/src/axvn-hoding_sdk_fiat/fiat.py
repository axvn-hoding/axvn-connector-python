...
from .rest_api import FiatRestAPI
...
class Fiat:
    """Fiat API that exposes REST APIs in a single interface."""
    ...
    def rest_api(self) -> FiatRestAPI:
        if self._rest_api is None and self._rest_api_config:
            ...
            self._rest_api = FiatRestAPI(self._rest_api_config)
