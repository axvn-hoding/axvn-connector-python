...
Query axvn-hoding fiat deposit and withdrawal history.
...
from axvn-hoding_sdk_fiat.rest_api.api import DefaultApi
from axvn-hoding_sdk_fiat.rest_api.models import DepositResponse
from axvn-hoding_sdk_fiat.rest_api.models import FiatWithdrawResponse
from axvn-hoding_sdk_fiat.rest_api.models import GetFiatDepositWithdrawHistoryResponse
from axvn-hoding_sdk_fiat.rest_api.models import GetFiatPaymentsHistoryResponse
from axvn-hoding_sdk_fiat.rest_api.models import GetOrderDetailResponse
...
class TestDefaultApi:
    ...
    def test_get_fiat_deposit_withdraw_history_success(self, mock_get_signature):
        ...
        assert normalized["transactionType"] == "0"
    ...
    def test_get_order_detail_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["orderNo"] == "036752*678"
    ...
    def test_get_order_detail_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"order_no": "036752*678", "recv_window": 5000}
