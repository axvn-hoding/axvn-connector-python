...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-fiat)](https://pypi.python.org/pypi/axvn-sdk-fiat)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-fiat.svg)](https://pypi.org/project/axvn-sdk-fiat/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-fiat)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Fiat SDK API, enabling developers to interact programmatically with Axvn's Fiat trading platform. The library provides tools to get Axvn Fiat SDK Deposit/Withdraw history through the REST API:
- [REST API](./src/axvn_sdk_fiat/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-fiat
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/fiat/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_fiat/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import FIAT_REST_API_PROD_URL
