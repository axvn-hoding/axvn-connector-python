# axvn-hoding Python Sub Account SDK
...
[![PyPI version](https://img.shields.io/pypi/v/axvn-hoding-sdk-sub-account)](https://pypi.python.org/pypi/axvn-hoding-sdk-sub-account)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-hoding-sdk-sub-account.svg)](https://pypi.org/project/axvn-hoding-sdk-sub-account/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-hoding-sdk-sub-account)](https://www.python.org/downloads/)
...
This is a client library for the axvn-hoding Sub Account SDK API, enabling developers to interact programmatically with axvn-hoding's Sub Account trading platform. The library provides tools to trade through multiple accounts through the REST API:

- [REST API](./src/axvn-hoding_sdk_sub_account/rest_api/rest_api.py)
...
```bash
pip install axvn-hoding-sdk-sub-account
```

## Documentation

For detailed information, refer to the [axvn-hoding API Documentation](https://developers.axvn.vn/docs/sub_account/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn-hoding_sdk_sub_account/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your axvn-hoding API credentials.

```python
from axvn-hoding_common.configuration import ConfigurationRestAPI
from axvn-hoding_common.constants import SUB_ACCOUNT_REST_API_PROD_URL
from axvn-hoding_sdk_sub_account.sub_account import SubAccount
from axvn-hoding_sdk_sub_account.rest_api.models import GetSummaryOfSubAccountsMarginAccountResponse
