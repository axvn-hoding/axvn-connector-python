...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-sub-account)](https://pypi.python.org/pypi/axvn-sdk-sub-account)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-sub-account.svg)](https://pypi.org/project/axvn-sdk-sub-account/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-sub-account)](https://www.python.org/downloads/)
...
This is a client library for the Axvn Sub Account SDK API, enabling developers to interact programmatically with Axvn's Sub Account trading platform. The library provides tools to trade through multiple accounts through the REST API:

- [REST API](./src/axvn_sdk_sub_account/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-sub-account
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/sub_account/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_sub_account/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import SUB_ACCOUNT_REST_API_PROD_URL
from axvn_sdk_sub_account.sub_account import SubAccount
from axvn_sdk_sub_account.rest_api.models import GetSummaryOfSubAccountsMarginAccountResponse
