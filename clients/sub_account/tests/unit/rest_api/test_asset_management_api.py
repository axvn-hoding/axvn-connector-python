...
from axvn-hoding_sdk_sub_account.rest_api.api import AssetManagementApi
from axvn-hoding_sdk_sub_account.rest_api.models import FuturesTransferForSubAccountResponse
...
from axvn-hoding_sdk_sub_account.rest_api.models import GetSubAccountDepositAddressResponse
from axvn-hoding_sdk_sub_account.rest_api.models import GetSubAccountDepositHistoryResponse
from axvn-hoding_sdk_sub_account.rest_api.models import (
...
from axvn-hoding_sdk_sub_account.rest_api.models import MarginTransferForSubAccountResponse
from axvn-hoding_sdk_sub_account.rest_api.models import MovePositionForSubAccountResponse
from axvn-hoding_sdk_sub_account.rest_api.models import QuerySubAccountAssetsResponse
from axvn-hoding_sdk_sub_account.rest_api.models import (
...
from axvn-hoding_sdk_sub_account.rest_api.models import SubAccountTransferHistoryResponse
from axvn-hoding_sdk_sub_account.rest_api.models import TransferToMasterResponse
from axvn-hoding_sdk_sub_account.rest_api.models import (
    TransferToSubAccountOfSameMasterResponse,
)
from axvn-hoding_sdk_sub_account.rest_api.models import UniversalTransferResponse
...
class TestAssetManagementApi:
    ...
    def test_get_detail_on_sub_accounts_futures_account_success_with_optional_params(
        ...
        params = {"email": "123@test.com", "recv_window": 5000}
    ...
    def test_get_detail_on_sub_accounts_futures_account_v2_success(
        ...
        assert request_kwargs["method"] == "GET"
        assert normalized["email"] == "123@test.com"
        assert normalized["futuresType"] == 1
    ...
    def test_get_detail_on_sub_accounts_futures_account_v2_success_with_optional_params(
        ...
        params = {"email": "123@test.com", "futures_type": 1, "recv_window": 5000}
        ...
        expected_response = [
            {
                ...
                "network": "AXVN",
                "status": 0,
                "address": "axvn136ns6lfw4zs5hg4n85vdthaad7hq5m4gtkgf23",
    ...
    def test_get_summary_of_sub_accounts_futures_account_success_with_optional_params(
        ...
        params = {"page": 1, "limit": 1, "recv_window": 5000}
    ...
    def test_get_summary_of_sub_accounts_futures_account_v2_success_with_optional_params(
        ...
        params = {"futures_type": 1, "page": 1, "limit": 10, "recv_window": 5000}
    ...
    def test_move_position_for_sub_account_success(self, mock_get_signature):
        ...
        assert "/sapi/v1/sub-account/futures/move-position" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["fromUserEmail"] == "testFrom@google.com"
        assert normalized["toUserEmail"] == "testTo@google.com"
        assert (
            normalized["productType"]
            == MovePositionForSubAccountProductTypeEnum["UM"].value
        )
    ...
    def test_query_sub_account_spot_asset_transfer_history_success_with_optional_params(
        ...
        params = {
            "from_email": "aaa@test.com",
            "to_email": "bbb@test.com",
            "start_time": 1623319461670,
            "end_time": 1641782889000,
            "page": 1,
            "limit": 10,
    ...
    def test_query_sub_account_spot_assets_summary_success_with_optional_params(
        ...
        params = {"email": "123@test.com", "page": 1, "size": 10, "recv_window": 5000}
    ...
    def test_query_universal_transfer_history_success_with_optional_params(
        ...
        params = {
            "from_email": "abctest@gmail.com",
            "to_email": "deftest@gmail.com",
            "client_tran_id": "1",
            "start_time": 1623319461670,
            "end_time": 1641782889000,
            "page": 1,
    ...
    def test_sub_account_futures_asset_transfer_success(self, mock_get_signature):
        ...
        assert "/sapi/v1/sub-account/futures/internalTransfer" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["fromEmail"] == "abc@test.com"
        assert normalized["toEmail"] == "def@test.com"
        assert normalized["futuresType"] == 1
        assert normalized["asset"] == "BTC"
        assert normalized["amount"] == 1.0
    ...
    def test_transfer_to_master_success_with_optional_params(self, mock_get_signature):
        ...
        params = {"asset": "BTC", "amount": 1.0, "recv_window": 5000}
    ...
    def test_transfer_to_sub_account_of_same_master_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["toEmail"] == "abc@test.com"
        assert normalized["asset"] == "BTC"
        assert normalized["amount"] == 1.0
    ...
    def test_universal_transfer_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert (
            normalized["fromAccountType"]
            == UniversalTransferFromAccountTypeEnum["SPOT"].value
        )
        assert (
            normalized["toAccountType"]
            == UniversalTransferToAccountTypeEnum["SPOT"].value
        )
        assert normalized["asset"] == "BTC"
        assert normalized["amount"] == 1.0
