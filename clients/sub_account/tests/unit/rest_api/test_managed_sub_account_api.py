...
from axvn-hoding_sdk_sub_account.rest_api.api import ManagedSubAccountApi
...
from axvn-hoding_sdk_sub_account.rest_api.models import QueryManagedSubAccountListResponse
from axvn-hoding_sdk_sub_account.rest_api.models import (
...
class TestManagedSubAccountApi:
    ...
    def test_query_managed_sub_account_asset_details_success_with_optional_params(
        ...
        params = {"email": "abc@test.com", "recv_window": 5000}
    ...
    def test_query_managed_sub_account_futures_asset_details_success_with_optional_params(
        ...
        params = {"email": "abc@test.com", "account_type": "MARGIN"}
    ...
    def test_query_managed_sub_account_list_success_with_optional_params(
        ...
        params = {"email": "abc@test.com", "page": 1, "limit": 10, "recv_window": 5000}
    ...
    def test_query_managed_sub_account_snapshot_success(self, mock_get_signature):
        ...
        assert normalized["email"] == "abc@test.com"
        assert (
            normalized["type"] == QueryManagedSubAccountSnapshotTypeEnum["SPOT"].value
        )
    ...
    def test_query_managed_sub_account_transfer_log_master_account_investor_success_with_optional_params(
        ...
        params = {
            ...
            "transfer_function_account_type": QueryManagedSubAccountTransferLogMasterAccountInvestorTransferFunctionAccountTypeEnum[
                "SPOT"
            ].value,
        }
    ...
    def test_query_managed_sub_account_transfer_log_master_account_trading_success_with_optional_params(
        ...
        params = {
            ...
            "limit": 10,
            "transfers": "transfers_example",
            "transfer_function_account_type": QueryManagedSubAccountTransferLogMasterAccountTradingTransferFunctionAccountTypeEnum[
                "SPOT"
            ].value,
        }
    ...
    def test_query_managed_sub_account_transfer_log_sub_account_trading_success_with_optional_params(
        ...
        params = {
            ...
            "limit": 10,
            "transfers": "transfers_example",
            "transfer_function_account_type": QueryManagedSubAccountTransferLogSubAccountTradingTransferFunctionAccountTypeEnum[
                "SPOT"
            ].value,
            "recv_window": 5000,
        }
    ...
    def test_withdrawl_assets_from_the_managed_sub_account_success(
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["fromEmail"] == "from@test.com"
        assert normalized["asset"] == "BTC"
        assert normalized["amount"] == 1.0
