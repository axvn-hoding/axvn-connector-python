...
from axvn-hoding_sdk_sub_account.rest_api.models.get_detail_on_sub_accounts_futures_account_response_assets_inner import (
...
class GetDetailOnSubAccountsFuturesAccountV2ResponseFutureAccountResp(BaseModel):
    """
    GetDetailOnSubAccountsFuturesAccountV2ResponseFutureAccountResp
    """  # noqa: E501

    email: Optional[StrictStr] = None
    assets: Optional[List[GetDetailOnSubAccountsFuturesAccountResponseAssetsInner]] = (
        None
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDetailOnSubAccountsFuturesAccountV2ResponseFutureAccountResp from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDetailOnSubAccountsFuturesAccountV2ResponseFutureAccountResp from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "assets": (
                    [
                        GetDetailOnSubAccountsFuturesAccountResponseAssetsInner.from_dict(
                            _item
                        )
