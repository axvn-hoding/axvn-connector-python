...
from axvn-hoding_sdk_sub_account.rest_api.models.get_futures_position_risk_of_sub_account_response_inner import (
    GetFuturesPositionRiskOfSubAccountResponseInner,
)
from axvn-hoding_sdk_sub_account.rest_api.models.get_futures_position_risk_of_sub_account_v2_response_delivery_position_risk_vos_inner import (
...
class GetFuturesPositionRiskOfSubAccountV2Response(BaseModel):
    ...
    future_position_risk_vos: Optional[
        List[GetFuturesPositionRiskOfSubAccountResponseInner]
        ...
        _obj = cls.model_validate(
            {
                "futurePositionRiskVos": (
                    [
                        GetFuturesPositionRiskOfSubAccountResponseInner.from_dict(_item)
