...
from axvn-hoding_sdk_sub_account.rest_api.models.get_summary_of_sub_accounts_margin_account_response_sub_account_list_inner import (
...
class GetSummaryOfSubAccountsMarginAccountResponse(BaseModel):
    """
    ...
    sub_account_list: Optional[
        List[GetSummaryOfSubAccountsMarginAccountResponseSubAccountListInner]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSummaryOfSubAccountsMarginAccountResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetSummaryOfSubAccountsMarginAccountResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "subAccountList": (
                    [
                        GetSummaryOfSubAccountsMarginAccountResponseSubAccountListInner.from_dict(
                            _item
                        )
