...
from axvn-hoding_sdk_sub_account.rest_api.models.query_managed_sub_account_asset_details_response_inner import (
...
class QueryManagedSubAccountAssetDetailsResponse(
    QueryManagedSubAccountAssetDetailsResponseInner
):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryManagedSubAccountAssetDetailsResponse from a JSON string"""
