...
from axvn-hoding_sdk_sub_account.rest_api.models.get_sub_accounts_status_on_margin_or_futures_response_inner import (
...
class GetSubAccountsStatusOnMarginOrFuturesResponse(
    GetSubAccountsStatusOnMarginOrFuturesResponseInner
):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetSubAccountsStatusOnMarginOrFuturesResponse from a JSON string"""
