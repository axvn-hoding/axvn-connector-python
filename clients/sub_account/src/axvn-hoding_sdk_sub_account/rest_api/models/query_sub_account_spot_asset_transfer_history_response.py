...
from axvn-hoding_sdk_sub_account.rest_api.models.query_sub_account_spot_asset_transfer_history_response_inner import (
...
class QuerySubAccountSpotAssetTransferHistoryResponse(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuerySubAccountSpotAssetTransferHistoryResponse from a JSON string"""
