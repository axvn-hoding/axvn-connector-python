...
from axvn-hoding_sdk_sub_account.rest_api.models.query_sub_account_api_key_response_rows_inner import (
...
class QuerySubAccountApiKeyResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuerySubAccountApiKeyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuerySubAccountApiKeyResponse from a dict"""
        if obj is None:
            return None
