...
from axvn-hoding_sdk_sub_account.rest_api.models.get_summary_of_sub_accounts_futures_account_response_sub_account_list_inner import (
...
class GetSummaryOfSubAccountsFuturesAccountResponse(BaseModel):
    ...
    sub_account_list: Optional[
        List[GetSummaryOfSubAccountsFuturesAccountResponseSubAccountListInner]
        ...
        _obj = cls.model_validate(
            {
                ...
                "subAccountList": (
                    [
                        GetSummaryOfSubAccountsFuturesAccountResponseSubAccountListInner.from_dict(
                            _item
                        )
