...
class ManagedSubAccountApi:
    ...
    def deposit_assets_into_the_managed_sub_account(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#deposit-assets-into-the-managed-sub-account
    ...
    def get_managed_sub_account_deposit_address(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#get-managed-sub-account-deposit-address
    ...
    def query_managed_sub_account_asset_details(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#query-managed-sub-account-asset-details
    ...
    def query_managed_sub_account_futures_asset_details(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#query-managed-sub-account-futures-asset-details
    ...
    def query_managed_sub_account_list(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#query-managed-sub-account-list
    ...
    def query_managed_sub_account_margin_asset_details(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#query-managed-sub-account-margin-asset-details
    ...
    def query_managed_sub_account_snapshot(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#query-managed-sub-account-snapshot
    ...
    def query_managed_sub_account_transfer_log_master_account_investor(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#query-managed-sub-account-transfer-log-master-account-investor
        ...
        Please refer to
        [link](https://www.axvn.vn/en/support/faq/how-to-get-started-with-managed-sub-account-functions-and-frequently-asked-questions-0594748722704383a7c369046e489459)
    ...
    def query_managed_sub_account_transfer_log_master_account_trading(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#query-managed-sub-account-transfer-log-master-account-trading
    ...
    def query_managed_sub_account_transfer_log_sub_account_trading(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#query-managed-sub-account-transfer-log-sub-account-trading
    ...
    def withdrawl_assets_from_the_managed_sub_account(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/managed-sub-account#withdrawl-assets-from-the-managed-sub-account
