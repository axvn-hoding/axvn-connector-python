...
class AccountManagementApi:
    ...
    def create_a_virtual_sub_account(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/account-management#create-avirtual-sub-account
    ...
    def enable_futures_for_sub_account(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/account-management#enable-futures-for-sub-account
    ...
    def enable_options_for_sub_account(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/account-management#enable-options-for-sub-account
    ...
    def get_futures_position_risk_of_sub_account(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/account-management#get-futures-position-risk-of-sub-account
    ...
    def get_futures_position_risk_of_sub_account_v2(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/account-management#get-futures-position-risk-of-sub-account-v2
    ...
    def get_sub_accounts_status_on_margin_or_futures(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/account-management#get-sub-accounts-status-on-margin-or-futures
    ...
    def query_sub_account_list(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/account-management#query-sub-account-list
    ...
    def query_sub_account_transaction_statistics(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/vip-and-institutional-sub-account/api/rest-api/account-management#query-sub-account-transaction-statistics
