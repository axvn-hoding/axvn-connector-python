...
[![PyPI version](https://img.shields.io/pypi/v/axvn-sdk-c2c)](https://pypi.python.org/pypi/axvn-sdk-c2c)
[![PyPI Downloads](https://img.shields.io/pypi/dm/axvn-sdk-c2c.svg)](https://pypi.org/project/axvn-sdk-c2c/)
[![Python version](https://img.shields.io/pypi/pyversions/axvn-sdk-c2c)](https://www.python.org/downloads/)
...
This is a client library for the Axvn C2C SDK API, enabling developers to interact programmatically with Axvn's C2C trading platform. The library provides tools to query Fiat transaction history through the REST API:
- [REST API](./src/axvn_sdk_c2c/rest_api/rest_api.py)
...
```bash
pip install axvn-sdk-c2c
```

## Documentation

For detailed information, refer to the [Axvn API Documentation](https://developers.axvn.vn/docs/c2c/Introduction).

### REST APIs

All REST API endpoints are available through the [`rest_api`](./src/axvn_sdk_c2c/rest_api/rest_api.py) module. The REST API enables you to fetch market data, manage trades, and access account information. Note that some endpoints require authentication using your Axvn API credentials.

```python
from axvn_common.configuration import ConfigurationRestAPI
from axvn_common.constants import C2C_REST_API_PROD_URL
from axvn_sdk_c2c.c2c import C2C
from axvn_sdk_c2c.rest_api.models import GetC2CTradeHistoryResponse
