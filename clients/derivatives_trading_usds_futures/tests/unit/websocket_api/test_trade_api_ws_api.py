...
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.api import TradeApi
...
class TestWebSocketTradeApi:
    ...
    async def test_cancel_algo_order_success_with_optional_params(self):
        ...
        params = {
            ...
            "algo_id": 2000000002162519,
            "client_algo_id": "rDMG8WSde6LkyMNtk6s825",
            "recv_window": 5000,
        }
        ...
        assert params["algo_id"] == 2000000002162519
        assert params["client_algo_id"] == "rDMG8WSde6LkyMNtk6s825"
    ...
    async def test_new_algo_order_success(self):
        ...
        assert params["algo_type"] == NewAlgoOrderAlgoTypeEnum["CONDITIONAL"].value

        assert params["symbol"] == "BTCUSDT"

        assert params["side"] == NewAlgoOrderSideEnum["BUY"].value

        assert params["type"] == NewAlgoOrderTypeEnum["STOP_MARKET"].value
    ...
    async def test_new_algo_order_success_with_optional_params(self):
        ...
        params = {
            ...
            "time_in_force": NewAlgoOrderTimeInForceEnum["IOC"].value,
            "quantity": 1.0,
            "price": 1.0,
            "trigger_price": 1.0,
        ...
        assert params["time_in_force"] == NewAlgoOrderTimeInForceEnum["IOC"].value
        assert params["quantity"] == 1.0
        assert params["price"] == 1.0
        assert params["trigger_price"] == 1.0
        assert params["working_type"] == NewAlgoOrderWorkingTypeEnum["MARK_PRICE"].value
        assert params["price_match"] == NewAlgoOrderPriceMatchEnum["OPPONENT"].value
        assert params["close_position"] == NewAlgoOrderClosePositionEnum["TRUE"].value
        assert params["price_protect"] == NewAlgoOrderPriceProtectEnum["TRUE"].value
        assert params["reduce_only"] == NewAlgoOrderReduceOnlyEnum["TRUE"].value
        assert params["activate_price"] == 1.0
        assert params["callback_rate"] == 1
        ...
        assert (
            ...
            == NewAlgoOrderSelfTradePreventionModeEnum["NONE"].value
        )
        assert params["good_till_date"] == 1770736694138
        assert params["recv_window"] == 5000
    ...
    async def test_new_order_success_with_optional_params(self):
        ...
        assert params["reduce_only"] == NewOrderReduceOnlyEnum["TRUE"].value
        assert params["quantity"] == 1.0
        assert params["price"] == 1.0
        ...
        assert params["price_match"] == NewOrderPriceMatchEnum["OPPONENT"].value
        assert (
            params["self_trade_prevention_mode"]
