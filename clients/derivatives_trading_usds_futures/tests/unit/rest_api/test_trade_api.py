...
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.api import TradeApi
...
class TestTradeApi:
    ...
    def test_auto_cancel_all_open_orders_success(self, mock_get_signature):
        ...
        assert normalized["symbol"] == "BTCUSDT"
        assert normalized["countdownTime"] == 1000
    ...
    def test_auto_cancel_all_open_orders_success_with_optional_params(
        ...
        params = {"symbol": "BTCUSDT", "countdown_time": 1000, "recv_window": 5000}
    ...
    def test_change_initial_leverage_success_with_optional_params(
        ...
        params = {"symbol": "BTCUSDT", "leverage": 1, "recv_window": 5000}
    ...
    def test_change_multi_assets_mode_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["multiAssetsMargin"] == "True"
    ...
    def test_change_multi_assets_mode_success_with_optional_params(
        ...
        params = {"multi_assets_margin": "True", "recv_window": 5000}
    ...
    def test_change_position_mode_success(self, mock_get_signature):
        ...
        assert request_kwargs["method"] == "POST"
        assert normalized["dualSidePosition"] == "True"
    ...
    def test_change_position_mode_success_with_optional_params(
        ...
        params = {"dual_side_position": "True", "recv_window": 5000}
    ...
    def test_new_algo_order_success(self, mock_get_signature):
        ...
        params = {
            ...
            "type": NewAlgoOrderTypeEnum["LIMIT"].value,
        }
        ...
        assert "/fapi/v1/algoOrder" in request_kwargs["url"]
        assert request_kwargs["method"] == "POST"
        assert normalized["algoType"] == NewAlgoOrderAlgoTypeEnum["CONDITIONAL"].value
        assert normalized["symbol"] == "AXVNUSDT"
        assert normalized["side"] == NewAlgoOrderSideEnum["BUY"].value
        assert normalized["type"] == NewAlgoOrderTypeEnum["LIMIT"].value
    ...
    def test_new_algo_order_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            ...
            "price_match": NewAlgoOrderPriceMatchEnum["OPPONENT"].value,
            "close_position": NewAlgoOrderClosePositionEnum["TRUE"].value,
            "price_protect": NewAlgoOrderPriceProtectEnum["TRUE"].value,
            "reduce_only": NewAlgoOrderReduceOnlyEnum["TRUE"].value,
            "activate_price": 1.0,
            "callback_rate": 1,
            "client_algo_id": "1",
    ...
    def test_new_order_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            ...
            "price_match": NewOrderPriceMatchEnum["OPPONENT"].value,
    ...
    def test_position_adl_quantile_estimation_success(self, mock_get_signature):
        ...
        expected_response = [{"symbol": "ETHUSDT", "adlQuantile": {}}]
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)
    ...
    def test_test_order_success(self, mock_get_signature):
        ...
        assert normalized["type"] == TestOrderTypeEnum["LIMIT"].value
    ...
    def test_test_order_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            ...
            "reduce_only": TestOrderReduceOnlyEnum["TRUE"].value,
            "quantity": 1.0,
            "price": 1.0,
            "new_client_order_id": "1",
            "stop_price": 1.0,
            "close_position": TestOrderClosePositionEnum["TRUE"].value,
            ...
            "price_protect": TestOrderPriceProtectEnum["TRUE"].value,
            "new_order_resp_type": TestOrderNewOrderRespTypeEnum["ACK"].value,
            "price_match": TestOrderPriceMatchEnum["OPPONENT"].value,
