...
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.api import AccountApi
...
class TestAccountApi:
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_axvn_burn_status_success(self, mock_get_signature):
        """Test get_axvn_burn_status() successfully with required parameters only."""

        expected_response = {"feeBurn": True}
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)

        response = self.client.get_axvn_burn_status()
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_get_axvn_burn_status_success_with_optional_params(self, mock_get_signature):
        """Test get_axvn_burn_status() successfully with optional parameters."""
        ...
        response = self.client.get_axvn_burn_status(**params)
    ...
    def test_get_axvn_burn_status_server_error(self):
        """Test that get_axvn_burn_status() raises an error when the server returns an error."""

        mock_error = Exception("ResponseError")
        self.client.get_axvn_burn_status = MagicMock(side_effect=mock_error)

        with pytest.raises(Exception, match="ResponseError"):
            self.client.get_axvn_burn_status()
    ...
    def test_get_income_history_success_with_optional_params(self, mock_get_signature):
        ...
        params = {
            "symbol": "BTCUSDT",
            "income_type": GetIncomeHistoryIncomeTypeEnum["TRANSFER"].value,
            "start_time": 1623319461670,
            "end_time": 1641782889000,
            "page": 1,
            "limit": 30,
    ...
    def test_notional_and_leverage_brackets_success(self, mock_get_signature):
        ...
        expected_response = [{"symbol": "ETHUSDT", "notionalCoef": 1.5, "brackets": []}]
        mock_get_signature.return_value = "mocked_signature"
        self.set_mock_response(expected_response)
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_toggle_axvn_burn_on_futures_trade_success(self, mock_get_signature):
        """Test toggle_axvn_burn_on_futures_trade() successfully with required parameters only."""
        ...
        response = self.client.toggle_axvn_burn_on_futures_trade(**params)
        ...
        assert normalized["feeBurn"] == "True"
    ...
    @patch("axvn-hoding_common.utils.get_signature")
    def test_toggle_axvn_burn_on_futures_trade_success_with_optional_params(
        self, mock_get_signature
    ):
        """Test toggle_axvn_burn_on_futures_trade() successfully with optional parameters."""

        params = {"fee_burn": "True", "recv_window": 5000}
    ...
    def test_toggle_axvn_burn_on_futures_trade_missing_required_param_fee_burn(self):
        """Test that toggle_axvn_burn_on_futures_trade() raises RequiredError when 'fee_burn' is missing."""
        params = {
            "fee_burn": "True",
        }
        ...
        with pytest.raises(
            ...
            self.client.toggle_axvn_burn_on_futures_trade(**params)

    def test_toggle_axvn_burn_on_futures_trade_server_error(self):
        """Test that toggle_axvn_burn_on_futures_trade() raises an error when the server returns an error."""
        ...
        mock_error = Exception("ResponseError")
        self.client.toggle_axvn_burn_on_futures_trade = MagicMock(side_effect=mock_error)
