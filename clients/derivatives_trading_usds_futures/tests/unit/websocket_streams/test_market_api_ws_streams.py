...
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.streams import (
    MarketApi,
)
...
class TestWebSocketStreams:
    ...
    @pytest.mark.asyncio
    async def test_asset_index_suaxvnscription(self):
        """Test that asset_index() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_composite_index_symbol_information_streams_suaxvnscription(self):
        """Test that composite_index_symbol_information_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_liquidation_order_streams_suaxvnscription(self):
        """Test that liquidation_order_streams() suaxvnscribes to the correct WebSocket stream."""
    ...
    @pytest.mark.asyncio
    async def test_mark_price_stream_for_all_market_suaxvnscription(self):
        """Test that mark_price_stream_for_all_market() suaxvnscribes to the correct WebSocket stream."""
    ...
    async def test_mark_price_stream_for_all_market_success_with_optional_params(self):
        ...
        params = {
            "id": "e9d6b4349871b40611412680b3445fac",
            "update_speed": MarkPriceStreamForAllMarketUpdateSpeedEnum[
                "UPDATE_SPEED_1s"
            ].value,
        }
    ...
    @pytest.mark.asyncio
    async def test_trading_session_stream_suaxvnscription(self):
        """Test that trading_session_stream() suaxvnscribes to the correct WebSocket stream."""
