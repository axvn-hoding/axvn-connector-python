...
class PortfolioMarginEndpointsApi:
    ...
    def classic_portfolio_margin_account_information(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/portfolio-margin-endpoints#classic-portfolio-margin-account-information
