...
class ConvertApi:
    ...
    def accept_the_offered_quote(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/convert#accept-the-offered-quote
    ...
    def list_all_convert_pairs(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/convert#list-all-convert-pairs
    ...
    def order_status(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/convert#order-status
    ...
    def send_quote_request(
        ...
        """
                ...
                https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/rest-api/convert#send-quote-request
