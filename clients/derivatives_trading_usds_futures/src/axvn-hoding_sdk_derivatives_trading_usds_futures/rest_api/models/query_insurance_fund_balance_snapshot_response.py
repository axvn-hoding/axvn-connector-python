...
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.query_insurance_fund_balance_snapshot_response1 import (
    QueryInsuranceFundBalanceSnapshotResponse1,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.query_insurance_fund_balance_snapshot_response2 import (
    QueryInsuranceFundBalanceSnapshotResponse2,
)
from typing import Union, Set, Dict
from typing_extensions import Self

QUERYINSURANCEFUNDBALANCESNAPSHOTRESPONSE_ONE_OF_SCHEMAS = [
    "QueryInsuranceFundBalanceSnapshotResponse1",
    "QueryInsuranceFundBalanceSnapshotResponse2",
]


class QueryInsuranceFundBalanceSnapshotResponse(BaseModel):
    """
    QueryInsuranceFundBalanceSnapshotResponse
    """

    # data type: QueryInsuranceFundBalanceSnapshotResponse1
    oneof_schema_1_validator: Optional[QueryInsuranceFundBalanceSnapshotResponse1] = (
        None
    )
    # data type: QueryInsuranceFundBalanceSnapshotResponse2
    oneof_schema_2_validator: Optional[QueryInsuranceFundBalanceSnapshotResponse2] = (
        None
    )
    actual_instance: Optional[
        Union[
            QueryInsuranceFundBalanceSnapshotResponse1,
            list[QueryInsuranceFundBalanceSnapshotResponse2],
        ]
    ] = None
