...
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.account_information_v2_response_assets_inner import (
    AccountInformationV2ResponseAssetsInner,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.account_information_v2_response_positions_inner import (
...
class AccountInformationV2Response(BaseModel):
    """
    ...
    fee_burn: Optional[StrictBool] = Field(
        default=None, description="Whether fee discount is enabled.", alias="feeBurn"
    )
    can_trade: Optional[StrictBool] = Field(
        default=None, description="Whether trading is enabled.", alias="canTrade"
    )
    can_deposit: Optional[StrictBool] = Field(
        default=None, description="Whether transfer-in is enabled.", alias="canDeposit"
    )
    can_withdraw: Optional[StrictBool] = Field(
        default=None,
        description="Whether transfer-out is enabled.",
        alias="canWithdraw",
    )
    update_time: Optional[StrictInt] = Field(
        default=None, description="Reserved field, ignore.", alias="updateTime"
    )
    multi_assets_margin: Optional[StrictBool] = Field(
        default=None,
        description="Whether multi-assets mode is enabled.",
        alias="multiAssetsMargin",
    )
    trade_group_id: Optional[StrictInt] = Field(
        default=None, description="Trade group identifier.", alias="tradeGroupId"
    )
    ...
    assets: Optional[List[AccountInformationV2ResponseAssetsInner]] = Field(
        default=None, description="Asset-level account details."
    )
    positions: Optional[List[AccountInformationV2ResponsePositionsInner]] = Field(
        default=None,
        description="Position details for symbols. One-way mode returns BOTH; hedge mode returns LONG/SHORT.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountInformationV2Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountInformationV2Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "assets": (
                    [
                        AccountInformationV2ResponseAssetsInner.from_dict(_item)
                ...
                "positions": (
                    [
                        AccountInformationV2ResponsePositionsInner.from_dict(_item)
