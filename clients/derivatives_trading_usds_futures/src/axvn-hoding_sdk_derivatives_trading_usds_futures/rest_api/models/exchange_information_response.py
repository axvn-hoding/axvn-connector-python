...
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.exchange_information_response_assets_inner import (
    ExchangeInformationResponseAssetsInner,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.exchange_information_response_rate_limits_inner import (
    ExchangeInformationResponseRateLimitsInner,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.exchange_information_response_symbols_inner import (
...
class ExchangeInformationResponse(BaseModel):
    ...
    server_time: Optional[StrictInt] = Field(
        default=None,
        description='Ignore please. If you want to check current server time, please check via "GET /fapi/v1/time"',
        alias="serverTime",
    )
    assets: Optional[List[ExchangeInformationResponseAssetsInner]] = Field(
        default=None, description="assets information"
    )
    symbols: Optional[List[ExchangeInformationResponseSymbolsInner]] = Field(
        default=None, description="Symbols."
    )
