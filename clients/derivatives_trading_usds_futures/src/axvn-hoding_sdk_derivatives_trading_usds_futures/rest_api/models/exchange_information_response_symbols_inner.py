...
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.exchange_information_response_symbols_inner_filters_inner import (
...
class ExchangeInformationResponseSymbolsInner(BaseModel):
    ...
    delivery_date: Optional[StrictInt] = Field(
        default=None, description="Delivery Date.", alias="deliveryDate"
    )
    onboard_date: Optional[StrictInt] = Field(
        default=None, description="Onboard Date.", alias="onboardDate"
    )
    ...
    base_asset: Optional[StrictStr] = Field(
        default=None, description="Base Asset.", alias="baseAsset"
    )
    ...
    quote_precision: Optional[StrictInt] = Field(
        default=None, description="Quote Precision.", alias="quotePrecision"
    )
