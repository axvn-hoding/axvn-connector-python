...
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.account_information_v3_response_assets_inner import (
    AccountInformationV3ResponseAssetsInner,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.account_information_v3_response_positions_inner import (
...
class AccountInformationV3Response(BaseModel):
    ...
    assets: Optional[List[AccountInformationV3ResponseAssetsInner]] = Field(
        default=None, description="Asset-level account details."
    )
    positions: Optional[List[AccountInformationV3ResponsePositionsInner]] = Field(
        default=None, description="Position details for symbols."
    )
