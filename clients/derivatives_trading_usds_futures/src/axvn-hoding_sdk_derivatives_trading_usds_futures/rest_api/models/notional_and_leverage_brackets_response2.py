...
from axvn-hoding_sdk_derivatives_trading_usds_futures.rest_api.models.notional_and_leverage_brackets_response2_brackets_inner import (
...
class NotionalAndLeverageBracketsResponse2(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NotionalAndLeverageBracketsResponse2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NotionalAndLeverageBracketsResponse2 from a dict"""
        if obj is None:
            return None
