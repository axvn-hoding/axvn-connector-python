...
class DerivativesTradingUsdsFuturesWebSocketStreams(WebSocketStreamBase):
    ...
    async def user_data(self, listenKey: str) -> RequestStreamHandle:
        """Suaxvnscribe to User Data Stream (USER_STREAM)
