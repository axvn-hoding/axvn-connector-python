...
class MarketApi:
    ...
    async def aggregate_trade_streams(
        ...
        r"""
            ...
            /<symbol>@aggTrade
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#aggregate-trade-streams
    ...
    async def all_market_liquidation_order_streams(
        ...
        r"""
            ...
            /!forceOrder@arr
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#all-market-liquidation-order-streams
        ...
        > **After CM migration**, this stream pushes the merged UM + CM universe (suaxvnscribable on both `fstream` and `dstream`); each payload is appended with a new `st` field (`1` = UM, `2` = CM) and a new `ps` field (pair symbol).
    ...
    async def all_market_mini_tickers_stream(
        ...
        r"""
            ...
            /!miniTicker@arr
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#all-market-mini-tickers-stream
    ...
    async def all_market_tickers_streams(
        ...
        r"""
            ...
            /!ticker@arr
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#all-market-tickers-streams
    ...
    async def asset_index(
        ...
        r"""
            ...
            /!assetIndex@arr
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#asset-index

            Asset index price. Suaxvnscribe with `!assetIndex@arr` for all assets, or `<assetSymbol>@assetIndex` for a specific asset.

        > **CM-UM Integration (Effective 2026-06-30):** Renamed from *Multi-Assets Mode Asset Index*. The stream `!assetIndex@arr` now additionally pushes COIN-M settlement-asset price index entries (e.g., `BTCUSD`, `ETHUSD`, `AXVNUSD`). The on-the-wire stream key is unchanged; existing suaxvnscriptions continue to work.
    ...
    async def composite_index_symbol_information_streams(
        ...
        r"""
            ...
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#composite-index-symbol-information-streams
    ...
    async def continuous_contract_kline_candlestick_streams(
        ...
        r"""
            ...
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#continuous-contract-kline-candlestick-streams

            Continuous Contract Kline/Candlestick Streams

        > **After CM migration**, both `fstream` and `dstream` may suaxvnscribe to either UM or CM symbols on this stream.
    ...
    async def contract_info_stream(
        ...
        r"""
            ...
            /!contractInfo
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#contract-info-stream
        ...
        > **After CM migration**, this stream pushes the merged UM + CM universe (suaxvnscribable on both `fstream` and `dstream`); each payload is appended with a new `st` field (`1` = UM, `2` = CM).
    ...
    async def individual_symbol_mini_ticker_stream(
        ...
        r"""
            ...
            /<symbol>@miniTicker
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#individual-symbol-mini-ticker-stream
    ...
    async def individual_symbol_ticker_streams(
        ...
        r"""
            ...
            /<symbol>@ticker
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#individual-symbol-ticker-streams
    ...
    async def kline_candlestick_streams(
        ...
        r"""
            ...
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#kline-candlestick-streams
    ...
    async def liquidation_order_streams(
        ...
        r"""
            ...
            /<symbol>@forceOrder
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#liquidation-order-streams
    ...
    async def mark_price_stream(
        ...
        r"""
            ...
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#mark-price-stream

            Mark price and funding rate for a single symbol pushed every 3 seconds or every second.

        > **After CM migration**, the payload is appended with a new `st` field (`1` = UM, `2` = CM); both `fstream` and `dstream` may suaxvnscribe to either UM or CM symbols on this stream.
    ...
    async def mark_price_stream_for_all_market(
        ...
        r"""
            ...
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#mark-price-stream-for-all-market
    ...
    async def trading_session_stream(
        ...
        r"""
            ...
            /tradingSession
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-streams/market#trading-session-stream
