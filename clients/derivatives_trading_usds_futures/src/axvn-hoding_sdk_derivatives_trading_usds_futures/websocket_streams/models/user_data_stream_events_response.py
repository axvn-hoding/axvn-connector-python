...
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.account_config_update import (
    AccountConfigUpdate,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.account_update import (
    AccountUpdate,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.algo_update import (
    AlgoUpdate,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.conditional_order_trigger_reject import (
    ConditionalOrderTriggerReject,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.grid_update import (
    GridUpdate,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.listen_key_expired import (
    ListenKeyExpired,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.margin_call import (
    MarginCall,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.order_trade_update import (
    OrderTradeUpdate,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.strategy_update import (
    StrategyUpdate,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_streams.models.trade_lite import (
    TradeLite,
)
...
class UserDataStreamEventsResponse(BaseModel):
    ...
    oneof_schema_3_validator: Optional[AlgoUpdate] = None
    ...
    oneof_schema_7_validator: Optional[MarginCall] = None
    # data type: OrderTradeUpdate
    oneof_schema_8_validator: Optional[OrderTradeUpdate] = None
    # data type: StrategyUpdate
    oneof_schema_9_validator: Optional[StrategyUpdate] = None
    # data type: TradeLite
    oneof_schema_10_validator: Optional[TradeLite] = None
