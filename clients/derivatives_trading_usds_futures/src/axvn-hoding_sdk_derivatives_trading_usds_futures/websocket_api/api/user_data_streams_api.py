...
class UserDataStreamsApi:
    ...
    async def close_user_data_stream(
        ...
        """
            ...
            /userDataStream.stop
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-api/user-data-streams#close-user-data-stream
    ...
    async def keepalive_user_data_stream(
        ...
        """
            ...
            /userDataStream.ping
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-api/user-data-streams#keepalive-user-data-stream
    ...
    async def start_user_data_stream(
        ...
        """
            ...
            https://developers.axvn.vn/en/docs/catalog/core-trading-derivatives-trading-usd-s-m-futures/api/ws-api/user-data-streams#start-user-data-stream
