...
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.models.cancel_algo_order_response_rate_limits_inner import (
    CancelAlgoOrderResponseRateLimitsInner,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.models.cancel_algo_order_response_result import (
...
class CancelAlgoOrderResponse(BaseModel):
    """
    ...
    result: Optional[CancelAlgoOrderResponseResult] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CancelAlgoOrderResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CancelAlgoOrderResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    CancelAlgoOrderResponseResult.from_dict(obj["result"])
