...
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.models.futures_account_balance_response_result_inner import (
...
class FuturesAccountBalanceResponse(BaseModel):
    """
    ...
    result: Optional[List[FuturesAccountBalanceResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FuturesAccountBalanceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FuturesAccountBalanceResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        FuturesAccountBalanceResponseResultInner.from_dict(_item)
