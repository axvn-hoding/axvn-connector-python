...
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.models.position_information_response_result_inner import (
...
class PositionInformationResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionInformationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionInformationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        PositionInformationResponseResultInner.from_dict(_item)
