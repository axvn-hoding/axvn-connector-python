...
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.models.account_information_response_result_assets_inner import (
    AccountInformationResponseResultAssetsInner,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.models.account_information_response_result_positions_inner import (
...
class AccountInformationResponseResult(BaseModel):
    """
    AccountInformationResponseResult
    """  # noqa: E501

    fee_tier: Optional[StrictInt] = Field(
        default=None, description="account commission tier", alias="feeTier"
    )
    can_trade: Optional[StrictBool] = Field(
        default=None, description="if can trade", alias="canTrade"
    )
    can_deposit: Optional[StrictBool] = Field(
        default=None, description="if can transfer in asset", alias="canDeposit"
    )
    can_withdraw: Optional[StrictBool] = Field(
        default=None, description="if can transfer out asset", alias="canWithdraw"
    )
    update_time: Optional[StrictInt] = Field(
        default=None, description="reserved property, please ignore", alias="updateTime"
    )
    multi_assets_margin: Optional[StrictBool] = Field(
        default=None, alias="multiAssetsMargin"
    )
    trade_group_id: Optional[StrictInt] = Field(default=None, alias="tradeGroupId")
    total_initial_margin: Optional[StrictStr] = Field(
        default=None,
        description="total initial margin required with current mark price (useless with isolated positions), only for USDT asset",
        alias="totalInitialMargin",
    )
    total_maint_margin: Optional[StrictStr] = Field(
        default=None,
        description="the sum of USD value of all cross positions maintenance margin",
        alias="totalMaintMargin",
    )
    total_wallet_balance: Optional[StrictStr] = Field(
        default=None,
        description="total wallet balance, only for USDT asset",
        alias="totalWalletBalance",
    )
    total_unrealized_profit: Optional[StrictStr] = Field(
        default=None,
        description="total unrealized profit, only for USDT asset",
        alias="totalUnrealizedProfit",
    )
    total_margin_balance: Optional[StrictStr] = Field(
        default=None,
        description="total margin balance, only for USDT asset",
        alias="totalMarginBalance",
    )
    total_position_initial_margin: Optional[StrictStr] = Field(
        default=None,
        description="initial margin required for positions with current mark price, only for USDT asset",
        alias="totalPositionInitialMargin",
    )
    total_open_order_initial_margin: Optional[StrictStr] = Field(
        default=None,
        description="initial margin required for open orders with current mark price, only for USDT asset",
        alias="totalOpenOrderInitialMargin",
    )
    total_cross_wallet_balance: Optional[StrictStr] = Field(
        default=None,
        description="crossed wallet balance, only for USDT asset",
        alias="totalCrossWalletBalance",
    )
    total_cross_un_pnl: Optional[StrictStr] = Field(
        default=None,
        description="unrealized profit of crossed positions, only for USDT asset",
    ...
    assets: Optional[List[AccountInformationResponseResultAssetsInner]] = Field(
        default=None, alias="assets"
    )

    positions: Optional[List[AccountInformationResponseResultPositionsInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountInformationResponseResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountInformationResponseResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "assets": (
                    [
                        AccountInformationResponseResultAssetsInner.from_dict(_item)
                ...
                "positions": (
                    [
                        AccountInformationResponseResultPositionsInner.from_dict(_item)
