...
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.models.account_information_response_rate_limits_inner import (
    AccountInformationResponseRateLimitsInner,
)
from axvn-hoding_sdk_derivatives_trading_usds_futures.websocket_api.models.position_information_v2_response_result_inner import (
...
class PositionInformationV2Response(BaseModel):
    """
    ...
    result: Optional[List[PositionInformationV2ResponseResultInner]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PositionInformationV2Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PositionInformationV2Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "result": (
                    [
                        PositionInformationV2ResponseResultInner.from_dict(_item)
                ...
                "rateLimits": (
                    [
                        AccountInformationResponseRateLimitsInner.from_dict(_item)
