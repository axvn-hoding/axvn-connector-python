...
class CopyTrading:
    """CopyTrading API that exposes REST APIs in a single interface."""
    ...
    @property
    def rest_api(self) -> CopyTradingRestAPI:
        if self._rest_api is None and self._rest_api_config:
            ...
            self._rest_api = CopyTradingRestAPI(self._rest_api_config)
